...
| CR-12 | Nav | “Dashboard” primary item | Demo / not cutover-ready (`site-hierarchy.md`) can mislead families | Relabel “Dashboard (demo)” or move under More until auth ships | Parent expectations | P1 | **Yes** | Pending Mike |
