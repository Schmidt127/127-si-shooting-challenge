...
- **Future / Planned:** **SC-SEASON-SIM-001** — three-athlete full-season simulation (**READY (preparation completing)**, not executed). Commands: `dry-run-three`, `--offline-fixture`, future `preflight`, future gated `execute`, `cleanup` (preview), gated cleanup execute, formula restore verification. Auth phrase: **`RUN 3-ATHLETE SEASON SIMULATION`**. Five-enrollment design **superseded**. Canonical entry: [`docs/127-SI-MASTER-FUTURE-WORK-LIST.md`](../../127-SI-MASTER-FUTURE-WORK-LIST.md) · `MRW-H11` · readiness [`docs/audits/SC-SEASON-SIM-001-THREE-ATHLETE-PREP-READINESS-20260906.md`](../../audits/SC-SEASON-SIM-001-THREE-ATHLETE-PREP-READINESS-20260906.md). **SC-SEASON-SIM-002** remains COMPLETE historical infrastructure. **Not** SC-112 multi-child auth or SC-161 leaderboard "3 athletes". **FUT-010** remains separate.
