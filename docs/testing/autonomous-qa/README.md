...
- **Future / Planned:** **SC-SEASON-SIM-001** — three-athlete full-season simulation (**READY**, not executed). Canonical entry: [`docs/127-SI-MASTER-FUTURE-WORK-LIST.md`](../../127-SI-MASTER-FUTURE-WORK-LIST.md) · `MRW-H11`. **SC-SEASON-SIM-002** remains COMPLETE historical infrastructure. **FUT-010** remains separate.
