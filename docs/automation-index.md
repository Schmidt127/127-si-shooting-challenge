...
| **010** | Submission Intake — Create/Reconcile XP Event from Submission | Submissions when `Reconciliation Needed? = 1` plus Enrollment, Week, WAS present; `Count This Submission?`; `Total Shots Counted > 0`; dynamic `recordId` | `010-submission-intake-create-xp-event.js` (**GitHub v10.12**; **Production v10.11** until paste — run history 2026-08-21) |
