...
Live attendance XP remains **101**. **SC-147** recording half-XP is implemented in **101 v6.7** (GitHub) — no slot **121**. Recording approval email remains **117** (email only). **No DEV base** (retired 2026-08-19) — paste 101 v6.7 to **Production** after disposable proof ([`SC-147-zoom-recording-half-xp.md`](./deploy-checklists/SC-147-zoom-recording-half-xp.md)).
