...
| **065** | Homework Review — Create/Reconcile Homework XP Event | `Homework XP Reconciliation Needed? = 1` — **Production v10.5 Live** (FUT-001 + multi-asset reconcile; Automations Code MCP 2026-08-31); Source Key `HOMEWORK_XP\|{HC ID}`; input `recordId` = **triggering HC** (dynamic); do not re-paste | `065-homework-review-and-xp-create-homework-xp-event.js` |
