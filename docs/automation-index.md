...
| **010** | Submission Intake — Create/Reconcile XP Event from Submission | Submissions when `Reconciliation Needed? = 1`, dynamic `recordId` | `010-submission-intake-create-xp-event.js` (**GitHub + Live v10.14** SC-167 duplicate consolidate — PR **#453** `08da8b03`; Live `wflJUkUJYTtRWJCyH` MCP-verified 2026-09-05 — eligible disposable create+retry still required — [`deploy-checklists/SC-167-010-v10.14-duplicate-consolidate.md`](./deploy-checklists/SC-167-010-v10.14-duplicate-consolidate.md) · [`audits/SC-167-168-169-LIVE-VERIFICATION-20260905.md`](./audits/SC-167-168-169-LIVE-VERIFICATION-20260905.md)) |
