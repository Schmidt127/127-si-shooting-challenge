...
| **065** | Homework Review — Create/Reconcile Homework XP Event | `Homework XP Reconciliation Needed? = 1` — **Production v10.4 Live** (FUT-001; Automations Code MCP 2026-08-29/30); Source Key `HOMEWORK_XP\|{HC ID}`; input `recordId` = **triggering HC** (dynamic; remapped 2026-08-30); do not re-paste | `065-homework-review-and-xp-create-homework-xp-event.js` |
