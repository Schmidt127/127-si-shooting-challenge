...
| 009 | Submission Intake — Create Submission Assets | **Live v1.2** (Automations Code) / **GitHub v1.3** (SC-160 paste pending) | `009-submission-intake-create-submission-assets.js` (**GitHub v1.3** — Week optional for intake; one asset per attachment; Source Attachment ID idempotent; checklist [SC-160-009-asset-intake-decouple.md](./deploy-checklists/SC-160-009-asset-intake-decouple.md); see [HOMEWORK-ASSET-COMPLETION-RUNBOOK.md](./online-agents/homework-assets/HOMEWORK-ASSET-COMPLETION-RUNBOOK.md)) |
...
| **057** | Achievements — Calculate Perfect Week Eligibility | WAS Perfect Week recalc | `057-achievements-and-milestones-calculate-perfect-week-eligibility.js` (**v2.4** — SC-152 clears `Perfect Week Recalc Needed?` on writeback; late homework excluded from Perfect Week count; Config-driven Perfect Week video minimum (SC-034); inactive enrollment and unsettled/multiple/wrong-scope goals fail closed; requires lookup parity with the linked active goal) |
...
| **059** | Achievements — Create/Reconcile XP Event from Achievement Unlock | Athlete Achievement Unlock lifecycle; **OR** (Pending+Active) **or** (Active?=false + Shot Milestone not empty); **Do NOT filter on Ready for 059 XP** | `059-achievements-and-milestones-create-xp-event-from-achievement-unlock.js` (**v3.8** — SF-08 lifecycle OR; Trigger Context; Milestone Source Key; `lifecycleOut`) |
