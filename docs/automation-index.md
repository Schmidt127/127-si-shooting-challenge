...
| **117f** | Zoom Recording Credit — Send Approval Email (**v1.2.0**, DEV script package) | Zoom Attendance · Satisfactory recording path · inputs `recordId` + `webhookUrl` | `117f-zoom-recording-send-approval-email.js` · [DEV evidence](./deploy-checklists/C-025-117f-dev-agent2-evidence-2026-07-20.md) |
