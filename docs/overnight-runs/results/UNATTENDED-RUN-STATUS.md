...
| Field | Value |
|-------|-------|
| Combined 020 | Live; post-paste smoke **CRITICAL PASS** |
| 063 | Still ON — retire next |
| Evidence | `phase-c1-020-post-paste-smoke-2026-07-14.json` |
| Next | Mike deletes **063** → **47 est / 3 free** · reply **Phase C1 UI complete** |
