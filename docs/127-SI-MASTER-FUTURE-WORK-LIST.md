...
| **SC-153** | Achievements | Perfect Week 058 lifecycle / positive-only trigger (SF-02) | P0 | **Partial — lifecycle live; withdraw hotfix paste pending** (2026-09-04) | SC-152, SC-077 | Trigger + nine fields live; create/award/restore PASS; withdraw fails on live v1.6 Coach Note bug — paste **058 v1.7** per [`deploy-checklists/SC-152-153-perfect-week-lifecycle-057-058.md`](./deploy-checklists/SC-152-153-perfect-week-lifecycle-057-058.md). |
