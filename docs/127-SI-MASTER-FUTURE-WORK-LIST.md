...
| **SC-160** | Intake / Homework / PW | Asset intake without Submission.Week + early/on-time/late HW (009/020/065/057) | P0 | **PAUSED** (2026-09-05) — live 009/020/065/057 pasted; Stage 6 blocked on WAS-for-PHA-Week after weekless intake. Incident [udits/SC-160-STAGE6-WAS-DUPLICATE-INCIDENT-20260904.md](./audits/SC-160-STAGE6-WAS-DUPLICATE-INCIDENT-20260904.md). |
...
| **SC-160 / asset intake + HW timing** | **PAUSED** (2026-09-05) | Live scripts OK; resolve 020 WAS find/create for PHA Week; FUT-002 trash still gated. |
