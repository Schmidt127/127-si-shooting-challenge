...
| **SC-112** | Website | Athlete auth + dashboard | P2 | **MERGED/DEPLOYED** (magic-link **works**) · multi-child **MERGED** + **PARTIAL / NEEDS-MIKE** | SC-149 | Private `/shoot/dashboard`; opaque selection keys (PR **#373** `97548cee`); tip `9a68281e`; multi-child evidence **#380** MERGED (walkthrough incomplete); auth docs **#379** MERGED. Closeout: [`audits/SC-112-finalization-closeout-20260903.md`](./audits/SC-112-finalization-closeout-20260903.md) |
...
| **SC-112 multi-child parent auth** | **MERGED/DEPLOYED** + **PARTIAL / NEEDS-MIKE** (also **NEEDS-PRODUCTION-PROOF** for signed-in walkthrough) | PR **#373** merged 97548cee. Docs **#379** MERGED. Evidence **#380** MERGED. Authenticated select/switch/sign-out still needs Mike inbox walkthrough. |
