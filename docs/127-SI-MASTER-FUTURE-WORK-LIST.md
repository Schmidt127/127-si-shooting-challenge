...
| **SC-163** | Enrollment | Enrollments Goal Met Date reliability + backfill | P1 | **HOLD — 066 OFF until v4.1 paste** (2026-09-05) | — | Live v4.0 double-shifted Athlete1 (`2026-08-30`→`08/28 6PM`). Paste **066 v4.1** (date-key preserve); Goal Met Date must be **date-only / time off**; clear wrong stamp; **no backfill this fix**. Checklist [`deploy-checklists/SC-163-goal-met-date.md`](./deploy-checklists/SC-163-goal-met-date.md). **Not live-complete.** |
