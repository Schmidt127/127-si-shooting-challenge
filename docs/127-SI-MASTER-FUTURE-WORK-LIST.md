...
| **SC-160** | Homework / Perfect Week | Early/on-time/late + HC Week from PHA (Submission.Week optional) | P0 | **IN PROGRESS / GitHub ready — Mike paste** (2026-09-04) | FUT-001, Agent 2 (009) | **020 v4.0 / 065 v10.7 / 057 2.5**. PHA.Week authoritative; Early counts for PW homework; late XP ok / PW exclude; 059 untouched. Evidence [`audits/SC-160-HOMEWORK-TIMING-PW-20260904.md`](./audits/SC-160-HOMEWORK-TIMING-PW-20260904.md) · paste [`deploy-checklists/SC-160-homework-timing-pw-020-057-065.md`](./deploy-checklists/SC-160-homework-timing-pw-020-057-065.md). |
