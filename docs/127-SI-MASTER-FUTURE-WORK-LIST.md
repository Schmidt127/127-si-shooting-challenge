...
| **SC-152** | Achievements | Perfect Week 057 formula-queue / trigger reliability (SF-01) | P0 | **IN PROGRESS** (2026-09-04 remediation wave) | SC-057 (attestation closed), SC-028 | Fix silent miss when `Perfect Week Calculation Queue?` is formula-only; every eligible WAS must reach evaluated state; reconciliation for stranded Queue?=1. Do **not** reopen SC-057 attestation. |
| **SC-153** | Achievements | Perfect Week 058 lifecycle / positive-only trigger (SF-02) | P0 | **IN PROGRESS** (2026-09-04 remediation wave) | SC-152, SC-077 | Process fail/withdraw/re-evaluate states not only Eligible+Ready+Unlock empty; preserve XP dedupe; visible Fail vs incomplete. Do **not** reopen SC-058 attestation. |
| **SC-154** | Weekly Summary | Duplicate Weekly Athlete Summary uniqueness (SF-03) | P1 | **IN PROGRESS** (2026-09-04 remediation wave) | SC-037 | Inventory writers; confirm Enrollment+Week key; harden create path; reconciliation for duplicates — no auto-merge of live rows without evidence. |
| **SC-155** | Levels | Level recalculation lag / stuck Needed? (SF-04) | P1 | **IN PROGRESS** (2026-09-04 remediation wave) | SC-024 | Prove 041 cron 15m vs missed trigger; add reconciliation for Needed?=1 aged; fix only evidence-supported defects. |
| **SC-156** | Assets | Automation 070a enabled-state + failure observability (SF-06) | P1 | **IN PROGRESS** (2026-09-04 remediation wave) | SC-095, SC-138 | Attest live ON/OFF vs launch docs; verify failures visible/retryable on test data only; no broad email. |
| **SC-157** | Platform | Draft PR **#340** disposition vs SC-147 closeout | P1 | **IN PROGRESS** (2026-09-04 remediation wave) | SC-147 | Determine remaining useful scope vs superseded by 101 v6.8 closeout; preserve or close with evidence. |
