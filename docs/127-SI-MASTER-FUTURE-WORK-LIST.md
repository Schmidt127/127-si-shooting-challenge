...
| **SC-151** | Website | Family Dashboard allows registered Gmail parent emails | P1 | **MERGED** (PR **#389**, `a00ef7a5`) | SC-112 | Removed incorrect Gmail domain block + sign-in copy fix. **SC-112 remains closed.** Audit: [`audits/SC-151-family-dashboard-gmail-access-20260904.md`](./audits/SC-151-family-dashboard-gmail-access-20260904.md) |
