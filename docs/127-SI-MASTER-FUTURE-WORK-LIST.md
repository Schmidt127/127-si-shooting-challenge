...
| **SC-112 multi-child parent auth** | **MERGED/DEPLOYED** + **NEEDS-PRODUCTION-PROOF** | PR **#373** merged 97548cee. Docs **#379** MERGED. Evidence **#380** MERGED. Authenticated select/switch/sign-out still needs Mike inbox walkthrough. |
...
| **Public awards publication gate** | **MERGED** PR **#378** (0e84533); **#376** closed superseded | Live checkbox **Public On Web** wired as sole public gate. Fail-closed blank/false. Vercel Production follows merge. |
