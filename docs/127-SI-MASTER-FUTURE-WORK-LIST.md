...
| **SC-118** | Website | Production readiness smoke package for public `/shoot` | P2 | **Complete** (2026-08-30 final pass) | SC-102 | Playwright smoke includes `/faq`; HTTP smoke includes `/faq`; Vitest `public-route-readiness`; prod smoke re-run after deploy |
