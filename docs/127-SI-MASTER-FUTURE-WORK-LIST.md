...
| **SC-169** | Achievements | Season Sim T122531Z “unlocks=0” discrepancy | P0 | **COMPLETE / Repository** (2026-09-05) | SC-SEASON-SIM-002 | **False-negative count + cleanup gap** — 066/059 awarded 4 shot-milestone unlocks (matched 4 SHOT_MILESTONE XP); cascade used non-existent Unlocks.`Enrollment Record ID`; orphans deleted. Streaks/PW do not use Unlocks table here. Evidence [`audits/SC-169-ACHIEVEMENT-UNLOCKS-20260905.md`](./audits/SC-169-ACHIEVEMENT-UNLOCKS-20260905.md) · checklist [`deploy-checklists/SC-169-achievement-unlocks.md`](./deploy-checklists/SC-169-achievement-unlocks.md). **No automation paste.** |
