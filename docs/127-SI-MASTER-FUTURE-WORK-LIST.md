...
| **SC-112** | Website | Athlete auth + dashboard | P2 | **MERGED/DEPLOYED** (magic-link) · multi-child **MERGED** + **PARTIAL** live proof · **NEEDS-MIKE** inbox for select/switch | SC-149 | Private `/shoot/dashboard`; opaque selection keys (PR **#373** `97548cee`); tip `9a68281e`; Agent 1 final live evidence [`audits/SC-112-multi-child-live-a1-final-20260903.md`](./audits/SC-112-multi-child-live-a1-final-20260903.md); prior evidence **#380**. Closeout: [`audits/SC-112-finalization-closeout-20260903.md`](./audits/SC-112-finalization-closeout-20260903.md) |
...
| **SC-112 multi-child parent auth** | **MERGED/DEPLOYED** + **PARTIAL** (data/API/request) + **NEEDS-MIKE** / **NEEDS-PRODUCTION-PROOF** (authenticated select/switch) | PR **#373** merged 97548cee. Docs **#379** MERGED. Evidence **#380** MERGED. Agent 1 final live pass on tip `9a68281e`: 3 Active enrollments; Vitest 56/56; Prod Playwright 12/4; controlled magic-link request OK; inbox select/switch still Mike. [`audits/SC-112-multi-child-live-a1-final-20260903.md`](./audits/SC-112-multi-child-live-a1-final-20260903.md). |
