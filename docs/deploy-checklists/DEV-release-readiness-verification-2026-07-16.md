...
> **Historical — read-only evidence package (2026-07-16).** Offline verification snapshot from the pre–production-only era. Current release gates use `tools/validate-v2-release-readiness.js` and `tools/testing/run-agent4-suite.js` against the live PROD-aligned repository.
