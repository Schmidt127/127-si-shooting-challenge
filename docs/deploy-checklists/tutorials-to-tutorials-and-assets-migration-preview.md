...
**Base for first run:** Production `appn84sqPw03zEbTT`
...
## Live Production snapshot (2026-08-17)
...
Create in Airtable (production-only validation), then re-run dry-run:
...
2. Create prerequisite fields + Tutorial Migration Review on Production.
...
6. Repeat on PROD only after Production approval.
