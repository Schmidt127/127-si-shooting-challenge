...
**Implementation plan:** [C-013-production-lambda-upload-plan.md](./C-013-production-lambda-upload-plan.md) — **IMPLEMENTED** (code + local PASS 2026-07-08); **AWS deploy** pending admin IAM
...
| **3 — SDK / hybrid interim** | **Proof complete** — logic source for Lambda; [`c013_prod_s3_upload_proof.py`](../../tools/airtable/c013_prod_s3_upload_proof.py) + [`lambda/upload-asset/`](../../lambda/upload-asset/) |
...
**Lambda deploy:** [lambda/upload-asset/DEPLOY.md](../../lambda/upload-asset/DEPLOY.md). **070b prep:** [C-013-production-070b-hybrid-prep.md](./C-013-production-070b-hybrid-prep.md) (still OFF).
...
| **4** | Save `_preview/c013-prod-h2-sdk-proof-<assetId>.json` + probe verify | Cursor | **DONE** |
| **4b** | H2 through Lambda handler (`c013_prod_lambda_invoke.py`) | Cursor | **DONE** (`recLAk8TA4lfbA6eu`, `allPass=true`) |
...
Implemented in `c013_prod_s3_upload_proof.py` (2026-07-08):
...
| [C-013-make-s3-production-build-packet.md](./C-013-make-s3-production-build-packet.md) | Writeback contract |
| [C-013-production-lambda-upload-plan.md](./C-013-production-lambda-upload-plan.md) | **Lambda implementation plan (Production)** |
| [C-013-production-070b-hybrid-prep.md](./C-013-production-070b-hybrid-prep.md) | 070b trigger prep (OFF until approved) |
