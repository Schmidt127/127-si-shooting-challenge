...
> **Historical — read-only (DEV base retired 2026-08-19).** Offline harness and OMNI checklist only. Current script is **066 v3.8** on PROD; use deploy checklists under `docs/deploy-checklists/` for paste guidance.
