...
| **V2-015** | Permanent Development Airtable base | **Approved** — one repo, one prod, one dev; DEV for paste/schema/backfills/Make/Test Intake | V2-014 | **approved** | [v2-015-development-base-architecture.md](./v2-015-development-base-architecture.md) |
