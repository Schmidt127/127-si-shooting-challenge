...
| **C-020** | **High** | **Engineering Test Framework** — **Testing Scenarios** on Production; script blocked on OMNI field list |
...
| **H-002** | **Done** | **Automation 066 v3.2** — V2 standard rewrite; Week write; **Production + PROD pasted** 2026-07-06; live OMNI sandbox confirm still open. See [v2/06-automation-standards.md](./v2/06-automation-standards.md). |
