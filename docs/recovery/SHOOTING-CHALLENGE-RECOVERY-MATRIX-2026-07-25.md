...
|---------|------------|-----------|----|----------------|-------------|---------|---------|-------------|
| Automation 035 v1.1 | Built (PR tip only; absent on master) | Committed + Pushed @ `7aff310` | #43 draft | **No** (not in inventory; 0 WEEKLY_THRESHOLD XP) | **No** | Mike UI paste OFF-first + Schmidt Tests 1–5 | None unique | After #45 path: paste from PR #43 checklist |
...
| SC-041 weekly-email retry | Built on #46; master still Planned | Committed + Pushed @ `1c2dcc7` | #46 draft | N/A (SOP/contracts; 074 already Live) | **No** failure→recovery | Mike authorization for deliberate failure | SCN-027 ID clash with #44 | Keep draft; no failure test yet |
