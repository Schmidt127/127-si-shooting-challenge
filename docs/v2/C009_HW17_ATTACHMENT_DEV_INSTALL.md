...
> **Historical — read-only (DEV base retired 2026-08-19).** Do not paste to the retired DEV base. Use PROD-first workflow and Mike/OMNI authorization for any live install.
