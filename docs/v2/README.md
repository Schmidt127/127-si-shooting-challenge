...
| # | File | Status |
|---|------|--------|
| — | [../ENGINEERING_CONSTITUTION.md](../ENGINEERING_CONSTITUTION.md) | **Active** — highest-level engineering law (GitHub, production-only, priorities) |
...
| 04 | [04-ai-development-standards.md](./04-ai-development-standards.md) | **Active** — three-role workflow, **production-only delivery diagram**, five phases |
