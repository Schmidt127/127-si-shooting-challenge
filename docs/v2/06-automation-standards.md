...
**Status:** **Active** — V2 rewrite pattern defined; **066 v3.3** is the current reference implementation (evolved from v3.2 / original **v3.1** V2 rewrite).
...
**066 v3.3** scores **Critical** by line count alone — that is expected for domain-heavy scripts. Complexity score drives **priority and test rigor**, not “must merge to save slots.”
...
**Automation 066 v3.3** (`066-achievements-and-milestones-create-shot-milestone-unlocks.js`) is the **canonical template** for future V2 automation rewrites.
...
**Status:** **Proposed standard** — mandatory for all **new** Category B rewrites and substantive edits. **066 v3.3** is the reference. **No mass migration of legacy scripts until their wave is approved.**
...
| Streaks | 053, 054 |
| Achievements | 059, **066 (v3.3 — V2 reference)** |
