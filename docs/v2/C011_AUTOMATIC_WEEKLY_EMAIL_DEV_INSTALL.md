...
> **Historical — read-only (DEV base retired 2026-08-19).** Weekly email is live on PROD via Communications Hub (`118 → 072 → 119 → 074 → 079`). Do not re-enable against the retired DEV base.
