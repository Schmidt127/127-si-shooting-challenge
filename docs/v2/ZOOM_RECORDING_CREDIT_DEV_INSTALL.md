...
> **Historical — read-only (DEV base retired 2026-08-19).** Stage 17 Zoom Attendance is authoritative on PROD. Use [C-025-stage17-zoom-recording-dev-installation-packet.md](../deploy-checklists/C-025-stage17-zoom-recording-dev-installation-packet.md) for current install guidance.
