...
|----|---------------|-------------|------------------------------------------|--------------------------|
| [#2](https://github.com/Schmidt127/127-si-shooting-challenge/pull/2) | Cursor Cloud production environment | **CLOSE â€” OBSOLETE / DUPLICATE** | Duplicate cloud-setup draft; `AGENTS.md` + web/production setup already on `master` tip `267d473`; hundreds of commits behind â€” do not merge | [comment](https://github.com/Schmidt127/127-si-shooting-challenge/pull/2#issuecomment-5078570216) Â· closed |
| [#3](https://github.com/Schmidt127/127-si-shooting-challenge/pull/3) | Cursor Cloud production environment | **CLOSE â€” OBSOLETE / DUPLICATE** | Same class as `#2` â€” duplicate Cursor Cloud draft; setup already on master | [comment](https://github.com/Schmidt127/127-si-shooting-challenge/pull/3#issuecomment-5078570305) Â· closed |
| [#4](https://github.com/Schmidt127/127-si-shooting-challenge/pull/4) | Cloud production environment | **CLOSE â€” OBSOLETE / DUPLICATE** | Same class as `#2` â€” duplicate cloud-setup draft | [comment](https://github.com/Schmidt127/127-si-shooting-challenge/pull/4#issuecomment-5078570394) Â· closed |
...
| [#12](https://github.com/Schmidt127/127-si-shooting-challenge/pull/12) | Worker-B 070a backend | **CLOSE â€” FULLY SUPERSEDED** | 070a Production package history absorbed on master; PROD 070a intentionally OFF â€” stale draft must not merge | [comment](https://github.com/Schmidt127/127-si-shooting-challenge/pull/12#issuecomment-5078570836) Â· closed |
...
| [#20](https://github.com/Schmidt127/127-si-shooting-challenge/pull/20) | Cursor Cloud production environment | **CLOSE â€” OBSOLETE / DUPLICATE** | Same class as `#2` â€” duplicate Cursor Cloud draft | [comment](https://github.com/Schmidt127/127-si-shooting-challenge/pull/20#issuecomment-5078570486) Â· closed |
| [#21](https://github.com/Schmidt127/127-si-shooting-challenge/pull/21) | Cursor Cloud production environment | **CLOSE â€” OBSOLETE / DUPLICATE** | Same class as `#2` â€” duplicate Cursor Cloud draft | [comment](https://github.com/Schmidt127/127-si-shooting-challenge/pull/21#issuecomment-5078570593) Â· closed |
