...
**Last verification (repo):** 2026-09-05 — **FUT-002 Batch 2 COMPLETE** (four stubs UI-deleted; five Batch 2 IDs absent; live **1375** fields / **35** tables). **SC-160 COMPLETE / Live Tested** (live **009 v1.3 / 020 v4.1 / 065 v10.7 / 057 2.5**). **SC-159 COMPLETE / Live Tested**. Season Sim **NOT run**. Evidence: [audits/FUT-002-BATCH2-POST-DELETE-CLOSEOUT-20260905.md](./audits/FUT-002-BATCH2-POST-DELETE-CLOSEOUT-20260905.md) · [audits/SC-160-STAGE6-FINAL-CLOSEOUT-20260905.md](./audits/SC-160-STAGE6-FINAL-CLOSEOUT-20260905.md).
...
| **067** | **v3.4** (live body) | v3.5 | Live / optional structure paste | Reflection quiz → Homework Completion. MCP 2026-09-05 live script **v3.4**; inventory Code/AI Agent = v3.5 (structure-only). Retract prior “Live v3.5 DO-NOT-TOUCH” overstatement — [`audits/VERSION-AUDIT-CORRECTION-021-013-067-20260905.md`](./audits/VERSION-AUDIT-CORRECTION-021-013-067-20260905.md) |
| **066** | **v3.9** | v3.9 | Live / live-tested | Dynamic `recordId`; replay verified 2026-08-24 |
| **013** | **v3.1.0** (live body) | v3.2.0 | Live / optional structure paste | MCP 2026-09-05 live **v3.1.0**; GitHub v3.2.0 V2 structure only — [`audits/VERSION-AUDIT-CORRECTION-021-013-067-20260905.md`](./audits/VERSION-AUDIT-CORRECTION-021-013-067-20260905.md) |
