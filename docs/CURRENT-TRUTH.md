...
| HEAD SHA | **`5dcb8449ffce9c11a1a136f46c817f029dd72a10`** â SC-156 070a Live Tested (#411) after SC-152â157 wave. Re-verify: `git rev-parse HEAD` (post-closeout merge advances tip) |
| `origin/master` | Should match HEAD after fetch â re-verify: `git rev-parse origin/master` |
| Ahead / behind | **0 / 0** (re-verify after fetch) |
| Recent merges (2026-09-04 SF + reliability) | **#411** SC-156 Â· **#410/#409/#408** SC-153 Â· **#407** SF closeout Â· **#406** SC-152/153 Â· **#404** SC-154/155/156 Â· **#401** SC-157 closes **#340** Â· **#398** SC-147 Â· **#399** SEO Â· **#397** FUT-025 Â· **#396** SC-148 Â· **#395** SC-057/058 |
...
Schema snapshots under `airtable/schema/snapshots/prod-20260706/` and `dev-20260706/` are dated exports in-repo (DEV snapshot is historical). **PostâFUT-002 batch-1 live export:** `airtable/schema/snapshots/prod-20260831-fut002-batch1/` (33 tables / **1350** fields, 2026-08-31; **historical relative to later SA stub deletes**). **After SA XP text stubs delete (same day):** live Meta **1363** fields / **35** tables â [`testing/evidence/fut-002/sa-xp-text-stubs-deleted-2026-08-31.json`](./testing/evidence/fut-002/sa-xp-text-stubs-deleted-2026-08-31.json). `airtable/schema/current/` remains **stale** â prefer dated snapshot + latest FUT-002 evidence for live field truth.
...
| Production deploy | **Live** â Vercel Production follows `master` (repo tip **`5dcb8449`** after SC-156; prior attested deploy **`dpl_hnPCeD3gELNcQkJyQe9Mugao1jYc`** READY). `GET /shoot` / `/shoot/api/airtable` live-pass **200**. SC-149 branding env MATCH; Family Dashboard nav live; FUT-025 athlete indexing env on |
...
| SC-149 Family Dashboard navigation | **COMPLETE / Live Tested in PROD** (2026-09-04) â PR **#358** (`29904b45`); header/mobile/footer/parent/FAQ CTAs â `/shoot/dashboard/sign-in`; private `/shoot/dashboard` remains auth-gated. Evidence [`audits/SC-149-family-dashboard-nav-prod-verification-20260904.md`](./audits/SC-149-family-dashboard-nav-prod-verification-20260904.md) Â· independent verify [`audits/SC-149-INDEPENDENT-VERIFY-20260904.md`](./audits/SC-149-INDEPENDENT-VERIFY-20260904.md) |
...
| FUT-002 field inventory | **Batch 1 COMPLETE (2026-08-31)** + **SA XP text stubs deleted** â Mike UI-deleted 5 quarantined fields, then unused SA text `XP Events` / `XP Events copy`; live Meta **1363** fields / **35** tables; batch-1 schema `airtable/schema/snapshots/prod-20260831-fut002-batch1/`; evidence [`testing/evidence/fut-002/batch1-live-verify.json`](./testing/evidence/fut-002/batch1-live-verify.json) Â· [`testing/evidence/fut-002/sa-xp-text-stubs-deleted-2026-08-31.json`](./testing/evidence/fut-002/sa-xp-text-stubs-deleted-2026-08-31.json). Later inventory batches remain FUTURE |
...
| **020** | **v4.0** | v4.0 | Live / **PASTE-ALIGNED** (SC-160 Stage 6 2026-09-04) | HC Week = PHA.Week; Submission.Week optional; Early/On Time/Late Notes. Evidence [`audits/SC-160-STAGE6-LIVE-VERIFICATION-20260904.md`](./audits/SC-160-STAGE6-LIVE-VERIFICATION-20260904.md) |
...
| **067** | **v3.5** | v3.5 | **Live / COMPLETE / DO-NOT-TOUCH** | Reflection quiz â Homework Completion. Automations Code 2026-09-03 SCRIPT **v3.5**. Do not edit this closeout wave |
...
- Optional Automations Code **tracker** text refresh for 057 (live script already correct â do not repaste)
