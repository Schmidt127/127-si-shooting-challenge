...
| Structured Curriculum Hub cutover | **PARTIAL** (2026-09-10) — SC routes live (401 not 404); Hub **Submission Outbox retry fields COMPLETE** (Mike UI); Hub Production redeem/submit URLs still empty at prep. Checklist [`deploy-checklists/structured-curriculum-hub-production-cutover.md`](./deploy-checklists/structured-curriculum-hub-production-cutover.md) · Outbox [`deploy-checklists/HUB-SUBMISSION-OUTBOX-RETRY-FIELDS.md`](./deploy-checklists/HUB-SUBMISSION-OUTBOX-RETRY-FIELDS.md) |
