...
|------|---------|-------------------|
| **A — Trustworthy (verified_prod or strong recent proof)** | Live path proven or recently pasted | **072 v4.0**, **074 v2.1** (+ Live sendMode), **118/119 v1.4** (**schedules ON** — see STALE-CLAIM-CORRECTION), Make Bulk Email May 18 Live writeback, **070b/070c**, **117** Stage 17, **066 v3.3** / **054 v5.6** |
