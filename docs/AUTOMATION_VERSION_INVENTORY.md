...
| 005 | Submission Intake — Assign Week to Submission — Homework First | **v5.3** | UNKNOWN | 2026-05-20 | *confirm in Airtable* | UNKNOWN — confirm in Airtable UI | recordId | UNKNOWN — confirm in DEV Airtable UI | UNKNOWN — confirm in PROD Airtable UI | GitHub SCRIPT v5.3 | Verify live trigger/version against GitHub before promote |
