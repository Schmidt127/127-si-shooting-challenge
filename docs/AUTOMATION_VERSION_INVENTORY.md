...
| 010 | Submission Intake — Create XP Event from Submission | **v10.11** | 2026-08-21 | 2026-06-06 | Submissions when `Count This Submission?` checked and XP should be awarded | Controlled Testing3 path passed | Current controlled path passed | **Production v10.11** (run history); GitHub v10.11 | PKG-006R v10.9 + midday v10.10 Code-column snapshot are historical; preserve `SUBMISSION_XP|{submissionId}` | None — reconciled |
...
| 057 | Achievements — Calculate Perfect Week Eligibility | **1.7** | 2026-08-21 | 2026-05-30 | Weekly Athlete Summary Perfect Week queue / helpers | Confirm in Airtable UI | recordId | n/a | **Live / 1.7** | Eligibility helpers only; order **057→058→059** | Do not award early while Days Logged &lt; 7 |
