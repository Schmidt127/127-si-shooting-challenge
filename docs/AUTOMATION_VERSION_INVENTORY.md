...
| 058 | Achievements — Create Perfect Week Unlock | **1.5** | 2026-08-29 | 2026-05-30 | Weekly Athlete Summary lifecycle (Eligible/Ready; not positive-only) | Confirm in Airtable UI | recordId | n/a | **Repo 1.5 — paste pending** | Unlock **Milestone Source Key** `PERFECT_WEEK|{enr}|{week}`; Coach Note | Paste [`058-v1.5-milestone-source-key.md`](./deploy-checklists/058-v1.5-milestone-source-key.md); SC-PW-E2E BLOCKED until WAS proof |
| 059 | Achievements — Create XP Event from Achievement Unlock | **v3.7** | 2026-08-29 | 2026-06-05 | **Recommended:** record **created** · XP Award Status Pending — **Do NOT filter on Ready for 059 XP**; do not require Shot Milestone | Confirm UI matches recommended trigger | recordId | n/a | **Repo v3.7 — paste with 058 v1.5** | Perfect Week prefers Unlocks **Milestone Source Key**; Coach Note | Confirm dynamic recordId |
