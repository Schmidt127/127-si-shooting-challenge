...
**Last updated:** 2026-08-23 (autonomous QA continuation — 072 v4.3, prod version API read, SUBMISSION_XP repairs)  
...
| 057 | Achievements — Calculate Perfect Week Eligibility | **1.9** | 2026-08-21 | 2026-05-30 | Weekly Athlete Summary Perfect Week queue / helpers | Confirm in Airtable UI | recordId | n/a | **Live / Code v1.8** (API 2026-08-23) | GitHub 1.9 goal settlement | **Paste v1.9** — [`057-v1.9-goal-settlement-fix.md`](./deploy-checklists/057-v1.9-goal-settlement-fix.md) |
...
| 065 | Homework Review — Create/Reconcile Homework XP Event | **v10.2** | 2026-08-21 | 2026-06-06 | Homework XP Reconciliation Needed? = 1 | Confirm in Airtable UI | recordId | n/a | **Live / v10.2** (final 2026-08-21) | Source Key HOMEWORK_XP|{HC ID}; does **not** set Parent Feedback Ready? | None — reconciled |
...
| 072 | Email — Build Weekly Summary Email Package | **v4.3** | 2026-08-23 | 2026-06-20 | Weekly Athlete Summary when `Build Weekly Email Now?` checked | UNKNOWN — confirm in Airtable UI | recordId | n/a | **Live / Code v4.2** (API 2026-08-23) | GitHub v4.3 WAS-linked XP reconciliation | **Paste v4.3** — [`072-v4.3-was-linked-xp-reconciliation.md`](./deploy-checklists/072-v4.3-was-linked-xp-reconciliation.md) |
