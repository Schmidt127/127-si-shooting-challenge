...
**Last updated:** 2026-08-24 (master reconciliation — 057 v2.0 grace live-tested; weekly email E2E; 065/066 repo fix)  
...
| 065 | Homework Review — Create/Reconcile Homework XP Event | **v10.3** | 2026-08-24 | 2026-06-06 | Homework XP Reconciliation Needed? = 1 | Confirm in Airtable UI | recordId | n/a | **Live / v10.2** (paste **v10.3** pending) | GitHub dynamic `recordId` (PR #256); E2E test required manual settlement | [`065-066-v10.3-v3.9-dynamic-trigger-record.md`](./deploy-checklists/065-066-v10.3-v3.9-dynamic-trigger-record.md) |
| 066 | 066 - Achievements and Milestones - Create Shot Milestone Unlocks | **v3.9** | 2026-08-24 | 2026-06-17 | Enrollments · Run Shot Milestone Check? | UNKNOWN — confirm in Airtable UI | recordId | UNKNOWN — confirm in DEV UI | **ON / v3.8** (paste **v3.9** pending) | GitHub dynamic `recordId` (PR #256); E2E test required manual settlement | [`065-066-v10.3-v3.9-dynamic-trigger-record.md`](./deploy-checklists/065-066-v10.3-v3.9-dynamic-trigger-record.md) |
