...
**Last updated:** 2026-09-03 (Automation **003** v2.0 COMPLETE / PRODUCTION-VERIFIED — SC-023 disposable VERIFY Enrollment; keep active. Prior same-day: parent-email Live cutover audit — GitHub versions 071 v4.3, 072 v4.9.1, 073 v4.6, 074 v3.5, 076 v8.12, 078A v1.5, 079 v2.5, 117 v2.1, 118 v2.0, 119 v1.7)  
...
| Additional PROD-verified overlays | **003 v2.0** COMPLETE / PRODUCTION-VERIFIED 2026-09-03 (SC-023; keep active) |
...
| **003** | Enrollment Intake and Setup — Assign Grade Band — If Grade Changes | **v2.0** | 2026-05-20 | 2026-05-20 | Enrollments · enters view **Automation - 003 - Grade Band Refresh Needed** | Grade Band / Grade / Athlete not empty; `Grade Band Refresh Needed = 1` | Dynamic `recordId` (triggering Enrollment) | n/a (Production only) | **COMPLETE / PRODUCTION-VERIFIED** — **Live / enabled / keep active** (Mike disposable VERIFY Enrollment 2026-09-03) | GitHub v2.0; [`prod-completion/2026-09-03/AUTOMATION-003-GRADE-CHANGE-VERIFIED.md`](./prod-completion/2026-09-03/AUTOMATION-003-GRADE-CHANGE-VERIFIED.md); offline `tests/enrollment-intake/automation-003-grade-change-refresh.test.js` | Keep active — grade-change safeguard; initial assign remains **002**; do not retire as unused slot |
...
| 020 | Homework — Link or Create Homework Completion | **v3.9** | 2026-09-03 | 2026-05-20 | Submission Assets when homework asset ready | Controlled HW path | Controlled HW1/HW2 path passed | n/a | **Repo v3.9 — Production paste pending** ([late-credit checklist](./deploy-checklists/homework-late-credit-policy-020-065-057.md)) | Late = full credit (Notes); Enrollment+PHA identity | Pending paste |
...
| 057 | Achievements — Calculate Perfect Week Eligibility | **2.3** | 2026-09-03 | 2026-05-30 | Weekly Athlete Summary Perfect Week queue / helpers | Confirm in Airtable UI | recordId | n/a | **Repo 2.3 — Production paste pending** ([late-credit checklist](./deploy-checklists/homework-late-credit-policy-020-065-057.md)) | Excludes late HC from PW homework gate; video minimum Config | Pending paste |
...
| 065 | Homework Review — Create/Reconcile Homework XP Event | **v10.6** | 2026-09-03 | 2026-06-06 | Homework XP Reconciliation Needed? = 1 | Confirm in Airtable UI | recordId | n/a | **Repo v10.6 — Production paste pending** ([late-credit checklist](./deploy-checklists/homework-late-credit-policy-020-065-057.md)) | Late no longer blocks XP; Satisfactory gate; `HOMEWORK_XP\|{hcId}` | Pending paste |
