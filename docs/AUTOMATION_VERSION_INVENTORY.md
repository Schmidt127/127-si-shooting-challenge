...
| 115 | 115 - Engineering Test Framework - Run Testing Scenario Daily Submission | v1.6 | 2026-07-18 | 2026-07-06 | Testing Scenarios when **Run Test?** checked | UNKNOWN — confirm in Airtable UI | recordId | v1.6 C025 042 view re-entry; Daily/HW/Video unchanged from v1.3 | Not deployed (DEV only) | C-025 ETF packet + C-020 checklist | Keep DEV-only; never paste to PROD |
