...
Production final verification overlays: **101 v6.8 Live + SC-147 verified 2026-09-02** (see inventory row). Historical 2026-08-21 summary listed **101 v6.7** (later corrected vs Code / paste history). Perfect Week controlled-path evidence: [`deploy-checklists/2026-08-21-perfect-week-test-prep-report.md`](./deploy-checklists/2026-08-21-perfect-week-test-prep-report.md). **077** remains deleted. Older UNKNOWN/OFF values and S16 117a/117b rows remain historical unless explicitly reconciled.
...
| **072** | Email — Build Weekly Summary Email Package | **v4.8** | 2026-08-24 | 2026-06-20 | Weekly Athlete Summary when `Build Weekly Email Now?` checked | **Live v4.8** (Automations MCP 2026-08-29) | recordId | n/a | **Live v4.8** | Lambda viewer URLs only | Aligned |
| 073 | Email — Send Video Feedback Parent Email Webhook | **v4.4** | 2026-08-24 | 2026-06-17 | *confirm in Airtable* | **Live v4.4** (Automations MCP 2026-08-29) | recordId | n/a | **Live / v4.4** | Lambda-only parent URL gate | Aligned |
...
| 078A | Enrollment — Create WELCOME Email Handoff | **v1.4** | 2026-08-22 | 2026-08-11 | Enrollments after Athlete + cleaned parent + PI | Live (Automations audit) | recordId | UNKNOWN | Live | GitHub SCRIPT v1.4 Hub queue create; does **not** write retired 075 Enrollment fields | 078A→079→Hub→Resend |
...
| 101 | Zoom Attendance XP — Award Meeting XP | **v6.8** | 2026-09-02 | 2026-05-28 | Zoom Meetings when **`Zoom XP Reconciliation Needed? = 1`** (sole primary condition) | Do **not** use Create XP Events / Attendees / Completed as primary trigger | recordId | obsolete — ignore | **Production v6.8 Live + SC-147 verified** 2026-09-02 (recording + live disposable proof). No Automation 121. | Evidence `VERIFY-2026-09-02-POST-PASTE.md` | Optional: refresh Automations Code tracker text |
