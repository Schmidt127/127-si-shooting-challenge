...
| 020 | Homework — Link or Create Homework Completion | **v3.8** | 2026-08-28 | 2026-05-20 | Submission Assets when homework asset ready | Controlled HW path | Controlled HW1/HW2 path passed | n/a | **Live / v3.8** (FUT-001; Automations MCP 2026-08-29) | Assignment identity Enrollment+PHA; deadline Notes | Aligned |
...
| 057 | Achievements — Calculate Perfect Week Eligibility | **2.2** | 2026-08-27 | 2026-05-30 | Weekly Athlete Summary Perfect Week queue / helpers | Confirm in Airtable UI | recordId | n/a | **Repaste required** | Code v2.2 still has typo CONFIG `MInimum` — [`057-v2.2-perfect-week-video-minimum-paste.md`](./deploy-checklists/057-v2.2-perfect-week-video-minimum-paste.md) |
...
| 065 | Homework Review — Create/Reconcile Homework XP Event | **v10.4** | 2026-08-28 | 2026-06-06 | Homework XP Reconciliation Needed? = 1 | Confirm in Airtable UI | recordId | n/a | **Live / v10.4** (FUT-001; Automations MCP 2026-08-29) | Deadline + slot-agnostic PHA | Aligned |
