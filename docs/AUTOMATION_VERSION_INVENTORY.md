...
**Last updated:** 2026-08-20 (GitHub version refresh; **077** retired per Mike-dated docs; obsolete Automations-table ban)  
...
022 Production paste is **v2.1**, 020 is **v3.6**, 070b is **v4.6**, 117 is **v2.1** Hub handoff, 066 is **v3.8**, and 010 is **v10.10** (Mike 2026-08-19). GitHub SCRIPT versions below refreshed 2026-08-20 where headers differ from older inventory rows. **077** is **deleted from Production** per Completion Master / automation-index / PKG-006 (2026-08-13) — do not treat obsolete-table “Live” as evidence. The 2026-08-16 controlled-path packet remains path evidence. Older UNKNOWN/OFF values and S16 117a/117b rows remain historical unless explicitly reconciled.
...
| Rows with strong PROD evidence | **022 v2.1**, **020 v3.6**, **070b v4.6**, **117 v2.1**, **066 v3.8**, **010 v10.10** (Mike); **077 deleted** (Mike-dated docs 2026-08-13); 070c/116 (partial historical); C-013 v4.4 closeout historical |
...
| 009 | Submission Intake — Create Submission Assets | v1.1 | 2026-08-09 | 2026-06-20 | Submissions — confirm in Airtable UI | UNKNOWN — confirm in Airtable UI | recordId | UNKNOWN — confirm in DEV Airtable UI | UNKNOWN — confirm in PROD Airtable UI | SCRIPT metadata established 2026-08-09 (v1.1) | Verify live trigger; paste only if DEV/PROD drift |
| 010 | Submission Intake — Create XP Event from Submission | **v10.11** | 2026-08-20 | 2026-06-06 | Submissions when `Count This Submission?` checked and XP should be awarded | Controlled Testing3 path passed | Current controlled path passed | **GitHub v10.11** (midnight-UTC date keys); Production paste was **v10.10** (Mike 2026-08-19) until next paste | PKG-006R v10.9 lifecycle proof 2026-08-15 historical; preserve `SUBMISSION_XP|{submissionId}` | Paste v10.11 when ready |
| 013 | Submission Intake — Create or Link Video Feedback | **v3.1.0** | UNKNOWN | 2026-05-20 | Submission Assets when video asset ready for Video Feedback prep | UNKNOWN — confirm in Airtable UI | recordId | UNKNOWN — confirm in DEV Airtable UI | UNKNOWN — confirm in PROD Airtable UI | GitHub SCRIPT v3.1.0 | Verify live trigger/version against GitHub before promote |
...
| 022 | Submission Intake — Sync Child Upload Writeback | **v2.1** | 2026-08-17 | 2026-06-21 | Submission Assets when Upload Status is Uploaded/Processing/Error and child linked | Upload Destination + child linked | recordId | UNKNOWN — confirm in DEV UI | **ON / v2.1 in Production Airtable (Mike 2026-08-19)** | 2026-08-16 path evidence in [`SC-2026-08-16-CURRENT-STATE-RECONCILIATION.md`](./prod-completion/2026-08-16/SC-2026-08-16-CURRENT-STATE-RECONCILIATION.md) (then v2.0); offline `lib/022-child-upload-writeback.test.js` | Keep GitHub aligned with Airtable v2.1 |
...
| 041 | 041 - Levels and Progression - Mark Enrollment for Level Recalculation | **5.0** | UNKNOWN | UNKNOWN | Table: XP Events Trigger: When record matches conditions  Trigger Conditions: Enrollment is not empty XP Points is greater than 0  Required  | Enrollment is not empty XP Points is greater than 0  Required Input Variable: recordId = Airtable re | recordId | UNKNOWN — confirm in DEV Airtable UI | UNKNOWN — confirm in PROD Airtable UI | GitHub SCRIPT 5.0 | Verify live trigger/version against GitHub before promote |
...
| 059 | Achievements — Create XP Event from Achievement Unlock | **v3.6** | UNKNOWN | 2026-06-05 | **Recommended:** record **created** · Shot Milestone not empty · XP Award Status Pending — **Do NOT filter on Ready for 059 XP** | UNKNOWN — confirm UI matches recommended trigger | recordId | UNKNOWN — confirm in DEV Airtable UI | UNKNOWN — confirm in PROD Airtable UI | GitHub SCRIPT v3.6 | Confirm created-trigger (not Ready-for-059 formula filter) before promote |
...
| 065 | Homework Review — Create Homework XP Event | **v10.1** | UNKNOWN | 2026-06-06 | Homework Completions when review complete, satisfactory, XP pending | UNKNOWN — confirm in Airtable UI | recordId | UNKNOWN | UNKNOWN | GitHub SCRIPT v10.1 | Homework XP after review |
| 066 | 066 - Achievements and Milestones - Create Shot Milestone Unlocks | **v3.8** | 2026-08-14 | 2026-06-17 | Enrollments · Run Shot Milestone Check? | UNKNOWN — confirm in Airtable UI | recordId | UNKNOWN — confirm in DEV UI | **ON / v3.8 in Production Airtable (Mike 2026-08-19)** | Historical: v3.3 install 2026-07-24; v3.5 existing-unlock replay 2026-08-08 | Optional OMNI sandbox (K-H1) if still open |
...
| 074 | Email — Send Weekly Summary Email Package to Make | **v3.1** | UNKNOWN | 2026-05-29 | *confirm in Airtable* | UNKNOWN — confirm in Airtable UI | recordId | UNKNOWN — confirm in DEV Airtable UI | UNKNOWN — confirm in PROD Airtable UI | GitHub SCRIPT v3.1 (filename historical; send plane is Hub→Resend) | Confirm UI + Hub routing; do not restore Make email |
...
| 079 | Email — Send queue handoff to Communications Hub | **v2.5** | UNKNOWN | UNKNOWN | Email Handoff Queue when Status is Ready — *confirm in Airtable UI* | UNKNOWN — confirm in Airtable UI | recordId | UNKNOWN — confirm in DEV Airtable UI | UNKNOWN — confirm pasted version in PROD Automations UI | GitHub SCRIPT v2.5 | Confirm UI version vs GitHub |
| 101 | Zoom Attendance XP — Award Meeting XP | **v6.6** | UNKNOWN | 2026-05-28 | Zoom Meetings when `Create XP Events` checked and meeting ready to award | UNKNOWN — confirm in Airtable UI | recordId | UNKNOWN | UNKNOWN | GitHub SCRIPT v6.6; recording credit C-025 not under 101 | Live attendance XP; recording approval email is **117** Hub handoff |
...
| 112 | Video Review — Create Video Feedback from Submission Asset | v2.1 | UNKNOWN | 2026-05-19 | **OFF — monitor before delete** (legacy duplicate of **013**; do not re-enable) | Confirm still **OFF** in Airtable UI | recordId | **Expected OFF** — confirm in DEV UI | **Expected OFF** — confirm in PROD UI | PROJECT_STATE; automation-index; V2-014 | Keep OFF; delete with **043** in maintenance window |
| 113 | Video Review — Assign Base Video XP | **v6.4** | UNKNOWN | UNKNOWN | *confirm in Airtable* | UNKNOWN — confirm in Airtable UI | recordId | UNKNOWN — confirm in DEV Airtable UI | UNKNOWN — confirm in PROD Airtable UI | GitHub SCRIPT v6.4 | Verify live trigger/version against GitHub before promote |
| 114 | Video Review — Create or Update Video XP Event | **v6.1** | UNKNOWN | 2026-05-23 | Video Feedback posted, XP positive, `Ready for XP Automation?` checked | UNKNOWN — confirm in Airtable UI | recordId | UNKNOWN | UNKNOWN | GitHub SCRIPT v6.1 | Video XP steal-guard rerun |
