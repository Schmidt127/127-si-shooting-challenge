...
| 057 | Achievements — Calculate Perfect Week Eligibility | **2.1** | 2026-08-27 | 2026-05-30 | Weekly Athlete Summary Perfect Week queue / helpers | Confirm in Airtable UI | recordId | n/a | **Repo / v2.1 pending paste** | SC-034 Config video minimum + date-key hardening | [`057-v2.1-perfect-week-config-video-minimum.md`](./deploy-checklists/057-v2.1-perfect-week-config-video-minimum.md) |
