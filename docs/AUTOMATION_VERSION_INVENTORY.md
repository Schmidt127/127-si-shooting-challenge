...
| Additional PROD-verified overlays | **003 v2.0** COMPLETE / PRODUCTION-VERIFIED / DO-NOT-TOUCH 2026-09-03 (SC-023; keep active). **067 v3.5** Live / DO-NOT-TOUCH (Automations Code 2026-09-03). Late-credit **020 v3.9 / 065 v10.6 / 057 2.3** Automations Code PASTE-ALIGNED 2026-09-03 |
...
| 010 | Submission Intake — Create XP Event from Submission | **v10.12** | 2026-08-22 | 2026-06-06 | Submissions when `Count This Submission?` checked and XP should be awarded | Controlled Testing3 path passed | Current controlled path passed | **Production Live v10.12** (Automations Code MCP 2026-08-29) | GitHub v10.12 | **Aligned** — do not re-paste |
...
| 020 | Homework — Link or Create Homework Completion | **v3.9** | 2026-09-03 | 2026-05-20 | Submission Assets when homework asset ready | Controlled HW path | Controlled HW1/HW2 path passed | n/a | **Live / v3.9 PASTE-ALIGNED** (Automations Code MCP 2026-09-03; late-credit PR **#372**) | Assignment identity Enrollment+PHA; late submissions remain credit-eligible | Aligned Code column; disposable late-HW proof **REQUIRES LIVE CONFIRMATION** |
...
| 057 | Achievements — Calculate Perfect Week Eligibility | **2.3** | 2026-09-03 | 2026-05-30 | Weekly Athlete Summary Perfect Week queue / helpers | Confirm in Airtable UI | recordId | n/a | **Live / 2.3 PASTE-ALIGNED** (Automations Code MCP 2026-09-03; late-credit PR **#372**) | Late homework excluded from Perfect Week counts; Video Minimum CONFIG preserved | Disposable PW exclusion proof **REQUIRES LIVE CONFIRMATION** |
| 058 | Achievements — Create Perfect Week Unlock | **1.5** | 2026-08-29 | 2026-05-30 | Weekly Athlete Summary lifecycle (Eligible/Ready; not positive-only) | Confirm in Airtable UI | recordId | n/a | **Live / 1.5** (Automations MCP 2026-08-29) | Unlock **Milestone Source Key**; Coach Note | Aligned — SC-PW-E2E award COMPLETE |
| 059 | Achievements — Create XP Event from Achievement Unlock | **v3.7** | 2026-08-29 | 2026-06-05 | **Recommended:** record **created** · XP Award Status Pending | Confirm UI matches recommended trigger | recordId | n/a | **Live / v3.7** (Automations MCP 2026-08-29) | Perfect Week prefers **Milestone Source Key** | Aligned |
...
| 065 | Homework Review — Create/Reconcile Homework XP Event | **v10.6** | 2026-09-03 | 2026-06-06 | Homework XP Reconciliation Needed? = 1 | Confirm in Airtable UI | recordId | n/a | **Live / v10.6 PASTE-ALIGNED** (Automations Code MCP 2026-09-03; late-credit PR **#372**) | Late homework remains full XP once satisfactory | Aligned Code column; disposable late-HW proof **REQUIRES LIVE CONFIRMATION** |
...
| 067 | Homework — Link or Create Completion from Reflection Quiz | **v3.5** | UNKNOWN | 2026-06-28 | Final Reflection Quiz Submissions when ready (created / Processing Status Pending, Enrollment set) | Confirm in Airtable UI | recordId | n/a | **Live / COMPLETE / DO-NOT-TOUCH** — Automations Code SCRIPT **v3.5** (MCP 2026-09-03) | GitHub SCRIPT v3.5 aligned with Code column | Keep Live; **DO-NOT-TOUCH** this closeout wave (do not modify with 003/101/117/SC-147) |
...
| **072** | Email — Build Weekly Summary Email Package | **v4.9.1** | 2026-08-24 | 2026-06-20 | Weekly Athlete Summary when `Build Weekly Email Now?` checked | **Live v4.9.1** (confirm in UI) | recordId, sendModeInput | n/a | **Live** (confirm UI) | Lambda viewer URLs only; raw Parent Email fallback for recipients | Aligned — see parent-email cutover checklist |
| 073 | Email — Send Video Feedback Parent Email Webhook | **v4.6** | 2026-09-02 | 2026-06-17 | *confirm in Airtable* | **Live v4.6** (confirm in UI) | recordId, testMode (optional) | n/a | **Live / v4.6** | Lambda-only parent URL gate | Aligned |
| 074 | Email — Send Weekly Summary Email Package to Make | **v3.5** | 2026-08-24 | 2026-05-29 | Weekly Athlete Summary Hub handoff when `Send to Make?` checked | **Live / live-tested** (E2E 2026-08-24) | recordId, testMode (optional) | n/a | **Live v3.5** | Hub handoff only (not Make POST) | Confirm UI matches GitHub v3.5 |
...
| 076 | Email — Build Daily Submission Email Package / Hub handoff | **v8.12** | 2026-08-20 | 2026-05-29 | *confirm in Airtable* | UNKNOWN — confirm in Airtable UI | recordId, testMode (optional) | UNKNOWN — confirm in DEV Airtable UI | UNKNOWN — confirm pasted version in PROD Automations UI | GitHub SCRIPT v8.12 Hub queue create | Daily path is 076→079→Hub→Resend; not Make 077 |
...
| 078A | Enrollment — Create WELCOME Email Handoff | **v1.5** | 2026-09-02 | 2026-08-11 | Enrollments after Athlete + cleaned parent + PI | Live (Automations audit) | recordId, testMode (optional) | UNKNOWN | Live | GitHub SCRIPT v1.5 Hub queue create; configurable `testMode` (default true); does **not** write retired 075 Enrollment fields | 078A→079→Hub→Resend |
