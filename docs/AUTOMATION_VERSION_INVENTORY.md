...
**Last updated:** 2026-08-16 (022 v2.0 Production alignment)  
...
Current controlled-path evidence is recorded in [`prod-completion/2026-08-16/SC-2026-08-16-CURRENT-STATE-RECONCILIATION.md`](./prod-completion/2026-08-16/SC-2026-08-16-CURRENT-STATE-RECONCILIATION.md). Older UNKNOWN/OFF values remain historical unless explicitly reconciled there or in a newer live evidence packet.
...
| 010 | Submission Intake — Create XP Event from Submission | v10.10 | 2026-08-16 | 2026-06-06 | Submissions when `Count This Submission?` checked and XP should be awarded | Controlled Testing3 path passed | Current controlled path passed; verify UI paste before launch | Controlled Testing3 path passed after canonical identity/date correction | Mike-supplied controlled evidence | Preserve `SUBMISSION_XP|{submissionId}` dedupe and recheck before launch |
...
| 020 | Homework — Link or Create Homework Completion | v3.6 | 2026-08-16 | 2026-05-20 | Submission Assets when homework asset ready for Homework Completion prep | 13/13 offline tests reported by Cursor | Controlled HW1/HW2 path passed; v3.6 paste/backfill evidence recorded | v3.5 controlled run passed; v3.6 attachment-copy installation requires UI confirmation | Current reconciliation packet | Confirm v3.6 paste, then rerun HW1/HW2 for idempotent no-duplicate proof |
...
| 022 | Submission Intake — Sync Child Upload Writeback | **v2.0** | 2026-08-16 | 2026-06-21 | Submission Assets when Upload Status is Uploaded/Processing/Error and child linked | Upload Destination + child linked | recordId | UNKNOWN — confirm in DEV UI | **ON / live tested 2026-08-16** (Perfect Week video writeback) | [`SC-2026-08-16-CURRENT-STATE-RECONCILIATION.md`](./prod-completion/2026-08-16/SC-2026-08-16-CURRENT-STATE-RECONCILIATION.md); offline `lib/022-child-upload-writeback.test.js` | Keep aligned with PROD; no paste unless Airtable body drifts |
...
| 059 | Achievements — Create XP Event from Achievement Unlock | v3.5 | UNKNOWN | 2026-06-05 | **Recommended:** record **created** · Shot Milestone not empty · XP Award Status Pending — **Do NOT filter on Ready for 059 XP** | UNKNOWN — confirm UI matches recommended trigger | recordId | UNKNOWN — confirm in DEV Airtable UI | UNKNOWN — confirm in PROD Airtable UI | Script RECOMMENDED TRIGGER 2026-06-24; automation-index | Confirm created-trigger (not Ready-for-059 formula filter) before promote |
...
| 066 | 066 - Achievements and Milestones - Create Shot Milestone Unlocks | v3.3 | 2026-07-24 | 2026-06-17 | Enrollments · Run Shot Milestone Check? | UNKNOWN — confirm in Airtable UI | recordId | ON / DEV ready (H-002); **PROD install recorded 2026-07-24 (v3.3)**; live OMNI sandbox still pending — offline harness PASS 2026-07-16 | Installed in PROD (v3.3 attested 2026-07-24) — confirm UI string | 066-dev-omni-confirmation-packet.md; harness PASS 2026-07-16; PROJECT_STATE | OMNI confirm Schmidt intake + crossings before closing H-002 |
...
| 070b | Email — Send Video Asset Payload to Make | v4.4 | 2026-07-11 | 2026-06-27 | Submission Assets · `Send to Make Trigger` checked · `Upload Status = Pending Link` · `Upload Destination = Video Feedback` | UNKNOWN — confirm in Airtable UI | recordId | DEV proven | **PROD COMPLETE v4.4** (C-013 2026-07-11) — async `Accepted` handoff; no timers/polling | docs/deploy-checklists/C-013-prod-*; CONFIG.version v4.4 | Hygiene only — version wording locked to script **v4.4** |
