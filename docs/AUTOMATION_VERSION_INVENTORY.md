...
| 057 | Achievements — Calculate Perfect Week Eligibility | **2.2** | 2026-08-27 | 2026-05-30 | Weekly Athlete Summary Perfect Week queue / helpers | Confirm in Airtable UI | recordId | n/a | **Repo / v2.2 pending paste** | SC-034 Config-only video minimum (`Perfect Week Video MInimum`) | [`057-v2.1-perfect-week-config-video-minimum.md`](./deploy-checklists/057-v2.1-perfect-week-config-video-minimum.md) |
