...
022 Production paste is **v2.1**, 020 is **v3.6**, 070b is **v4.7**, 117 is **v2.1** Hub handoff, 066 is **v3.8**, and 010 is **v10.10** (Mike 2026-08-19). GitHub **010** is **v10.11** (paste pending). GitHub **070a/070b** synced to Production **v4.7** (2026-08-21). **077** is **deleted from Production** per Completion Master / automation-index / PKG-006 (2026-08-13) — do not treat obsolete-table “Live” as evidence.
...
| Rows with strong PROD evidence | **022 v2.1**, **020 v3.6**, **070b v4.7**, **117 v2.1**, **066 v3.8**, **010 v10.10** (Mike); **077 deleted** (Mike-dated docs 2026-08-13); 070c/116 (partial historical); C-013 v4.4 closeout historical |
