...
| 022 | Submission Intake — Sync Child Upload Writeback | v2.0 | UNKNOWN | 2026-08-16 | Submission Assets when Upload Status is Uploaded/Processing/Error and child linked | UNKNOWN — confirm in Airtable UI | recordId | UNKNOWN — confirm in DEV Airtable UI | UNKNOWN — confirm in PROD Airtable UI | GitHub v2.0 rewrite; URL precedence Reviewer→Canonical→Drive; verify outputs | DEV paste + smoke before PROD |
