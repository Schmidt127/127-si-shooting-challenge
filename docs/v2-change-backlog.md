...
| **C-023** | File dedup by **content hash**, not title/filename | SHA-256 hash writeback **proven** on DEV hybrid path. **H3 duplicate-bytes validation** — next technical DEV test. Full duplicate policy **not closed**. | C-013, C-024 | **in progress** |
