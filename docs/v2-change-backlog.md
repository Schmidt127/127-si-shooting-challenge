...
| **C-023** | File dedup by **content hash**, not title/filename | **Stage 4C** PASS · **4D-R** Parts A–E PASS · **H3b–H3p** matrix **15/16 PASS** (H3f second enrollment **BLOCKED**). H3e homework Lambda route deployed DEV. Stage 5 consequences not implemented. | C-013, C-024 | **in progress** |
