...
| **C-023** | File dedup by **content hash**, not title/filename | **H3 PASS** · policy approved. **Stage 2A/2B complete** (local claim + contextual review; 31 unit tests). **Stage 3** DEV schema + OMNI **next gate**. No Lambda deploy yet. | C-013, C-024 | **in progress** |
