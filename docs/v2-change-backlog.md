...
| **C-023** | File dedup by **content hash**, not title/filename | **H3 PASS** · policy approved (independent upload + contextual manual review). **Stage 1 complete** — [schema + claim spec](./deploy-checklists/C-023-production-duplicate-policy.md) §10–§17. Stages 2–6 **blocked** pending Mike approval. Processing claim **designed/open**. | C-013, C-024 | **in progress** |
