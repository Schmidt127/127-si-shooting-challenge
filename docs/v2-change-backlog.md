...
| **PKG-006R** | Daily submission XP reconciliation reliability | Automation 010 owns Submission Base XP create/replay/correction with latch acknowledgement. **HF-001 (2026-08-13):** v10.7 failed when Homework XP legitimately linked to the same Submission; v10.8 scopes duplicate detection to Submission Base identity only. **010 OFF in Production** until v10.8 paste and proof. PKG-006R and PKG-036 locks remain active. | PKG-007 partial | **hotfix ready — 010 OFF; paste v10.8 pending** |
| **PKG-036** | Progression configuration and bidirectional recalculation reliability | Harden 041 queue reachability and 042 assignment/retry behavior across XP corrections, Level/Gate configuration changes, formula settlement, lifecycle changes, and maximum-level handling. 041 remains queue-only; 042 remains the sole progression assignment writer; 043 remains retired. Production-only exception authorized by Mike because no DEV Airtable exists. Mike-supplied 2026-08-13 baseline: `Progression Last Reconciled Signature` created; 12 Levels + 12 school-year gate rules verified; **041 v5.0 / 042 v4.1 paste deferred** until PKG-006R lock release. | C-025 complete; V2-013 partial | **schema installed — script paste/proof pending PKG-006R lock release** |
| **PKG-038** | Streak and shot-milestone XP corrected-history reliability | 053/054 reconcile canonical streak topology and exact `STREAK_XP` lifecycle; 066/059 reconcile current counted-shot thresholds and exact `SHOT_MILESTONE` lifecycle. Separate canonical streak blocks may earn configured thresholds again; unsupported records/events become inactive rather than deleted. | PKG-006R / PKG-036 locks; 010 remains Submission Base XP owner | **repository-ready — Production paste/proof blocked by PKG-006R + PKG-036** |
| **PKG-040** | Standings and leaderboard data-integrity reliability | Repository contract for active Enrollment identity (Athlete + Program Instance + School Year), settled Level/XP/shots, deterministic ties, required `Web - Leaderboard` scope, no broad fallback, read-only audit, executable adapter coverage, and Mike-only Production verification packet. No Airtable schema/data/view/automation change. | PKG-006R / PKG-036 correction observation locks; PKG-039 may run in parallel | **repository-ready — Production verification blocked by PKG-006R + PKG-036 locks** |
