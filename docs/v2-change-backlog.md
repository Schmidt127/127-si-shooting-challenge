...
Last updated: **2026-08-24** (weekly-summary E2E live-tested; V2-065-066-SCRIPT-INPUT-001 queued)
...
| **PKG-038** | Streak and shot-milestone XP corrected-history reliability | 053/054 reconcile canonical streak topology and exact `STREAK_XP` lifecycle; 066/059 reconcile current counted-shot thresholds and exact `SHOT_MILESTONE` lifecycle. Separate canonical streak blocks may earn configured thresholds again; unsupported records/events become inactive rather than deleted. | PKG-006R / PKG-036 locks released | **complete — Production proof passed 2026-08-16** |
