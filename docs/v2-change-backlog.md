...
| **C-023** | File dedup by **content hash**, not title/filename | **H3 PASS** · Stage 3 verified · **Stage 4A** Lambda deployed · **Stage 4B** 070b Option A repo v4.2 · **Stage 4C** direct Lambda smoke **PASS** (`recXUc3010h16Usmo`). **Stage 4D** Make path next. DEV 070b paste still open. | C-013, C-024 | **in progress** |
