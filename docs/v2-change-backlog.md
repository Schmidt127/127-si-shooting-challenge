...
| **C-023** | File dedup by **content hash**, not title/filename | **H3 PASS** · Stage 3 verified · **Stage 4A** Lambda deployed · **Stage 4B** 070b Option A repo v4.2. DEV paste pending. **Stage 4C** runtime next. | C-013, C-024 | **in progress** |
