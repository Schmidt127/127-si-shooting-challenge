...
| **C-025** | Zoom **recording** attendance — partial credit path | **Owner decisions APPROVED (2026-07-13 S16).** **DEV formulas/conflict APPLIED (2026-07-13).** Config linkage + deadline + submission verification + automation packages **designed S17** ([config linkage](./deploy-checklists/C-025-config-linkage-design.md), [deadline](./deploy-checklists/C-025-deadline-repair-design.md), [automations](./deploy-checklists/C-025-automation-packages-stage17.md)). **Next:** DEV Config field create + true deadline date + hyphen Past Deadline view; then paste 117a–f (no PROD). | C-024, V2-006, V2-005 | formulas done / Config schema blocked |
