...
| `PKG-014` | Prove level progression beyond the current baseline, blocked-gate clear, and Zoom-credit participation | `needs live proof` | §4 SC-024, SC-078–SC-080 | `PKG-009`; `PKG-010`; eligible Schmidt fixtures | Mike; Cursor | Controlled level-up, gate-clear, and replay/no-churn evidence | 2026-08-11 — Supporting proof design in PKG-006’s controlled-proof specification defines level recalculation, blocked/clear progression, rule selection, and replay evidence; no live proof or completion claim | Airtable; Mike | Create a bounded fixture plan; do not infer completion from current Gate Blocked state | 14 |
