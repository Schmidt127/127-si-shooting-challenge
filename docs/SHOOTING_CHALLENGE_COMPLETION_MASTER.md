...
Execution matrix IDs advanced: PKG-001 through PKG-032 — matrix-only
documentation; no implementation package has started and every row below
remains queued at the baseline.
