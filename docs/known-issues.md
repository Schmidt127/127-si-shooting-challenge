...
| L5 | Zoom **recording credit (C-025)** not installed in live DEV/PROD; Perfect Week / Total Zoom / post-award conflict gaps under S16 | Medium | **Repo 117a/b ready** (offline PASS). OA1 authorized DEV install **blocked** 2026-07-16 (no PAT/UI) — [C-025-dev-install-attempt-2026-07-16.md](./deploy-checklists/C-025-dev-install-attempt-2026-07-16.md). Also reconcile XP Bucket `Zoom` vs snapshot `Zoom Attendance` + add XP Source `Zoom Recording` before enable. Packet: [ZOOM_RECORDING_CREDIT_DEV_INSTALL.md](./v2/ZOOM_RECORDING_CREDIT_DEV_INSTALL.md) |
