...
| WEB-004 | In Progress | Entire website imagery | Remove the cartoonish AI-created photos from all pages. Do not use that visual style in future site work. | Inventory and replace/remove every affected image; verify every public route has no cartoonish generated imagery. |
| WEB-005 | In Progress | Landing page — upcoming programs and hero | Sort upcoming-program cards by the actual Program Instance start date: Dribble Challenge (Jan. 1, 2027), JR Ref Clinic (Mar. 27, 2027), then Shooting Challenge (May 1, 2027). Feature the next upcoming program in the hero section. | Confirm date-driven sorting from Airtable and the correct next program shown in the hero. |
| WEB-006 | In Progress | Landing-page hero | Shorten the hero headline. Remove “Fairfield Athletes”; the site serves athletes throughout the United States. | Approve concise nationwide copy and verify desktop/mobile presentation. |
| WEB-007 | In Progress | Organization/about information | Explain that 127 Sports Intensity is the legally recognized nonprofit and Fairfield Basketball Club is the program/brand covering Shooting Challenge, Dribble Challenge, JR Ref Clinic, Brackets, State Standings, and related activities. | Add clear, accurate explanation in an appropriate About/organization location and verify links/navigation. |
| WEB-008 | In Progress | Program pricing | Decide where each program’s cost should appear: landing-page cards, each program home page, or both. | Policy approved via website-fix batch instruction: concise “from / current price” on landing cards; full pricing/included/payment on each program home page. Implementing and verifying live. |
| WEB-009 | In Progress | Sitewide copy | Replace all statements that limit participation to grades 1–8 with grades 1–12. | Search all public pages, metadata, program copy, and forms/links surfaced by the site; verify no public 1–8 wording remains unless intentionally historical. |
| WEB-010 | In Progress | Shooting Challenge card typography — homework, levels, game manual, shoutouts, and similar pages | Card text appears too light/slate-gray against white backgrounds, reducing readability. Establish a more visible, polished text-color and contrast system; use Impeccable or an equivalent design review during implementation. | Audit all card components and affected routes on desktop/mobile; meet accessible contrast expectations and verify that body text, labels, and secondary text remain clearly readable. |
