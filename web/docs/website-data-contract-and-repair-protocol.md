...
| WEB-011 | Completed | Athlete XP Event Log — Game Log + dashboard ledger | Professional two-row layout with ISO dates, linked headline details (shots, homework title, video file name, Zoom meeting name), deterministic same-date sort, no duplicate rows. | Deployed 2026-08-26; commits `6625559`, `f225f04`, `68c3a45`, `3306379`; display-only (no XP calculation changes); prod smoke 50/50. |
| WEB-012 | Completed | `/shoot/homework` (FUT-014) | PHA-backed live Homework Library catalog with verified Brief Description mapping, resource links, and mobile layout. | Deployed 2026-08-26; commits `cdd2b97`, `4a26aa4`; Brief Description = `Homework Library.Brief Description - Display` (`fldAnHr3uTuDN5bs9`); vitest 406/406; prod smoke 50/50; homework-due-date 3/3. |
