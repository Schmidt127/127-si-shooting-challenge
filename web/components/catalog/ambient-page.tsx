...
const VARIANT_GLOWS: Record<NonNullable<AmbientPageProps["variant"]>, ReactNode> = {
  ...
  leaderboard: (
    <>
      <div className="absolute -left-24 top-0 h-[32rem] w-[32rem] rounded-full bg-amber-500/12 blur-3xl" />
      <div className="absolute right-0 top-20 h-96 w-96 rounded-full bg-brand-blue/15 blur-3xl" />
      <div className="absolute bottom-0 left-1/3 h-80 w-80 rounded-full bg-orange-600/8 blur-3xl" />
    </>
  ),
  homework: (
    <>
