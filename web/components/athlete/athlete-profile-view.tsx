  ...
  return (
    ...
    >
      <EmptyState
        ...
        description={`No public athlete is published for “${slug}”. Public profiles only show athletes published for the Shooting Challenge season. Private contact data is never shown here.`}
        action={
  ...
  return (
    ...
    >
      <ErrorState
        ...
        message="Something went wrong loading this public profile. Try again in a moment."
        action={
