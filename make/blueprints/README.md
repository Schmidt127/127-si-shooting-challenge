...
| [fut-003-fillout-stripe-payment-writeback.json](./fut-003-fillout-stripe-payment-writeback.json) | FUT-003 - Fillout Stripe Payment to Airtable Payment Transactions | Fillout → Custom webhook | **EXPORT_PENDING stub** — paid path validated 2026-08-26; scenario **inactive** until Mike ON. Free path deferred Nov/Dec 2026. Replace stub with redacted Make export. [checklist](../../docs/deploy-checklists/FUT-003-fillout-stripe-payment-writeback.md) · [audit 2026-09-04](../../docs/audits/FUT-003-STRIPE-STATUS-20260904.md) |
