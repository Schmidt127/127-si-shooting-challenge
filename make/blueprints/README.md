...
|----------------|----------------------|---------|---------------------|
| [upload-asset-engine-lambda-dev-v1.template.json](./upload-asset-engine-lambda-dev-v1.template.json) | Shooting Challenge - DEV - Upload Engine - Lambda - v1 | Webhook (070b video + **070a homework**) | DEV Lambda → S3 |
