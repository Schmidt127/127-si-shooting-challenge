...
**Active task (2026-07-08):** **[Lambda upload runtime](../../docs/deploy-checklists/C-013-dev-lambda-upload-plan.md)** — Airtable → Make → Lambda → S3. Make S3 **dropped**. **No deploy until plan approved.**
