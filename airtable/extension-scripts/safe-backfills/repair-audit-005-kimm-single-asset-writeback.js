/*
Extension Script: Repair Audit 005 — Kimm Single-Asset Writeback
System: 127 SI Shooting Challenge
Purpose:
  Fix #5 in the audit repair sequence (v1.2 linkage audit).

  Homework Completion: recCdWIquhJKk3Gyq
  Submission Asset: recTjCOoITb2geWFG
  (Koen Kimm — separate homework row from Fix #004)
...
const TARGET_HOMEWORK_ID = "recCdWIquhJKk3Gyq";
const TARGET_ASSET_ID = "recTjCOoITb2geWFG";
...
async function main() {
  ...
  const plan = {
    script: "repair-audit-005-kimm-single-asset-writeback",
    dryRun: DRY_RUN,
  ...
  console.log("===== Repair Audit 005 — Kimm Single-Asset Writeback =====");
