/*
Extension Script: Repair Audit 006 — Kimm Single-Asset Writeback (2)
System: 127 SI Shooting Challenge
Purpose:
  Fix #6 in the audit repair sequence (v1.2 linkage audit).

  Homework Completion: recrKPDHTaI3L3EEw
  Submission Asset: rec7NSnhvAZ1vXfy7
  (Koen Kimm — second writeback-only row)
...
const TARGET_HOMEWORK_ID = "recrKPDHTaI3L3EEw";
const TARGET_ASSET_ID = "rec7NSnhvAZ1vXfy7";
...
async function main() {
  ...
  const plan = {
    script: "repair-audit-006-kimm-single-asset-writeback",
    dryRun: DRY_RUN,
  ...
  console.log("===== Repair Audit 006 — Kimm Single-Asset Writeback (2) =====");
