/*
Extension Script: Repair Audit 003 — Geraghty HW9 Multi-Asset + Writeback
System: 127 SI Shooting Challenge
Purpose:
  Fix #3 in the audit repair sequence (v1.2 linkage audit).

  Homework Completion: recMP69CHUDuoAx2F
  (Geraghty, Riley — Week 9 — Sportsmanship / HW1)
  Linked assets: recY0mR21w9C9w29t, recolLCK3siJTSz9R
...
const TARGET_HOMEWORK_ID = "recMP69CHUDuoAx2F";
...
async function main() {
  ...
  const plan = {
    script: "repair-audit-003-geraghty-hw9-multi-asset-writeback",
    dryRun: DRY_RUN,
  ...
  console.log("===== Repair Audit 003 — Geraghty HW9 Multi-Asset + Writeback =====");
