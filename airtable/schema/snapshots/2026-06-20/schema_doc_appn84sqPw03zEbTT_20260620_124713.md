...
- [WARNING] Table 'Submission Assets' has 33 computed fields. | table=`Submission Assets`
- [WARNING] Table 'XP Events' has 22 computed fields. | table=`XP Events`
- [WARNING] Table 'Weekly Athlete Summary' has 46 computed fields. | table=`Weekly Athlete Summary`
- [WARNING] Table 'Homework Completions' has 25 computed fields. | table=`Homework Completions`
...
- **Legacy - Ready for Daily Email Build?**
  - id: `fldewsjv4rwSsnqOY`
  - type: `checkbox`
  - role: `contact`
  - primary: `False`
  - options summary: `{"icon":"check","color":"greenBright"}`
- **Legacy - Daily Email Build Status**
  - id: `fldcv69SOPqDrflx1`
  - type: `singleSelect`
  - role: `status`
  - primary: `False`
  - options summary: `{"choices":["Ready","Not Ready"],"choicesDetailed":[{"id":"selw3smJjCM9virZw","name":"Ready","color":"blueLight2"},{"id":"selYOyJtVV2Su8isI","name":"Not Ready","color":"cyanLight2"}]}`
- **XP Events**
...
- **Reward Rule Key**
  ...
  - role: `standard`
  - primary: `False`
- **LEGACY - XP Reward - DO NOT USE**
  - id: `fldcNSimGsKRaQ8c4`
  - type: `number`
  - role: `standard`
  - primary: `False`
  - options summary: `{"precision":0}`
...
- **Weekly Bonus XP Earned - LEGACY DO NOT USE**
  - id: `fldchvyFtKnSF7Qbj`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["flda0ZXW1Bf7OvRAK","fldNO1J6zZ1n9OcHU"],"referencedFieldNames":["Goal Completion %","Met Minimum Days Requirement?"],"formula":"IF({flda0ZXW1Bf7OvRAK} >= 1, 50, 0)\n+\nIF({fldNO1J6zZ1n9OcHU}, 25, 0)","fieldReferencesById":["flda0ZXW1Bf7OvRAK","fldNO1J6zZ1n9OcHU"],"fieldReferencesByName":["Goal Completion %","Met Minimum Days Requirement?"],"dependencySource":"metadata"}`
- **Level Number**
...
- **Award Category**
  ...
  - role: `standard`
  - primary: `False`
  - options summary: `{"choices":["Shots","XP","Homework","Zoom","Milestone","Achievement","Gift Card","Participation","Other","Video"],"choicesDetailed":[{"id":"selHCdLtiZGzendra","name":"Shots","color":"blueLight2"},{"id":"sel9Sw8OGmdI29Hxi","name":"XP","color":"cyanLight2"},{"id":"seljnYzwTIRKHZOXg","name":"Homework","color":"tealLight2"},{"id":"selG1dMyKQfFRYlMy","name":"Zoom","color":"greenLight2"},{"id":"selDwv3FBVrcydW1S","name":"Milestone","color":"yellowLight2"},{"id":"selkuKSFTrR15pvFx","name":"Achievement","color":"orangeLight2"},{"id":"selMqDk31tGbjSrYL","name":"Gift Card","color":"redLight2"},{"id":"selwhGtfRZKoD73pc","name":"Participation","color":"pinkLight2"},{"id":"selBmU6SfVFmpV3z6","name":"Other","color":"purpleLight2"},{"id":"selnP8wmm22Cnb2CH","name":"Video","color":"pinkBright"}]}`
- **Award Type**
...
- **Award Status**
  ...
  - role: `status`
  - primary: `False`
  - options summary: `{"choices":["Pending","Approved","Sent","Delivered","Cancelled"],"choicesDetailed":[{"id":"sel3GwanGB1hhM8eO","name":"Pending","color":"blueLight2"},{"id":"selMJGSlIzViC8Tky","name":"Approved","color":"cyanLight2"},{"id":"seldmtYuhvOYhUitS","name":"Sent","color":"tealLight2"},{"id":"sel8aRgrCAocKsrEG","name":"Delivered","color":"greenLight2"},{"id":"selib0bD8lLJe3cXD","name":"Cancelled","color":"yellowLight2"}]}`
...
- **Weekly Athlete Summary** → **Weekly Bonus XP Earned - LEGACY DO NOT USE** (`formula`) depends on: `Goal Completion %`, `Met Minimum Days Requirement?`
