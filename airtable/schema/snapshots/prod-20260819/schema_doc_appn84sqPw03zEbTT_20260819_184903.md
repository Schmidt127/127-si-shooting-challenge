...
- Generated: `2026-08-19T18:49:03`
- Script version: `2.4.0`
- Base ID: `appn84sqPw03zEbTT`
- Base Name: **127SI - SHOOTING CHALLENGE GAME - NEW 5_1_2026**
- Tables exported: **32**
- Links found: **166**
- Dependencies found: **490**
- Basic views exported: **126**
- Detailed view metadata exported: **126**
- Health warnings: **51**
...
- [WARNING] Table 'Submission Assets' has 37 computed fields. | table=`Submission Assets`
...
- [WARNING] Table 'Homework Completions' has 40 computed fields. | table=`Homework Completions`
...
- [WARNING] Formula field 'Lesson Key' is marked invalid. | table=`Homework Library` | field=`Lesson Key`
...
- **070 - Ready to Send Asset to Make**  
  ...
  - type: `grid`
- **2025-2026 Shooting Challenge Roster - All**  
...
- **Grid Testing View**  
  ...
  - type: `grid`
- **Grid View - Everything - 2026-2027**  
...
- **Week Lkp**
  ...
  - role: `lookup`
  - primary: `False`
  - options summary: `{"isValid":false,"recordLinkFieldId":"fldBuHIpIwxTy60js","recordLinkFieldName":"Homework Name 1"}`
- **Activity Date Key**
...
- **Lesson Key**
  ...
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":false,"referencedFieldIds":["fld3w0F60Pijeo63p"],"referencedFieldNames":["Assignment Title"],"formula":"ARRAYJOIN({column_value_flddMQ8OZdvSsvak8}) & \"|\" & ARRAYJOIN({column_value_fld69DQxhTVlmGoWh}) & \"|\" & {fld3w0F60Pijeo63p}","fieldReferencesById":["fld3w0F60Pijeo63p"],"fieldReferencesByName":["Assignment Title"],"dependencySource":"metadata"}`
- **Submissions**
...
- **Extension Activities**
  ...
  - primary: `False`
- **AI assist**
  - id: `fld7zjLYXgD4YHy45`
  - type: `multilineText`
  - role: `standard`
  - primary: `False`
- **AI assist 2**
  - id: `fldOit9YidoBVa1Wo`
  - type: `multilineText`
  - role: `standard`
  - primary: `False`
...
- **Submissions** → **Week Lkp** (`multipleLookupValues`) uses recordLinkField=`Homework Name 1`, linkedField=`None`
...
- **Homework Library** → **Lesson Key** (`formula`) depends on: `Assignment Title`
