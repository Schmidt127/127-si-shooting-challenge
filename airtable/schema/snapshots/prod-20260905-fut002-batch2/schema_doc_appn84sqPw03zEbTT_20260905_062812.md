...
- [WARNING] Table 'Zoom Meetings' has 44 computed fields. | table=`Zoom Meetings`
- [INFO] Table 'Zoom Attendance' has no description. | table=`Zoom Attendance`
- [WARNING] Table 'Zoom Attendance' has 29 computed fields. | table=`Zoom Attendance`
...
- [INFO] Field 'Zoom XP Current Signature' depends on many fields (9). | table=`Zoom Meetings` | field=`Zoom XP Current Signature`
- [INFO] Field 'Recording Pending Reconcile Token' depends on many fields (8). | table=`Zoom Attendance` | field=`Recording Pending Reconcile Token`
...
- **School Year**
  ...
  - role: `standard`
  - primary: `False`
  - options summary: `{"choices":["2025-2026","2026-2027","2027-2028","2028-2029"],"choicesDetailed":[{"id":"selOJAKUXvcjxGHdb","name":"2025-2026","color":"blueLight2"},{"id":"selpqerlgmyEtsmhK","name":"2026-2027","color":"cyanLight2"},{"id":"sel0CRVksd4U41BaI","name":"2027-2028","color":"tealLight2"},{"id":"selSfNkQsp6GMuKCa","name":"2028-2029","color":"blueLight2"}]}`
- **Athlete Email**
...
- **Ready for 009 Asset Creation?**
  ...
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fld0fKiO62UiztNQH","fld1kilHu3o3Qtlpv","fldtJS9LW3PAyCaNC","fldUvfAHi3e15Oxb7","fld0pxr2NoMx2MxBu"],"referencedFieldNames":["Enrollment","Submission Assets","HW Sub 1","HW Sub 2","Video Upload"],"formula":"IF(\n  AND(\n    {fld0fKiO62UiztNQH},\n    COUNTA({fld1kilHu3o3Qtlpv}) = 0,\n    OR(\n      COUNTA({fldtJS9LW3PAyCaNC}) > 0,\n      COUNTA({fldUvfAHi3e15Oxb7}) > 0,\n      COUNTA({fld0pxr2NoMx2MxBu}) > 0\n    )\n  ),\n  1,\n  0\n)","fieldReferencesById":["fld0fKiO62UiztNQH","fld1kilHu3o3Qtlpv","fldtJS9LW3PAyCaNC","fldUvfAHi3e15Oxb7","fld0pxr2NoMx2MxBu"],"fieldReferencesByName":["Enrollment","Submission Assets","HW Sub 1","HW Sub 2","Video Upload"],"dependencySource":"metadata"}`
- **Why Not Ready for 009?**
  - id: `fld7PEP0RfvxBJ5sx`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fld0fKiO62UiztNQH","fld1kilHu3o3Qtlpv","fldtJS9LW3PAyCaNC","fldUvfAHi3e15Oxb7","fld0pxr2NoMx2MxBu"],"referencedFieldNames":["Enrollment","Submission Assets","HW Sub 1","HW Sub 2","Video Upload"],"formula":"IF(\n  NOT({fld0fKiO62UiztNQH}),\n  \"Missing Enrollment\",\nIF(\n  COUNTA({fld1kilHu3o3Qtlpv}) > 0,\n  \"Already has Submission Assets\",\nIF(\n  AND(\n    COUNTA({fldtJS9LW3PAyCaNC}) = 0,\n    COUNTA({fldUvfAHi3e15Oxb7}) = 0,\n    COUNTA({fld0pxr2NoMx2MxBu}) = 0\n  ),\n  \"No HW Sub 1, HW Sub 2, or Video Upload attachment\",\n  \"READY\"\n)))","fieldReferencesById":["fld0fKiO62UiztNQH","fld1kilHu3o3Qtlpv","fldtJS9LW3PAyCaNC","fldUvfAHi3e15Oxb7","fld0pxr2NoMx2MxBu"],"fieldReferencesByName":["Enrollment","Submission Assets","HW Sub 1","HW Sub 2","Video Upload"],"dependencySource":"metadata"}`
- **Testing Scenarios**
...
- **Season Sim Test Record?**
  - id: `fldx964sodLvnCrWu`
  - type: `checkbox`
  - role: `standard`
  - primary: `False`
  - desc: SC-SEASON-SIM-002 gate 1 — disposable VERIFY only; hide from Fillout
  - options summary: `{"icon":"check","color":"greenBright"}`
- **Season Sim Clock Now**
  - id: `fldyxzwotgqRhHIPC`
  - type: `dateTime`
  - role: `standard`
  - primary: `False`
  - desc: SC-SEASON-SIM-002 simulated now (America/Denver) for gated Activity Date Is Future?
  - options summary: `{"dateFormat":{"name":"local","format":"l"},"timeFormat":{"name":"12hour","format":"h:mma"},"timeZone":"America/Denver"}`
- **Season Sim Test Submitted At**
  ...
  - role: `standard`
  - primary: `False`
  - desc: SC-SEASON-SIM-002 same-day surrogate; CREATED_TIME cannot be faked
  - options summary: `{"dateFormat":{"name":"local","format":"l"},"timeFormat":{"name":"12hour","format":"h:mma"},"timeZone":"America/Denver"}`
...
- **059 Lifecycle Trigger?**
  - id: `flduoz6oUJJ6SsFY6`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - desc: SC-159 lifecycle gate for Automation 059. Returns 1 for Pending+Active award/restore or Awarded+Inactive Shot Milestone withdrawal; otherwise 0.
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldHUsIkp3hF8W5kd","fldmDBm7IIP2yTGaA","fldop6wVgfxwKck0h"],"referencedFieldNames":["XP Award Status","Active?","Shot Milestone"],"formula":"IF(\n  OR(\n    AND(\n      {fldHUsIkp3hF8W5kd} = \"Pending\",\n      {fldmDBm7IIP2yTGaA}\n    ),\n    AND(\n      NOT({fldmDBm7IIP2yTGaA}),\n      {fldop6wVgfxwKck0h},\n      {fldHUsIkp3hF8W5kd} = \"Awarded\"\n    )\n  ),\n  1,\n  0\n)","fieldReferencesById":["fldHUsIkp3hF8W5kd","fldmDBm7IIP2yTGaA","fldop6wVgfxwKck0h"],"fieldReferencesByName":["XP Award Status","Active?","Shot Milestone"],"dependencySource":"metadata"}`
...
- **Perfect Week Calculation Queue?**
  ...
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldNH81lfwL5dBnAw","fldNUSqzr3H0PE5Ex","fldNvhGv57qOqbsfN","fldyFlpiRQiTpCKJz","fldH46SynZ19EosiG"],"referencedFieldNames":["Enrollment","Week","Goal Record","Perfect Week Automation Status","Perfect Week Recalc Needed?"],"formula":"IF(\n  AND(\n    LEN(ARRAYJOIN({fldNH81lfwL5dBnAw})) > 0,\n    LEN(ARRAYJOIN({fldNUSqzr3H0PE5Ex})) > 0,\n    LEN(ARRAYJOIN({fldNvhGv57qOqbsfN})) > 0,\n    OR(\n      {fldyFlpiRQiTpCKJz} = \"Pending\",\n      {fldH46SynZ19EosiG}\n    )\n  ),\n  1,\n  0\n)","fieldReferencesById":["fldNH81lfwL5dBnAw","fldNUSqzr3H0PE5Ex","fldNvhGv57qOqbsfN","fldyFlpiRQiTpCKJz","fldH46SynZ19EosiG"],"fieldReferencesByName":["Enrollment","Week","Goal Record","Perfect Week Automation Status","Perfect Week Recalc Needed?"],"dependencySource":"metadata"}`
...
- **Perfect Week Recalc Needed?**
  - id: `fldH46SynZ19EosiG`
  - type: `checkbox`
  - role: `standard`
  - primary: `False`
  - desc: SC-152 writable re-arm. When checked with Enr+Week+Goal linked, Perfect Week Calculation Queue?=1 so 057 re-enters. Cleared by 057 v2.4 on success/error.
  - options summary: `{"icon":"check","color":"greenBright"}`
...
- **Video Feedback Workflow Status**
  ...
  - role: `status`
  - primary: `False`
  - options summary: `{"choices":["Needs Review","Feedback Given","Ready for XP","Completed","Review Complete"],"choicesDetailed":[{"id":"seloZjpcMmK8xNf78","name":"Needs Review","color":"blueLight2"},{"id":"selXzY2YGvCgCt8Gt","name":"Feedback Given","color":"cyanLight2"},{"id":"sellxqIghSRaNqyJI","name":"Ready for XP","color":"tealLight2"},{"id":"sel5FFZ7cwtl1JSxI","name":"Completed","color":"greenLight2"},{"id":"selFxu7qPQ9Jwb3D2","name":"Review Complete","color":"blueLight2"}]}`
- **Writeback Complete?**
...
- **Confirm S3 Video Rename**
  - id: `fldL7sFUDGub8Yp1D`
  - type: `checkbox`
  - role: `standard`
  - primary: `False`
  - options summary: `{"icon":"check","color":"greenBright"}`
...
- **Zoom XP Current Signature**
  ...
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldacwAjVOVvf6GL3","fldPM4rI6gDjYsTnB","fldAgk3A2TuUzPiIH","fldbkE5FL3vz8bM7H","fldOi0gQkrvoBiuHs","fldttxtBTbGOfAUIB","fldCSb6OtPz0prBmK","fldxDQKJySP95xU1N","fldlwTA4ExUnEhvHu"],"referencedFieldNames":["Meeting Status","Zoom Meeting Key","Create XP Events","Attendees","Week","Zoom XP Enrollment Signature - Lkp","Zoom XP Week Signature - Lkp","Zoom XP Event Signature - Lkp","Recording Pending Reconcile Tokens"],"formula":"RECORD_ID() & \"|STATUS=\" & {fldacwAjVOVvf6GL3} & \"|KEY=\" & {fldPM4rI6gDjYsTnB} & \"|CREATE=\" & IF({fldAgk3A2TuUzPiIH}, 1, 0) & \"|ATTENDEES=\" & ARRAYJOIN({fldbkE5FL3vz8bM7H}) & \"|WEEK=\" & ARRAYJOIN({fldOi0gQkrvoBiuHs}) & \"|ENR_SIG=\" & ARRAYJOIN({fldttxtBTbGOfAUIB}) & \"|WEEK_SIG=\" & ARRAYJOIN({fldCSb6OtPz0prBmK}) & \"|EVENT_SIG=\" & ARRAYJOIN({fldxDQKJySP95xU1N}) & \"|REC_PENDING=\" & IF({fldlwTA4ExUnEhvHu}, {fldlwTA4ExUnEhvHu}, \"\")","fieldReferencesById":["fldacwAjVOVvf6GL3","fldPM4rI6gDjYsTnB","fldAgk3A2TuUzPiIH","fldbkE5FL3vz8bM7H","fldOi0gQkrvoBiuHs","fldttxtBTbGOfAUIB","fldCSb6OtPz0prBmK","fldxDQKJySP95xU1N","fldlwTA4ExUnEhvHu"],"fieldReferencesByName":["Meeting Status","Zoom Meeting Key","Create XP Events","Attendees","Week","Zoom XP Enrollment Signature - Lkp","Zoom XP Week Signature - Lkp","Zoom XP Event Signature - Lkp","Recording Pending Reconcile Tokens"],"dependencySource":"metadata"}`
...
- **Recording Pending Reconcile Tokens**
  - id: `fldlwTA4ExUnEhvHu`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldoS4n9QlLaSQQTc","recordLinkFieldName":"Zoom Attendance","fieldIdInLinkedTable":"fldweZu4WK0HbCQEo","fieldNameInLinkedTable":"Recording Pending Reconcile Token","fieldTableInLinkedTable":"Zoom Attendance"}`
- **Meeting Name**
...
- **Source Key - Lkp**
  - id: `fldgtnBFYNLQPmKf4`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fld1pUDdnK1wWRfyg","recordLinkFieldName":"XP Events","fieldIdInLinkedTable":"fldEz2RLvrYqyj2vB","fieldNameInLinkedTable":"Source Key","fieldTableInLinkedTable":"XP Events"}`
...
- **Meeting Attendee Enrollment RIDs - Lkp**
  - id: `fldI7iF8Fn2Arq3uF`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"multipleRecordLinks","resultOptions":{"isReversed":false,"prefersSingleRecordLink":false},"recordLinkFieldId":"fldH7CLQYdwFOduuk","recordLinkFieldName":"Zoom Meeting","fieldIdInLinkedTable":"fldbkE5FL3vz8bM7H","fieldNameInLinkedTable":"Attendees","fieldTableInLinkedTable":"Zoom Meetings"}`
- **Recording Pending Reconcile Token**
  - id: `fldweZu4WK0HbCQEo`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldVLhbecKJEVuK69","fld7pi4lBq4TZ7XRd","flduFM1TcM8HSLI7f","fldRgjQoEpwJZe48B","fldqwFOPxPxJFYRdD","fldI7iF8Fn2Arq3uF","fldh5HrtsgsnsDXMM","fldj1K25oDwjb2HCS"],"referencedFieldNames":["Attendance Method","Recording Quiz Satisfactory?","Zoom Credit Conflict?","Enrollment RID","Zoom Meeting RID","Meeting Attendee Enrollment RIDs - Lkp","Meeting XP Source Keys - Lkp","Meeting Zoom Meeting Key - Lkp"],"formula":"IF(\r\n  AND(\r\n    {fldVLhbecKJEVuK69} = \"Recording Quiz\",\r\n    {fld7pi4lBq4TZ7XRd},\r\n    {flduFM1TcM8HSLI7f} != 1,\r\n    {fldRgjQoEpwJZe48B},\r\n    {fldqwFOPxPxJFYRdD},\r\n    OR(\r\n      {fldI7iF8Fn2Arq3uF} = BLANK(),\r\n      IF(\r\n        ISERROR(\r\n          FIND(\r\n            {fldRgjQoEpwJZe48B},\r\n            ARRAYJOIN({fldI7iF8Fn2Arq3uF}) & \"\"\r\n          )\r\n        ),\r\n        0,\r\n        FIND(\r\n          {fldRgjQoEpwJZe48B},\r\n          ARRAYJOIN({fldI7iF8Fn2Arq3uF}) & \"\"\r\n        )\r\n      ) = 0\r\n    ),\r\n    IF(\r\n      ISERROR(\r\n        FIND(\r\n          \"ZOOM_RECORDING_CREDIT|\" & {fldRgjQoEpwJZe48B} & \"|\" & {fldqwFOPxPxJFYRdD},\r\n          ARRAYJOIN({fldh5HrtsgsnsDXMM}) & \"\"\r\n        )\r\n      ),\r\n      0,\r\n      FIND(\r\n        \"ZOOM_RECORDING_CREDIT|\" & {fldRgjQoEpwJZe48B} & \"|\" & {fldqwFOPxPxJFYRdD},\r\n        ARRAYJOIN({fldh5HrtsgsnsDXMM}) & \"\"\r\n      )\r\n    ) = 0,\r\n    IF(\r\n      ISERROR(\r\n        FIND(\r\n          \"ZOOM_LIVE|\" & {fldqwFOPxPxJFYRdD} & \"|\" & {fldRgjQoEpwJZe48B},\r\n          ARRAYJOIN({fldh5HrtsgsnsDXMM}) & \"\"\r\n        )\r\n      ),\r\n      0,\r\n      FIND(\r\n        \"ZOOM_LIVE|\" & {fldqwFOPxPxJFYRdD} & \"|\" & {fldRgjQoEpwJZe48B},\r\n        ARRAYJOIN({fldh5HrtsgsnsDXMM}) & \"\"\r\n      )\r\n    ) = 0,\r\n    OR(\r\n      {fldj1K25oDwjb2HCS} = BLANK(),\r\n      IF(\r\n        ISERROR(\r\n          FIND(\r\n            \"ZOOM_ATTEND_BASE|\" &\r\n            ARRAYJOIN({fldj1K25oDwjb2HCS}) &\r\n            \"|\" &\r\n            {fldRgjQoEpwJZe48B},\r\n            ARRAYJOIN({fldh5HrtsgsnsDXMM}) & \"\"\r\n          )\r\n        ),\r\n        0,\r\n        FIND(\r\n          \"ZOOM_ATTEND_BASE|\" &\r\n          ARRAYJOIN({fldj1K25oDwjb2HCS}) &\r\n          \"|\" &\r\n          {fldRgjQoEpwJZe48B},\r\n          ARRAYJOIN({fldh5HrtsgsnsDXMM}) & \"\"\r\n        )\r\n      ) = 0\r\n    )\r\n  ),\r\n  {fldRgjQoEpwJZe48B} & \"|\" & {fldqwFOPxPxJFYRdD} & \"|REC\",\r\n  \"\"\r\n)","fieldReferencesById":["fldVLhbecKJEVuK69","fld7pi4lBq4TZ7XRd","flduFM1TcM8HSLI7f","fldRgjQoEpwJZe48B","fldqwFOPxPxJFYRdD","fldI7iF8Fn2Arq3uF","fldh5HrtsgsnsDXMM","fldj1K25oDwjb2HCS"],"fieldReferencesByName":["Attendance Method","Recording Quiz Satisfactory?","Zoom Credit Conflict?","Enrollment RID","Zoom Meeting RID","Meeting Attendee Enrollment RIDs - Lkp","Meeting XP Source Keys - Lkp","Meeting Zoom Meeting Key - Lkp"],"dependencySource":"metadata"}`
- **Meeting XP Source Keys - Lkp**
  - id: `fldh5HrtsgsnsDXMM`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldH7CLQYdwFOduuk","recordLinkFieldName":"Zoom Meeting","fieldIdInLinkedTable":"fldgtnBFYNLQPmKf4","fieldNameInLinkedTable":"Source Key - Lkp","fieldTableInLinkedTable":"Zoom Meetings"}`
- **Meeting Zoom Meeting Key - Lkp**
  - id: `fldj1K25oDwjb2HCS`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldH7CLQYdwFOduuk","recordLinkFieldName":"Zoom Meeting","fieldIdInLinkedTable":"fldPM4rI6gDjYsTnB","fieldNameInLinkedTable":"Zoom Meeting Key","fieldTableInLinkedTable":"Zoom Meetings"}`
- **RecordId**
...
- **Submissions** → **Ready for 009 Asset Creation?** (`formula`) depends on: `Enrollment`, `Submission Assets`, `HW Sub 1`, `HW Sub 2`, `Video Upload`
- **Submissions** → **Why Not Ready for 009?** (`formula`) depends on: `Enrollment`, `Submission Assets`, `HW Sub 1`, `HW Sub 2`, `Video Upload`
...
- **Athlete Achievement Unlocks** → **059 Lifecycle Trigger?** (`formula`) depends on: `XP Award Status`, `Active?`, `Shot Milestone`
...
- **Weekly Athlete Summary** → **Perfect Week Calculation Queue?** (`formula`) depends on: `Enrollment`, `Week`, `Goal Record`, `Perfect Week Automation Status`, `Perfect Week Recalc Needed?`
...
- **Zoom Meetings** → **Zoom XP Current Signature** (`formula`) depends on: `Meeting Status`, `Zoom Meeting Key`, `Create XP Events`, `Attendees`, `Week`, `Zoom XP Enrollment Signature - Lkp`, `Zoom XP Week Signature - Lkp`, `Zoom XP Event Signature - Lkp`, `Recording Pending Reconcile Tokens`
...
- **Zoom Meetings** → **Recording Pending Reconcile Tokens** (`rollup`) uses recordLinkField=`Zoom Attendance`, linkedField=`Recording Pending Reconcile Token`
...
- **Zoom Meetings** → **Source Key - Lkp** (`multipleLookupValues`) uses recordLinkField=`XP Events`, linkedField=`Source Key`
...
- **Zoom Attendance** → **Meeting Attendee Enrollment RIDs - Lkp** (`multipleLookupValues`) uses recordLinkField=`Zoom Meeting`, linkedField=`Attendees`
- **Zoom Attendance** → **Recording Pending Reconcile Token** (`formula`) depends on: `Attendance Method`, `Recording Quiz Satisfactory?`, `Zoom Credit Conflict?`, `Enrollment RID`, `Zoom Meeting RID`, `Meeting Attendee Enrollment RIDs - Lkp`, `Meeting XP Source Keys - Lkp`, `Meeting Zoom Meeting Key - Lkp`
- **Zoom Attendance** → **Meeting XP Source Keys - Lkp** (`multipleLookupValues`) uses recordLinkField=`Zoom Meeting`, linkedField=`Source Key - Lkp`
- **Zoom Attendance** → **Meeting Zoom Meeting Key - Lkp** (`multipleLookupValues`) uses recordLinkField=`Zoom Meeting`, linkedField=`Zoom Meeting Key`
