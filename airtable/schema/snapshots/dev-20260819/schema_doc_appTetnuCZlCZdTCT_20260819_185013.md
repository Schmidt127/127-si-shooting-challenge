...
- Generated: `2026-08-19T18:50:21`
- Script version: `2.4.0`
- Base ID: `appTetnuCZlCZdTCT`
- Base Name: **127SI - SHOOTING CHALLENGE - DEV**
- Tables exported: **32**
- Links found: **154**
- Dependencies found: **481**
- Basic views exported: **129**
- Detailed view metadata exported: **129**
- Health warnings: **42**
...
- [WARNING] Table 'Zoom Meetings' has 83 computed fields. | table=`Zoom Meetings`
- [WARNING] Table 'Zoom Attendance' has 24 computed fields. | table=`Zoom Attendance`
- [WARNING] Table 'Final Reflection Quiz Submissions' has 25 computed fields. | table=`Final Reflection Quiz Submissions`
- [INFO] Table 'SYNC - Brackets' has no description. | table=`SYNC - Brackets`
...
- [INFO] Field 'Zoom XP Percentage' depends on many fields (6). | table=`Zoom Meetings` | field=`Zoom XP Percentage`
- [INFO] Field 'Zoom Credit Debug' depends on many fields (10). | table=`Zoom Meetings` | field=`Zoom Credit Debug`
...
- **Config** → **Program Instance - Synced** via **Program Instance** (inverse: _Config_; single?: `False`)
- **Config** → **Zoom Meetings** via **Zoom Meetings** (inverse: _Config (Program Scope)_; single?: `False`)
- **Config** → **Zoom Meetings** via **Zoom Meetings 2** (inverse: _Config (Global Scope)_; single?: `False`)
...
- **Final Reflection Quiz Submissions** → **Testing Scenarios** via **Testing Scenarios** (inverse: _Pipeline Entity Linked_; single?: `False`)
...
- **Program Instance - Synced** → **Config** via **Config** (inverse: _Program Instance_; single?: `False`)
...
- **Testing Scenarios** → **FBC Curriculum - SYNC** via **Homework Assignment** (inverse: _Testing Scenarios_; single?: `True`)
- **Testing Scenarios** → **Submissions** via **Linked Submission** (inverse: _Testing Scenarios_; single?: `True`)
- **Testing Scenarios** → **Final Reflection Quiz Submissions** via **Pipeline Entity Linked** (inverse: _Testing Scenarios_; single?: `True`)
- **Testing Scenarios** → **Enrollments** via **Related Enrollment** (inverse: _Testing Scenarios_; single?: `True`)
- **Testing Scenarios** → **Homework Completions** via **Relevant Homework Completion** (inverse: _Testing Scenarios_; single?: `True`)
...
- **Zoom Meetings** → **Config** via **Config (Global Scope)** (inverse: _Zoom Meetings 2_; single?: `False`)
- **Zoom Meetings** → **Config** via **Config (Program Scope)** (inverse: _Zoom Meetings_; single?: `False`)
...
### Unknown Table
- **002 - Submissions Ready for Homework Completion**  
  - id: `viwzWRTwfwQrbz1NM`  
  - type: `grid`
- **020 - Ready to Link Homework Completion**  
  - id: `viw13hPC2X2Cxcl6c`  
  - type: `grid`
- **030 - Assign Grade Band and Goal Record**  
  - id: `viwGlczA6iOB2CwSw`  
  - type: `grid`
- **042 - Needs Level Assignment**  
  - id: `viwm9OgwkPKI2bii3`  
  - type: `grid`
- **070 - Ready to Send Asset to Make**  
  - id: `viwPlmXDSf78jt6Ht`  
  - type: `grid`
- **ADMIN - DUPLICATE SUMMARY CLEANUP - OK TO DELTE**  
  - id: `viwb3YN5G8Md20q2K`  
  - type: `grid`
- **Active Rules Only**  
  - id: `viwBm5yGP9Ge83E9R`  
  - type: `grid`
- **Admin - Duplicate Weekly Threshold XP**  
  - id: `viwXJaiAyRifGjmzC`  
  - type: `grid`
- **Admin - Field Cleanup - Enrollments**  
  - id: `viwA2S2uJQ4VuHKS2`  
  - type: `grid`
- **Assign Enrollment to Submission**  
  - id: `viwPfXT0GwkI0VKV0`  
  - type: `grid`
- **Assign Week Automation**  
  - id: `viwtvJ6jRC344aaNa`  
  - type: `grid`
- **Athlete Table Check**  
  - id: `viwLSS0Rb0lRPFZCW`  
  - type: `grid`
- **Automation - 001 - Needs Athlete Link**  
  - id: `viwNV87i8BwPBxYlq`  
  - type: `grid`
- **Automation - 002 - Needs Grade Band**  
  - id: `viwitHfNChfwjvFkr`  
  - type: `grid`
- **Automation - 003 - Grade Band Refresh Needed**  
  - id: `viwWfoiEzXoIIcBse`  
  - type: `grid`
- **CHECK - Streak Duplicate Checker**  
  - id: `viwbXSbZjE2ksLspo`  
  - type: `grid`
- **CHECK - Streak Unlocks Created**  
  - id: `viw5Uwh9RbYSsMWpm`  
  - type: `grid`
- **CHECK - Weekly Threshold Duplicates copy**  
...
- **Contact Emails**  
  ...
  - type: `grid`
- **Create XP Event after Meeting**  
  - id: `viwh3KmPC0T8ICM7Y`  
  - type: `grid`
- **Current Award List Only - Active**  
  - id: `viwTvRZ7Jph4sO1ss`  
  - type: `grid`
- **Current Program Instance Only**  
  - id: `viwTEBb0ZxBzBSJMw`  
  - type: `grid`
- **DUPLICATE REVIEW**  
  - id: `viwYrrCCBDPyh44HF`  
  - type: `grid`
- **Daily Submission Email Flow Only**  
...
- **EMPTY Fields Check**  
  ...
  - type: `grid`
- **ENROLLMENTS - A5 - XP Award Ready**  
  - id: `viwRCz09bEvCTxOr9`  
  - type: `grid`
- **ENROLLMENTS - Needs Initial Level Assignment**  
  - id: `viwbi08N7HxOKkbxc`  
  - type: `grid`
- **Everything - Alpha**  
  - id: `viw38CUFg3rFFQ03n`  
  - type: `grid`
- **Fillout.com Form Info ONLY**  
  - id: `viwUPQyy0F1dpTG5W`  
  - type: `grid`
- **Fix Award Links - Sent ONly**  
  - id: `viw6I0oupsMDL8Bj0`  
  - type: `grid`
- **Fix Weekly Threshold Duplicates**  
...
- **Goal Conqured - Only**  
  ...
  - type: `grid`
- **Grading Video. In Order of Checkboxes**  
  - id: `viwx3YtYb9vcxOtlk`  
  - type: `grid`
- **Grid Testing View**  
  - id: `viwkuKF0uwyC0hE6D`  
  - type: `grid`
- **Grid View - Everything**  
...
- **Homework 2 Only**  
  ...
  - type: `grid`
- **Homework Completion Create Queue**  
  - id: `viw2XXs7opOP2DYY3`  
  - type: `grid`
- **Homework Record Picker View on FILLOUT.COM**  
  - id: `viwlDL7M9djLAREEj`  
  - type: `grid`
- **Level List**  
  - id: `viwDpVY4ZPtG0gP4k`  
  - type: `grid`
- **Meeting Agenda and Related Only**  
  - id: `viw5ALBxpEl6IXRju`  
  - type: `grid`
- **No Assignment Detail Info - Setting Parameters**  
  - id: `viwWGNi1Hks332lbx`  
  - type: `grid`
- **Operator View**  
  - id: `viwnfnJMPboWZzIpo`  
  - type: `grid`
- **Participation Certificate CSV Export**  
...
- **Riley**  
  ...
  - type: `grid`
- **SUBMISSIONS - 5 - XP Award Ready**  
  - id: `viwP0fsgmEzyZcKuU`  
  - type: `grid`
- **SUBMISSIONS - Weekly Athlete  Summary Builder**  
...
- **Video Upload Only**  
  ...
  - type: `grid`
- **Weekly Summary - A5 - Needs Goal Setup**  
  - id: `viwF8Yc51CD3JhF36`  
  - type: `grid`
- **Weekly Summary - A6 - Award Official Weekly XP Event**  
  - id: `viwigjO8WzotJjmB1`  
  - type: `grid`
- **Weekly Summary - A6 - Calculate Official Weekly XP**  
...
- **Workflow - Mandatory Fields**  
  ...
  - type: `grid`
- **Workflow - Required Fields Only**  
  - id: `viwTGosig4vtV0ImK`  
  - type: `grid`
- **Workflow Check**  
  - id: `viwXmpH8UIUHxz2l8`  
  - type: `grid`
- **Workflow Check - Fields to Check Only**  
  - id: `viwERev4p4vF1WtEt`  
  - type: `grid`
- **Workflow Check - Missing - Not Publishing**  
  - id: `viwAbrB2geNH4aJwj`  
  - type: `grid`
- **Workflow Check - Required Fields Only**  
...
- **Testing Scenarios**
  - id: `fldKYVEkFcbSrwczx`
  - type: `multipleRecordLinks`
  - role: `link`
  - primary: `False`
  - options summary: `{"linkedTableId":"tblEQLsXTCwx0iOd8","linkedTableName":"Testing Scenarios","inverseLinkFieldId":"fldPylkKBdhFTTDCL","inverseLinkFieldName":"Related Enrollment","prefersSingleRecordLink":false,"isReversed":false}`
- **Zoom Attendance**
  - id: `fldfMmRhD7Ubyhs5r`
  - type: `multipleRecordLinks`
  - role: `link`
  - primary: `False`
  - options summary: `{"linkedTableId":"tblfwbt6aCDCM5gUz","linkedTableName":"Zoom Attendance","inverseLinkFieldId":"fld6VA8craEkzgl8y","inverseLinkFieldName":"Enrollment","prefersSingleRecordLink":false,"isReversed":false}`
- **Public Profile Enabled**
  - id: `fldbLIaetHFQCSucg`
  - type: `checkbox`
  - role: `standard`
  - primary: `False`
  - options summary: `{"icon":"check","color":"greenBright"}`
- **Public Profile Slug**
  - id: `fldbaLY4S8TNqB4Lm`
  - type: `singleLineText`
  - role: `standard`
  - primary: `False`
...
- **Testing Scenarios**
  - id: `fldN544H8tEypxGsi`
  - type: `multipleRecordLinks`
  - role: `link`
  - primary: `False`
  - options summary: `{"linkedTableId":"tblEQLsXTCwx0iOd8","linkedTableName":"Testing Scenarios","inverseLinkFieldId":"fld4DCoxCVBqmBzfh","inverseLinkFieldName":"Linked Submission","prefersSingleRecordLink":false,"isReversed":false}`
- **Video Feedback Focus**
  - id: `fldSTI343fmLXDraM`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - options summary: `{"choices":["Shooting","Layups / Finishing","Ball Handling","Free Throws","Footwork / Defense","Strength / Movement","General Basketball","Other"],"choicesDetailed":[{"id":"selIe0mZdFZIcrZPt","name":"Shooting","color":"blueLight2"},{"id":"selCLiEuFxpYihYNh","name":"Layups / Finishing","color":"cyanLight2"},{"id":"selqmfHTFqcN7wyr0","name":"Ball Handling","color":"tealLight2"},{"id":"selYJ2kO3QO9ffiZ0","name":"Free Throws","color":"greenLight2"},{"id":"seljG0F6cq0Ty03vC","name":"Footwork / Defense","color":"yellowLight2"},{"id":"selqP4nCNc5UxYzGw","name":"Strength / Movement","color":"orangeLight2"},{"id":"seldlxPnQexfV8cPX","name":"General Basketball","color":"redLight2"},{"id":"selikMz6neLgJjt5Y","name":"Other","color":"pinkLight2"}]}`
- **Garbage Temp can be delted safely at any time.**
  - id: `fldBc8JQckPSbbfIH`
  - type: `checkbox`
  - role: `standard`
  - primary: `False`
  - options summary: `{"icon":"check","color":"greenBright"}`
...
- **Asset Reuse Decision**
  ...
  - role: `standard`
  - primary: `False`
  - options summary: `{"choices":["Not Reviewed","Allowed — Legitimate Reuse","Allowed — Correction/Resubmission","Confirmed Duplicate","Unable to Determine","Resolved — Duplicate Record Error","Approved Reuse","False Positive"],"choicesDetailed":[{"id":"selzPjnNd8ZgWGHJy","name":"Not Reviewed","color":"blueLight2"},{"id":"sel0ydjgAhKLSVokj","name":"Allowed — Legitimate Reuse","color":"cyanLight2"},{"id":"selUonrXL34W3VBBf","name":"Allowed — Correction/Resubmission","color":"tealLight2"},{"id":"selPYKmmWmOhsgnAj","name":"Confirmed Duplicate","color":"greenLight2"},{"id":"sellQHHgzC6ZZZsFg","name":"Unable to Determine","color":"yellowLight2"},{"id":"selVOFXUMJvx1PwA9","name":"Resolved — Duplicate Record Error","color":"orangeLight2"},{"id":"sel8dXoIHiBCaKngo","name":"Approved Reuse","color":"blueLight2"},{"id":"selvOIJ5WuwmDL8Nn","name":"False Positive","color":"blueLight2"}]}`
...
- **Duplicate Resolution Last Applied Decision**
  - id: `fld5CtionANLScNlZ`
  - type: `singleLineText`
  - role: `standard`
  - primary: `False`
- **Calculation**
  - id: `fldzFo5To0DXi94OS`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - desc: Displays the record id for this record.
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldXz9TNOnGeRXEL8"],"referencedFieldNames":["RecordId"],"formula":"{fldXz9TNOnGeRXEL8}","fieldReferencesById":["fldXz9TNOnGeRXEL8"],"fieldReferencesByName":["RecordId"],"dependencySource":"metadata"}`
...
- **Config**
  - id: `fldYviNLkJCyVOAtO`
  - type: `multipleRecordLinks`
  - role: `link`
  - primary: `False`
  - options summary: `{"linkedTableId":"tblRB6sh77NxjS568","linkedTableName":"Config","inverseLinkFieldId":"fld9KuUMhOAavlk2Y","inverseLinkFieldName":"Program Instance","prefersSingleRecordLink":false,"isReversed":false}`
...
- **Order**
  ...
  - options summary: `{"precision":0}`
- **Testing Scenarios**
  - id: `fld5Qz1U6X1aO6urv`
  - type: `multipleRecordLinks`
  - role: `link`
  - primary: `False`
  - options summary: `{"linkedTableId":"tblEQLsXTCwx0iOd8","linkedTableName":"Testing Scenarios","inverseLinkFieldId":"fldKmXmdPtpFxP9Vm","inverseLinkFieldName":"Homework Assignment","prefersSingleRecordLink":false,"isReversed":false}`
...
- **Final Reflection Quiz Submissions 2**
  ...
  - primary: `False`
- **Testing Scenarios**
  - id: `fldfoQWecOLx9QKP7`
  - type: `multipleRecordLinks`
  - role: `link`
  - primary: `False`
  - options summary: `{"linkedTableId":"tblEQLsXTCwx0iOd8","linkedTableName":"Testing Scenarios","inverseLinkFieldId":"fldD1xEqr5fyFluuN","inverseLinkFieldName":"Relevant Homework Completion","prefersSingleRecordLink":false,"isReversed":false}`
- **Linked Asset Reuse Decision**
  - id: `fldoaYnomxExYfhRN`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldKy5hltmJc6A8Jx","recordLinkFieldName":"Submission Assets","fieldIdInLinkedTable":"fldd9Zi6WUBOedtuY","fieldNameInLinkedTable":"Asset Reuse Decision","fieldTableInLinkedTable":"Submission Assets"}`
- **Activity XP Display Label**
  - id: `fldhFRX0BAvAsrb0x`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldoaYnomxExYfhRN"],"referencedFieldNames":["Linked Asset Reuse Decision"],"formula":"IF(\n  FIND(\"Confirmed Duplicate\", ARRAYJOIN({fldoaYnomxExYfhRN} & \"\")),\n  \"Confirmed Duplicate — 0 XP\",\n  \"\"\n)","fieldReferencesById":["fldoaYnomxExYfhRN"],"fieldReferencesByName":["Linked Asset Reuse Decision"],"dependencySource":"metadata"}`
...
- **Video Feedback Focus**
  - id: `fldIJcZal1D2kObdz`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - options summary: `{"choices":["Shooting","Layups / Finishing","Ball Handling","Free Throws","Footwork / Defense","Strength / Movement","General Basketball","Other"],"choicesDetailed":[{"id":"selcjLqrScMntBTUh","name":"Shooting","color":"blueLight2"},{"id":"selfIlVpwRL7ExoGq","name":"Layups / Finishing","color":"cyanLight2"},{"id":"selWKg3msOFsbae25","name":"Ball Handling","color":"tealLight2"},{"id":"selTtdy4Iz89x7S6s","name":"Free Throws","color":"greenLight2"},{"id":"selkSX9aOhBdkOCWM","name":"Footwork / Defense","color":"yellowLight2"},{"id":"sele1jAjWXL7PlUuY","name":"Strength / Movement","color":"orangeLight2"},{"id":"sel9mXcuKtLzisyx6","name":"General Basketball","color":"redLight2"},{"id":"selSx59wAToQWWbpP","name":"Other","color":"pinkLight2"}]}`
- **Video Feedback Question**
  - id: `fldzxIbOhjSrePq18`
  - type: `multilineText`
  - role: `identifier`
  - primary: `False`
- **Coach Video Title**
  - id: `fldjyNcpzpWQAI4Ml`
  - type: `singleLineText`
  - role: `identifier`
  - primary: `False`
- **Linked Asset Reuse Decision**
  - id: `fldR61pyRqd2IuWMP`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fld9laOK9yRAxgsph","recordLinkFieldName":"Submission Asset","fieldIdInLinkedTable":"fldd9Zi6WUBOedtuY","fieldNameInLinkedTable":"Asset Reuse Decision","fieldTableInLinkedTable":"Submission Assets"}`
- **Activity XP Display Label**
  - id: `fldGU27IKWxKIElqF`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldR61pyRqd2IuWMP"],"referencedFieldNames":["Linked Asset Reuse Decision"],"formula":"IF(\n  FIND('Confirmed Duplicate', ARRAYJOIN({fldR61pyRqd2IuWMP} & '')),\n  'Confirmed Duplicate — 0 XP',\n  ''\n)","fieldReferencesById":["fldR61pyRqd2IuWMP"],"fieldReferencesByName":["Linked Asset Reuse Decision"],"dependencySource":"metadata"}`
...
- **Effective Recording XP Percentage**
  - id: `fldgBdBIDvjMELY3o`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldFCW9Eck9bbrKel","fld5KGepq4YRRck99","fldYKUZQcvZi0ir2Q"],"referencedFieldNames":["Recording XP Percentage — Meeting Override","Program Config: Recording XP %","Global Config: Recording XP %"],"formula":"IF(\r\n  {fldFCW9Eck9bbrKel} != BLANK(),\r\n  {fldFCW9Eck9bbrKel},\r\n  IF(\r\n    {fld5KGepq4YRRck99} != BLANK(),\r\n    {fld5KGepq4YRRck99},\r\n    IF(\r\n      {fldYKUZQcvZi0ir2Q} != BLANK(),\r\n      {fldYKUZQcvZi0ir2Q},\r\n      50\r\n    )\r\n  )\r\n)","fieldReferencesById":["fldFCW9Eck9bbrKel","fld5KGepq4YRRck99","fldYKUZQcvZi0ir2Q"],"fieldReferencesByName":["Recording XP Percentage — Meeting Override","Program Config: Recording XP %","Global Config: Recording XP %"],"dependencySource":"metadata"}`
- **Effective Recording Makeup Enabled?**
  - id: `fldppA7JHEbYNu3bR`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldpfyi2e66uj9BXw","fldU0awkqf7dBtCMx","fld0FuPdNHd2lTjnD"],"referencedFieldNames":["Makeup Enabled — Meeting Override","Program Config: Makeup Enabled","Global Config: Makeup Enabled"],"formula":"IF(\r\n  {fldpfyi2e66uj9BXw} = \"Yes\", TRUE(),\r\n  IF(\r\n    {fldpfyi2e66uj9BXw} = \"No\", FALSE(),\r\n    IF(\r\n      {fldU0awkqf7dBtCMx} = \"Yes\", TRUE(),\r\n      IF(\r\n        {fldU0awkqf7dBtCMx} = \"No\", FALSE(),\r\n        IF(\r\n          {fld0FuPdNHd2lTjnD} = \"Yes\", TRUE(),\r\n          IF(\r\n            {fld0FuPdNHd2lTjnD} = \"No\", FALSE(),\r\n            TRUE()\r\n          )\r\n        )\r\n      )\r\n    )\r\n  )\r\n)","fieldReferencesById":["fldpfyi2e66uj9BXw","fldU0awkqf7dBtCMx","fld0FuPdNHd2lTjnD"],"fieldReferencesByName":["Makeup Enabled — Meeting Override","Program Config: Makeup Enabled","Global Config: Makeup Enabled"],"dependencySource":"metadata"}`
- **Effective Recording Makeup Window Days**
  - id: `fldfDKHOn54ZbH7XL`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldX3pVCYNARA4FGs","fldN1opjsr97wPfTK","fldCUxvOT4MpoRcuv"],"referencedFieldNames":["Makeup Window Days — Meeting Override","Program Config: Makeup Window Days","Global Config: Makeup Window Days"],"formula":"IF(\r\n  {fldX3pVCYNARA4FGs} != BLANK(),\r\n  {fldX3pVCYNARA4FGs},\r\n  IF(\r\n    {fldN1opjsr97wPfTK} != BLANK(),\r\n    {fldN1opjsr97wPfTK},\r\n    IF(\r\n      {fldCUxvOT4MpoRcuv} != BLANK(),\r\n      {fldCUxvOT4MpoRcuv},\r\n      7\r\n    )\r\n  )\r\n)","fieldReferencesById":["fldX3pVCYNARA4FGs","fldN1opjsr97wPfTK","fldCUxvOT4MpoRcuv"],"fieldReferencesByName":["Makeup Window Days — Meeting Override","Program Config: Makeup Window Days","Global Config: Makeup Window Days"],"dependencySource":"metadata"}`
- **Effective Recording Deadline Mode**
  - id: `fldnwzUITHTzEeR5n`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldthxCJSyDoG51OB","fldiUsPQwJAXfI7VX","fldpBQTlvywnZOv23"],"referencedFieldNames":["Deadline Mode — Meeting Override","Program Config: Deadline Mode","Global Config: Deadline Mode"],"formula":"IF(\r\n  LEN(TRIM({fldthxCJSyDoG51OB} & \"\")) > 0,\r\n  {fldthxCJSyDoG51OB} & \"\",\r\n  IF(\r\n    LEN(TRIM(ARRAYJOIN({fldiUsPQwJAXfI7VX}) & \"\")) > 0,\r\n    ARRAYJOIN({fldiUsPQwJAXfI7VX}),\r\n    IF(\r\n      LEN(TRIM(ARRAYJOIN({fldpBQTlvywnZOv23}) & \"\")) > 0,\r\n      ARRAYJOIN({fldpBQTlvywnZOv23}),\r\n      \"Later of Both\"\r\n    )\r\n  )\r\n)","fieldReferencesById":["fldthxCJSyDoG51OB","fldiUsPQwJAXfI7VX","fldpBQTlvywnZOv23"],"fieldReferencesByName":["Deadline Mode — Meeting Override","Program Config: Deadline Mode","Global Config: Deadline Mode"],"dependencySource":"metadata"}`
- **Effective Recording Counts for Level Gate?**
  - id: `fldswwnnpWpiKSIL4`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldhnXwy1EfYbSy4l","fldcVNVocMh0Ciq9a","fldJxPcC8tAvqks0F"],"referencedFieldNames":["Full Gate Credit — Meeting Override","Program Config: Full Gate Credit","Global Config: Full Gate Credit"],"formula":"IF(\r\n  {fldhnXwy1EfYbSy4l} = \"Yes\", TRUE(),\r\n  IF(\r\n    {fldhnXwy1EfYbSy4l} = \"No\", FALSE(),\r\n    IF(\r\n      {fldcVNVocMh0Ciq9a} = \"Yes\", TRUE(),\r\n      IF(\r\n        {fldcVNVocMh0Ciq9a} = \"No\", FALSE(),\r\n        IF(\r\n          {fldJxPcC8tAvqks0F} = \"Yes\", TRUE(),\r\n          IF(\r\n            {fldJxPcC8tAvqks0F} = \"No\", FALSE(),\r\n            TRUE()\r\n          )\r\n        )\r\n      )\r\n    )\r\n  )\r\n)","fieldReferencesById":["fldhnXwy1EfYbSy4l","fldcVNVocMh0Ciq9a","fldJxPcC8tAvqks0F"],"fieldReferencesByName":["Full Gate Credit — Meeting Override","Program Config: Full Gate Credit","Global Config: Full Gate Credit"],"dependencySource":"metadata"}`
- **Effective Recording Counts for Perfect Week?**
  - id: `fldEfs9Xk4cIm7sqA`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["flderax8CZZC0T7Io","fld1JXcc1VIFrbprj","fldRbQVOK2hkn4XfI"],"referencedFieldNames":["Perfect Week Credit — Meeting Override","Program Config: Perfect Week Credit","Global Config: Perfect Week Credit"],"formula":"IF(\r\n  {flderax8CZZC0T7Io} = \"Yes\", TRUE(),\r\n  IF(\r\n    {flderax8CZZC0T7Io} = \"No\", FALSE(),\r\n    IF(\r\n      {fld1JXcc1VIFrbprj} = \"Yes\", TRUE(),\r\n      IF(\r\n        {fld1JXcc1VIFrbprj} = \"No\", FALSE(),\r\n        IF(\r\n          {fldRbQVOK2hkn4XfI} = \"Yes\", TRUE(),\r\n          IF(\r\n            {fldRbQVOK2hkn4XfI} = \"No\", FALSE(),\r\n            TRUE()\r\n          )\r\n        )\r\n      )\r\n    )\r\n  )\r\n)","fieldReferencesById":["flderax8CZZC0T7Io","fld1JXcc1VIFrbprj","fldRbQVOK2hkn4XfI"],"fieldReferencesByName":["Perfect Week Credit — Meeting Override","Program Config: Perfect Week Credit","Global Config: Perfect Week Credit"],"dependencySource":"metadata"}`
- **Effective Recording Quiz Requires Coach Approval?**
  - id: `fldkKRtkzO4AkNyED`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldCsxeL9J4EMtAUb","fldSIq2ipNOe6wwK9","fld0uUzrbX5MPjGcm"],"referencedFieldNames":["Coach Approval Required — Meeting Override","Program Config: Coach Approval Required","Global Config: Coach Approval Required"],"formula":"IF(\r\n  {fldCsxeL9J4EMtAUb} = \"Yes\", TRUE(),\r\n  IF(\r\n    {fldCsxeL9J4EMtAUb} = \"No\", FALSE(),\r\n    IF(\r\n      {fldSIq2ipNOe6wwK9} = \"Yes\", TRUE(),\r\n      IF(\r\n        {fldSIq2ipNOe6wwK9} = \"No\", FALSE(),\r\n        IF(\r\n          {fld0uUzrbX5MPjGcm} = \"Yes\", TRUE(),\r\n          IF(\r\n            {fld0uUzrbX5MPjGcm} = \"No\", FALSE(),\r\n            TRUE()\r\n          )\r\n        )\r\n      )\r\n    )\r\n  )\r\n)","fieldReferencesById":["fldCsxeL9J4EMtAUb","fldSIq2ipNOe6wwK9","fld0uUzrbX5MPjGcm"],"fieldReferencesByName":["Coach Approval Required — Meeting Override","Program Config: Coach Approval Required","Global Config: Coach Approval Required"],"dependencySource":"metadata"}`
- **Effective Recording Approval Email Enabled?**
  - id: `fldqPzKXweQISK4ZR`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldCWlEwhEZsJq3CJ","flduT63RW6F4ZEo0N","fld8NYdy0eIEkFFav"],"referencedFieldNames":["Approval Email Enabled — Meeting Override","Program Config: Approval Email Enabled","Global Config: Approval Email Enabled"],"formula":"IF(\r\n  {fldCWlEwhEZsJq3CJ} = \"Yes\", TRUE(),\r\n  IF(\r\n    {fldCWlEwhEZsJq3CJ} = \"No\", FALSE(),\r\n    IF(\r\n      {flduT63RW6F4ZEo0N} = \"Yes\", TRUE(),\r\n      IF(\r\n        {flduT63RW6F4ZEo0N} = \"No\", FALSE(),\r\n        IF(\r\n          {fld8NYdy0eIEkFFav} = \"Yes\", TRUE(),\r\n          IF(\r\n            {fld8NYdy0eIEkFFav} = \"No\", FALSE(),\r\n            FALSE()\r\n          )\r\n        )\r\n      )\r\n    )\r\n  )\r\n)","fieldReferencesById":["fldCWlEwhEZsJq3CJ","flduT63RW6F4ZEo0N","fld8NYdy0eIEkFFav"],"fieldReferencesByName":["Approval Email Enabled — Meeting Override","Program Config: Approval Email Enabled","Global Config: Approval Email Enabled"],"dependencySource":"metadata"}`
- **Effective Recording Approval Email Timing**
  - id: `fldT2SG7GRc7sT32u`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldcItCULgDHSaXvk","fldJOR8XjFq3Lk2HI","fldkHtwI3H00k59wN"],"referencedFieldNames":["Approval Email Timing — Meeting Override","Program Config: Approval Email Timing","Global Config: Approval Email Timing"],"formula":"IF(\r\n  LEN(TRIM({fldcItCULgDHSaXvk} & \"\")) > 0,\r\n  {fldcItCULgDHSaXvk} & \"\",\r\n  IF(\r\n    LEN(TRIM(ARRAYJOIN({fldJOR8XjFq3Lk2HI}) & \"\")) > 0,\r\n    ARRAYJOIN({fldJOR8XjFq3Lk2HI}),\r\n    IF(\r\n      LEN(TRIM(ARRAYJOIN({fldkHtwI3H00k59wN}) & \"\")) > 0,\r\n      ARRAYJOIN({fldkHtwI3H00k59wN}),\r\n      \"On Satisfactory\"\r\n    )\r\n  )\r\n)","fieldReferencesById":["fldcItCULgDHSaXvk","fldJOR8XjFq3Lk2HI","fldkHtwI3H00k59wN"],"fieldReferencesByName":["Approval Email Timing — Meeting Override","Program Config: Approval Email Timing","Global Config: Approval Email Timing"],"dependencySource":"metadata"}`
- **Effective Recording Approval Email Template Key**
  - id: `fldQtvxkRPGCJ7pq8`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fld1W33MG1RjFYMlT","fldk358UEFdwq66X7","fldpeBcgvOcDCniy1"],"referencedFieldNames":["Approval Email Template Key — Meeting Override","Program Config: Approval Email Template Key","Global Config: Approval Email Template Key"],"formula":"IF(\r\n  LEN(TRIM({fld1W33MG1RjFYMlT} & \"\")) > 0,\r\n  {fld1W33MG1RjFYMlT} & \"\",\r\n  IF(\r\n    LEN(TRIM(ARRAYJOIN({fldk358UEFdwq66X7}) & \"\")) > 0,\r\n    ARRAYJOIN({fldk358UEFdwq66X7}),\r\n    IF(\r\n      LEN(TRIM(ARRAYJOIN({fldpeBcgvOcDCniy1}) & \"\")) > 0,\r\n      ARRAYJOIN({fldpeBcgvOcDCniy1}),\r\n      BLANK()\r\n    )\r\n  )\r\n)","fieldReferencesById":["fld1W33MG1RjFYMlT","fldk358UEFdwq66X7","fldpeBcgvOcDCniy1"],"fieldReferencesByName":["Approval Email Template Key — Meeting Override","Program Config: Approval Email Template Key","Global Config: Approval Email Template Key"],"dependencySource":"metadata"}`
- **Cover Media**
...
- **RecordId**
  ...
  - options summary: `{"isValid":true,"resultType":"singleLineText","formula":"RECORD_ID()","dependencySource":"none"}`
- **Recording URL**
  - id: `fldhmbxvs9AOgahdh`
  - type: `url`
  - role: `standard`
  - primary: `False`
- **Recording Quiz Available?**
  - id: `fldQFRSKTcKpjK2vb`
  - type: `checkbox`
  - role: `standard`
  - primary: `False`
  - options summary: `{"icon":"thumbsUp","color":"greenBright"}`
- **Recording Quiz Deadline**
  - id: `fld23cJ03tEsnNcaO`
  - type: `dateTime`
  - role: `standard`
  - primary: `False`
  - options summary: `{"dateFormat":{"name":"us","format":"M/D/YYYY"},"timeFormat":{"name":"12hour","format":"h:mma"},"timeZone":"utc"}`
- **Recording XP Percentage**
  - id: `fldQnTYsFsRFySFdk`
  - type: `number`
  - role: `standard`
  - primary: `False`
  - options summary: `{"precision":0}`
- **Attendance Method**
  - id: `fldpsIjB9bnNRa8vW`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - options summary: `{"choices":["Live","Recording Quiz"],"choicesDetailed":[{"id":"sel3aRM4sP0UEBzI2","name":"Live","color":"blueLight2"},{"id":"selRlGQ8brVN0gh2B","name":"Recording Quiz","color":"cyanLight2"}]}`
- **Recording Quiz Response**
  - id: `fldTqkzeo4Nayd6nS`
  - type: `multilineText`
  - role: `standard`
  - primary: `False`
- **Recording Quiz Submitted At**
  - id: `fldArnQlsGthSKmBb`
  - type: `dateTime`
  - role: `standard`
  - primary: `False`
  - options summary: `{"dateFormat":{"name":"us","format":"M/D/YYYY"},"timeFormat":{"name":"12hour","format":"h:mma"},"timeZone":"utc"}`
- **Recording Quiz Review Status**
  - id: `fld1XgDCkjjxB9R9z`
  - type: `singleSelect`
  - role: `status`
  - primary: `False`
  - options summary: `{"choices":["Not Submitted","Needs Review","Satisfactory","Needs Correction"],"choicesDetailed":[{"id":"selvo1godl3JOvO4K","name":"Not Submitted","color":"blueLight2"},{"id":"selcVpy7rrEKJs6S4","name":"Needs Review","color":"cyanLight2"},{"id":"selfZsehMf80AjADr","name":"Satisfactory","color":"tealLight2"},{"id":"sel3jsGc8WYBXZd6q","name":"Needs Correction","color":"greenLight2"}]}`
- **Recording Quiz Satisfactory?**
  - id: `fldgpyTNfJAAdMSNM`
  - type: `checkbox`
  - role: `standard`
  - primary: `False`
  - options summary: `{"icon":"thumbsUp","color":"greenBright"}`
- **Recording Quiz Coach Feedback**
  - id: `fldeS68RfcRQWAoNg`
  - type: `multilineText`
  - role: `standard`
  - primary: `False`
- **Recording Quiz Attempt Number**
  - id: `fldKpwbkVu78JuwrM`
  - type: `number`
  - role: `standard`
  - primary: `False`
  - options summary: `{"precision":0}`
- **Live Attendance Confirmed?**
  - id: `fldT9c1FO5TtZ12jE`
  - type: `checkbox`
  - role: `standard`
  - primary: `False`
  - options summary: `{"icon":"thumbsUp","color":"greenBright"}`
- **Zoom Credit Approved?**
  - id: `fldCJUXrLJEGyjxiA`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldT9c1FO5TtZ12jE","fldpsIjB9bnNRa8vW","fld1XgDCkjjxB9R9z","fldgpyTNfJAAdMSNM"],"referencedFieldNames":["Live Attendance Confirmed?","Attendance Method","Recording Quiz Review Status","Recording Quiz Satisfactory?"],"formula":"OR({fldT9c1FO5TtZ12jE}, AND({fldpsIjB9bnNRa8vW} = 'Recording Quiz', {fld1XgDCkjjxB9R9z} = 'Satisfactory', {fldgpyTNfJAAdMSNM}))","fieldReferencesById":["fldT9c1FO5TtZ12jE","fldpsIjB9bnNRa8vW","fld1XgDCkjjxB9R9z","fldgpyTNfJAAdMSNM"],"fieldReferencesByName":["Live Attendance Confirmed?","Attendance Method","Recording Quiz Review Status","Recording Quiz Satisfactory?"],"dependencySource":"metadata"}`
- **Zoom XP Percentage**
  - id: `fldvQfmaifxBZjHCd`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldCJUXrLJEGyjxiA","fldT9c1FO5TtZ12jE","fldpsIjB9bnNRa8vW","fld1XgDCkjjxB9R9z","fldgpyTNfJAAdMSNM","fldQnTYsFsRFySFdk"],"referencedFieldNames":["Zoom Credit Approved?","Live Attendance Confirmed?","Attendance Method","Recording Quiz Review Status","Recording Quiz Satisfactory?","Recording XP Percentage"],"formula":"IF({fldCJUXrLJEGyjxiA}, IF({fldT9c1FO5TtZ12jE}, 100, IF({fldpsIjB9bnNRa8vW} = 'Recording Quiz', IF({fld1XgDCkjjxB9R9z} = 'Satisfactory', IF({fldgpyTNfJAAdMSNM}, IF({fldQnTYsFsRFySFdk}, {fldQnTYsFsRFySFdk}, 50), 0), 0), 0)), 0)","fieldReferencesById":["fldCJUXrLJEGyjxiA","fldT9c1FO5TtZ12jE","fldpsIjB9bnNRa8vW","fld1XgDCkjjxB9R9z","fldgpyTNfJAAdMSNM","fldQnTYsFsRFySFdk"],"fieldReferencesByName":["Zoom Credit Approved?","Live Attendance Confirmed?","Attendance Method","Recording Quiz Review Status","Recording Quiz Satisfactory?","Recording XP Percentage"],"dependencySource":"metadata"}`
- **Zoom XP Amount**
  - id: `fld1MBQxn3geKPucN`
  - type: `formula`
  - role: `formula`
  - primary: `False`
...
- **Zoom Gate Credit Earned?**
  - id: `fldIFgXQbd8AfC9Pe`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldCJUXrLJEGyjxiA"],"referencedFieldNames":["Zoom Credit Approved?"],"formula":"{fldCJUXrLJEGyjxiA}","fieldReferencesById":["fldCJUXrLJEGyjxiA"],"fieldReferencesByName":["Zoom Credit Approved?"],"dependencySource":"metadata"}`
- **Zoom Credit Key**
  - id: `fldlZGADtQ4VIfBy9`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldPM4rI6gDjYsTnB","fld5fWmgD4tNKQEfz"],"referencedFieldNames":["Zoom Meeting Key","RecordId"],"formula":"IF(AND({fldPM4rI6gDjYsTnB}, {fld5fWmgD4tNKQEfz}), 'ZOOM_CREDIT|' & {fldPM4rI6gDjYsTnB} & '|' & {fld5fWmgD4tNKQEfz}, '')","fieldReferencesById":["fldPM4rI6gDjYsTnB","fld5fWmgD4tNKQEfz"],"fieldReferencesByName":["Zoom Meeting Key","RecordId"],"dependencySource":"metadata"}`
- **Zoom Credit Conflict?**
  - id: `flddPOdYEgAX2VtNT`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldT9c1FO5TtZ12jE","fldpsIjB9bnNRa8vW","fld1XgDCkjjxB9R9z","fldgpyTNfJAAdMSNM"],"referencedFieldNames":["Live Attendance Confirmed?","Attendance Method","Recording Quiz Review Status","Recording Quiz Satisfactory?"],"formula":"AND({fldT9c1FO5TtZ12jE}, {fldpsIjB9bnNRa8vW} = 'Recording Quiz', {fld1XgDCkjjxB9R9z} = 'Satisfactory', {fldgpyTNfJAAdMSNM})","fieldReferencesById":["fldT9c1FO5TtZ12jE","fldpsIjB9bnNRa8vW","fld1XgDCkjjxB9R9z","fldgpyTNfJAAdMSNM"],"fieldReferencesByName":["Live Attendance Confirmed?","Attendance Method","Recording Quiz Review Status","Recording Quiz Satisfactory?"],"dependencySource":"metadata"}`
- **Zoom Credit Debug**
  - id: `fldnK5TQeYRjLM2Am`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldpsIjB9bnNRa8vW","fldT9c1FO5TtZ12jE","fld1XgDCkjjxB9R9z","fldgpyTNfJAAdMSNM","fldCJUXrLJEGyjxiA","fldvQfmaifxBZjHCd","fld1MBQxn3geKPucN","fldIFgXQbd8AfC9Pe","flddPOdYEgAX2VtNT","fldlZGADtQ4VIfBy9"],"referencedFieldNames":["Attendance Method","Live Attendance Confirmed?","Recording Quiz Review Status","Recording Quiz Satisfactory?","Zoom Credit Approved?","Zoom XP Percentage","Zoom XP Amount","Zoom Gate Credit Earned?","Zoom Credit Conflict?","Zoom Credit Key"],"formula":"'Method: ' & {fldpsIjB9bnNRa8vW} & '\nLive Confirmed: ' & {fldT9c1FO5TtZ12jE} & '\nQuiz Status: ' & {fld1XgDCkjjxB9R9z} & '\nQuiz Satisfactory: ' & {fldgpyTNfJAAdMSNM} & '\nZoom Credit Approved: ' & {fldCJUXrLJEGyjxiA} & '\nZoom XP %: ' & {fldvQfmaifxBZjHCd} & '\nZoom XP Amount: ' & {fld1MBQxn3geKPucN} & '\nGate Credit: ' & {fldIFgXQbd8AfC9Pe} & '\nConflict: ' & {flddPOdYEgAX2VtNT} & '\nKey: ' & {fldlZGADtQ4VIfBy9}","fieldReferencesById":["fldpsIjB9bnNRa8vW","fldT9c1FO5TtZ12jE","fld1XgDCkjjxB9R9z","fldgpyTNfJAAdMSNM","fldCJUXrLJEGyjxiA","fldvQfmaifxBZjHCd","fld1MBQxn3geKPucN","fldIFgXQbd8AfC9Pe","flddPOdYEgAX2VtNT","fldlZGADtQ4VIfBy9"],"fieldReferencesByName":["Attendance Method","Live Attendance Confirmed?","Recording Quiz Review Status","Recording Quiz Satisfactory?","Zoom Credit Approved?","Zoom XP Percentage","Zoom XP Amount","Zoom Gate Credit Earned?","Zoom Credit Conflict?","Zoom Credit Key"],"dependencySource":"metadata"}`
- **Zoom Attendance**
  - id: `fldELpIe5BwPhXaTA`
  - type: `multipleRecordLinks`
  - role: `link`
  - primary: `False`
  - options summary: `{"linkedTableId":"tblfwbt6aCDCM5gUz","linkedTableName":"Zoom Attendance","inverseLinkFieldId":"fldHzgxuxbyzrQHYA","inverseLinkFieldName":"Zoom Meeting","prefersSingleRecordLink":false,"isReversed":false}`
- **Recording Available At**
  - id: `fld2AzW975HGKDsEG`
  - type: `dateTime`
  - role: `standard`
  - primary: `False`
...
- **Calculated Recording Quiz Deadline**
  - id: `fldbmg5yT9O2TSqwn`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - desc: C-025 — Calculated Recording Quiz Deadline (true date). Design §4 modes/defaults; Week End Date via DATETIME_PARSE(ARRAYJOIN); Later/Earlier via DATETIME_DIFF (MAX/MIN blanked on lookup date).
  - options summary: `{"isValid":true,"resultType":"date","resultOptions":{"dateFormat":{"name":"us","format":"M/D/YYYY"}},"referencedFieldIds":["fld2AzW975HGKDsEG","fldpsIjB9bnNRa8vW","fldnwzUITHTzEeR5n","fldfDKHOn54ZbH7XL","fldmeNbIm6UVQZI9Y"],"referencedFieldNames":["Recording Available At","Attendance Method","Effective Recording Deadline Mode","Effective Recording Makeup Window Days","Week End Date"],"formula":"IF(\n  OR(\n    {fld2AzW975HGKDsEG} = BLANK(),\n    {fldpsIjB9bnNRa8vW} != \"Recording Quiz\"\n  ),\n  BLANK(),\n  SWITCH(\n    IF({fldnwzUITHTzEeR5n} = BLANK(), \"Later of Both\", {fldnwzUITHTzEeR5n}),\n    \"Days After Recording Available\",\n      DATEADD({fld2AzW975HGKDsEG}, IF({fldfDKHOn54ZbH7XL} = BLANK(), 7, {fldfDKHOn54ZbH7XL}), 'days'),\n    \"End of Program Week\",\n      IF({fldmeNbIm6UVQZI9Y} = BLANK(), BLANK(), DATETIME_PARSE(ARRAYJOIN({fldmeNbIm6UVQZI9Y}), 'YYYY-MM-DD')),\n    \"Earlier of Both\",\n      IF(\n        OR({fldmeNbIm6UVQZI9Y} = BLANK(), {fld2AzW975HGKDsEG} = BLANK()),\n        IF({fldmeNbIm6UVQZI9Y} = BLANK(), DATEADD({fld2AzW975HGKDsEG}, IF({fldfDKHOn54ZbH7XL} = BLANK(), 7, {fldfDKHOn54ZbH7XL}), 'days'), DATETIME_PARSE(ARRAYJOIN({fldmeNbIm6UVQZI9Y}), 'YYYY-MM-DD')),\n        IF(\n          DATETIME_DIFF(DATEADD({fld2AzW975HGKDsEG}, IF({fldfDKHOn54ZbH7XL} = BLANK(), 7, {fldfDKHOn54ZbH7XL}), 'days'), DATETIME_PARSE(ARRAYJOIN({fldmeNbIm6UVQZI9Y}), 'YYYY-MM-DD'), 'seconds') <= 0,\n          DATEADD({fld2AzW975HGKDsEG}, IF({fldfDKHOn54ZbH7XL} = BLANK(), 7, {fldfDKHOn54ZbH7XL}), 'days'),\n          DATETIME_PARSE(ARRAYJOIN({fldmeNbIm6UVQZI9Y}), 'YYYY-MM-DD')\n        )\n      ),\n      IF(\n        OR({fldmeNbIm6UVQZI9Y} = BLANK(), {fld2AzW975HGKDsEG} = BLANK()),\n        IF({fldmeNbIm6UVQZI9Y} = BLANK(), DATEADD({fld2AzW975HGKDsEG}, IF({fldfDKHOn54ZbH7XL} = BLANK(), 7, {fldfDKHOn54ZbH7XL}), 'days'), DATETIME_PARSE(ARRAYJOIN({fldmeNbIm6UVQZI9Y}), 'YYYY-MM-DD')),\n        IF(\n          DATETIME_DIFF(DATEADD({fld2AzW975HGKDsEG}, IF({fldfDKHOn54ZbH7XL} = BLANK(), 7, {fldfDKHOn54ZbH7XL}), 'days'), DATETIME_PARSE(ARRAYJOIN({fldmeNbIm6UVQZI9Y}), 'YYYY-MM-DD'), 'seconds') >= 0,\n          DATEADD({fld2AzW975HGKDsEG}, IF({fldfDKHOn54ZbH7XL} = BLANK(), 7, {fldfDKHOn54ZbH7XL}), 'days'),\n          DATETIME_PARSE(ARRAYJOIN({fldmeNbIm6UVQZI9Y}), 'YYYY-MM-DD')\n        )\n      )\n  )\n)","fieldReferencesById":["fld2AzW975HGKDsEG","fldpsIjB9bnNRa8vW","fldnwzUITHTzEeR5n","fldfDKHOn54ZbH7XL","fldmeNbIm6UVQZI9Y"],"fieldReferencesByName":["Recording Available At","Attendance Method","Effective Recording Deadline Mode","Effective Recording Makeup Window Days","Week End Date"],"dependencySource":"metadata"}`
- **Approved Preconflict Pair Tags**
  - id: `fldcM3v5VOjjW002p`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 exclusivity tags
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldELpIe5BwPhXaTA","recordLinkFieldName":"Zoom Attendance","fieldIdInLinkedTable":"fldQJiAeb7K9G3cEl","fieldNameInLinkedTable":"Preconflict Pair Tag","fieldTableInLinkedTable":"Zoom Attendance"}`
- **Week End Date**
  - id: `fldmeNbIm6UVQZI9Y`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — lookup Weeks.End Date for recording quiz deadline
...
- **Config (Program Scope)**
  - id: `fldDZPEVVJkNLE82d`
  - type: `multipleRecordLinks`
  - role: `link`
  - primary: `False`
  - desc: C-025 — Config linkage scope link
  - options summary: `{"linkedTableId":"tblRB6sh77NxjS568","linkedTableName":"Config","inverseLinkFieldId":"fldrNisEXGjcQmEVu","inverseLinkFieldName":"Zoom Meetings","prefersSingleRecordLink":false,"isReversed":false}`
- **Config (Global Scope)**
  - id: `fldCk3Ilb4JVrhSUX`
  - type: `multipleRecordLinks`
  - role: `link`
  - primary: `False`
  - desc: C-025 — Config linkage scope link
  - options summary: `{"linkedTableId":"tblRB6sh77NxjS568","linkedTableName":"Config","inverseLinkFieldId":"fldPDq4jvOhQs5YbV","inverseLinkFieldName":"Zoom Meetings 2","prefersSingleRecordLink":false,"isReversed":false}`
- **Recording XP Percentage — Meeting Override**
  - id: `fldFCW9Eck9bbrKel`
  - type: `number`
  - role: `standard`
  - primary: `False`
...
- **Full Gate Credit — Meeting Override**
  - id: `fldhnXwy1EfYbSy4l`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - desc: C-025 — meeting override for Effective Recording Counts for Level Gate?
  - options summary: `{"choices":["Yes","No"],"choicesDetailed":[{"id":"sel3CLV1Gpny43rBj","name":"Yes","color":"grayLight2"},{"id":"selEPhyMmv8n7Q6fI","name":"No","color":"grayLight2"}]}`
- **Perfect Week Credit — Meeting Override**
  - id: `flderax8CZZC0T7Io`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - desc: C-025 — meeting override for Effective Recording Counts for Perfect Week?
  - options summary: `{"choices":["Yes","No"],"choicesDetailed":[{"id":"selxnVdtI2e8eua6q","name":"Yes","color":"grayLight2"},{"id":"selAJ8VOdsZfSyWB1","name":"No","color":"grayLight2"}]}`
- **Coach Approval Required — Meeting Override**
  - id: `fldCsxeL9J4EMtAUb`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - desc: C-025 — meeting override for Effective Recording Quiz Requires Coach Approval?
  - options summary: `{"choices":["Yes","No"],"choicesDetailed":[{"id":"seldS0xQkiVQNrBf2","name":"Yes","color":"grayLight2"},{"id":"selYLZ9f1CJAnIUZy","name":"No","color":"grayLight2"}]}`
- **Makeup Enabled — Meeting Override**
  - id: `fldpfyi2e66uj9BXw`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - desc: C-025 — meeting override for Effective Recording Makeup Enabled?
  - options summary: `{"choices":["Yes","No"],"choicesDetailed":[{"id":"selSSyko44O8r2uG1","name":"Yes","color":"grayLight2"},{"id":"selaAjUdvj77zRbFy","name":"No","color":"grayLight2"}]}`
- **Makeup Window Days — Meeting Override**
  - id: `fldX3pVCYNARA4FGs`
  - type: `number`
  - role: `standard`
  - primary: `False`
  - desc: C-025 — meeting override for Effective Recording Makeup Window Days
  - options summary: `{"precision":0}`
- **Deadline Mode — Meeting Override**
  - id: `fldthxCJSyDoG51OB`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - desc: C-025 — meeting override for Effective Recording Deadline Mode
  - options summary: `{"choices":["Days After Recording Available","End of Program Week","Later of Both","Earlier of Both"],"choicesDetailed":[{"id":"selqfxfv5fHwBC9Ov","name":"Days After Recording Available","color":"grayLight2"},{"id":"selTqb1JAP1g2ak8F","name":"End of Program Week","color":"grayLight2"},{"id":"selicSKWjUQ5NXiuF","name":"Later of Both","color":"grayLight2"},{"id":"selzVJIN0yYgbdv0k","name":"Earlier of Both","color":"grayLight2"}]}`
- **Approval Email Enabled — Meeting Override**
  - id: `fldCWlEwhEZsJq3CJ`
  - type: `singleSelect`
  - role: `contact`
  - primary: `False`
  - desc: C-025 — meeting override for Effective Recording Approval Email Enabled?
  - options summary: `{"choices":["Yes","No"],"choicesDetailed":[{"id":"selU6j9gsjNgIA0mB","name":"Yes","color":"grayLight2"},{"id":"selXd9PnThn75Q9zE","name":"No","color":"grayLight2"}]}`
- **Approval Email Timing — Meeting Override**
  - id: `fldcItCULgDHSaXvk`
  - type: `singleSelect`
  - role: `contact`
  - primary: `False`
  - desc: C-025 — meeting override for Effective Recording Approval Email Timing
  - options summary: `{"choices":["On Satisfactory"],"choicesDetailed":[{"id":"seldSVuu2n04hOQRz","name":"On Satisfactory","color":"grayLight2"}]}`
- **Approval Email Template Key — Meeting Override**
  - id: `fld1W33MG1RjFYMlT`
  - type: `singleLineText`
  - role: `identifier`
  - primary: `False`
  - desc: C-025 — meeting override for Effective Recording Approval Email Template Key
- **Program Config: Recording XP %**
  - id: `fld5KGepq4YRRck99`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 — Program Config rollup for Effective Recording XP Percentage
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fldRaNc87BixzsmLV","fieldNameInLinkedTable":"Zoom Recording XP Percent of Live","fieldTableInLinkedTable":"Config"}`
- **Global Config: Recording XP %**
  - id: `fldYKUZQcvZi0ir2Q`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 — Global Config rollup for Effective Recording XP Percentage
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldCk3Ilb4JVrhSUX","recordLinkFieldName":"Config (Global Scope)","fieldIdInLinkedTable":"fldRaNc87BixzsmLV","fieldNameInLinkedTable":"Zoom Recording XP Percent of Live","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Program Config: Full Gate Credit — legacy rollup**
  - id: `fldErkg4mbk91xH1a`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 — Program Config rollup for Effective Recording Counts for Level Gate?
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fld9QHugLr37qJmGS","fieldNameInLinkedTable":"Recording Gives Full Zoom Gate Credit?","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Global Config: Full Gate Credit — legacy rollup**
  - id: `fldaYc5Pc0Z0sL361`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 — Global Config rollup for Effective Recording Counts for Level Gate?
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldCk3Ilb4JVrhSUX","recordLinkFieldName":"Config (Global Scope)","fieldIdInLinkedTable":"fld9QHugLr37qJmGS","fieldNameInLinkedTable":"Recording Gives Full Zoom Gate Credit?","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Program Config: Perfect Week Credit — legacy rollup**
  - id: `fldMuSSdKQ4UnPqoa`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 — Program Config rollup for Effective Recording Counts for Perfect Week?
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fldmahedrTcx111aX","fieldNameInLinkedTable":"Recording Makeup Counts for Perfect Week?","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Global Config: Perfect Week Credit — legacy rollup**
  - id: `fldCUG40Uf5bA8BgR`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 — Global Config rollup for Effective Recording Counts for Perfect Week?
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldCk3Ilb4JVrhSUX","recordLinkFieldName":"Config (Global Scope)","fieldIdInLinkedTable":"fldmahedrTcx111aX","fieldNameInLinkedTable":"Recording Makeup Counts for Perfect Week?","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Program Config: Coach Approval Required — legacy rollup**
  - id: `fldx2vYJlA1z7K2yA`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 — Program Config rollup for Effective Recording Quiz Requires Coach Approval?
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fldB5cmOxn0AtcHUc","fieldNameInLinkedTable":"Recording Quiz Requires Coach Approval?","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Global Config: Coach Approval Required — legacy rollup**
  - id: `fldQKf9OARsLGWEsG`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 — Global Config rollup for Effective Recording Quiz Requires Coach Approval?
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldCk3Ilb4JVrhSUX","recordLinkFieldName":"Config (Global Scope)","fieldIdInLinkedTable":"fldB5cmOxn0AtcHUc","fieldNameInLinkedTable":"Recording Quiz Requires Coach Approval?","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Program Config: Makeup Enabled — legacy rollup**
  - id: `fldx5OoDjuzf9CgJO`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 — Program Config rollup for Effective Recording Makeup Enabled?
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fldEktL1d27p5KlF5","fieldNameInLinkedTable":"Recording Makeup Enabled?","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Global Config: Makeup Enabled — legacy rollup**
  - id: `fldU4KuxP9X2ySgWj`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 — Global Config rollup for Effective Recording Makeup Enabled?
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldCk3Ilb4JVrhSUX","recordLinkFieldName":"Config (Global Scope)","fieldIdInLinkedTable":"fldEktL1d27p5KlF5","fieldNameInLinkedTable":"Recording Makeup Enabled?","fieldTableInLinkedTable":"Config"}`
- **Program Config: Makeup Window Days**
  - id: `fldN1opjsr97wPfTK`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 — Program Config rollup for Effective Recording Makeup Window Days
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fld1Qg2jgJJOjDJKD","fieldNameInLinkedTable":"Zoom Recording Makeup Window Days","fieldTableInLinkedTable":"Config"}`
- **Global Config: Makeup Window Days**
  - id: `fldCUxvOT4MpoRcuv`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 — Global Config rollup for Effective Recording Makeup Window Days
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldCk3Ilb4JVrhSUX","recordLinkFieldName":"Config (Global Scope)","fieldIdInLinkedTable":"fld1Qg2jgJJOjDJKD","fieldNameInLinkedTable":"Zoom Recording Makeup Window Days","fieldTableInLinkedTable":"Config"}`
- **Program Config: Deadline Mode**
  - id: `fldiUsPQwJAXfI7VX`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 — Program Config rollup for Effective Recording Deadline Mode
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fldQ61QvoZSbMLFIK","fieldNameInLinkedTable":"Zoom Recording Deadline Mode","fieldTableInLinkedTable":"Config"}`
- **Global Config: Deadline Mode**
  - id: `fldpBQTlvywnZOv23`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 — Global Config rollup for Effective Recording Deadline Mode
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldCk3Ilb4JVrhSUX","recordLinkFieldName":"Config (Global Scope)","fieldIdInLinkedTable":"fldQ61QvoZSbMLFIK","fieldNameInLinkedTable":"Zoom Recording Deadline Mode","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Program Config: Approval Email Enabled — legacy rollup**
  - id: `fldQQVXD2XWtjKhyF`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 — Program Config rollup for Effective Recording Approval Email Enabled?
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fldWGs5xDGD4UwIDM","fieldNameInLinkedTable":"Recording Approval Email Enabled?","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Global Config: Approval Email Enabled — legacy rollup**
  - id: `fldQknOoi6Hdw3n34`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 — Global Config rollup for Effective Recording Approval Email Enabled?
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldCk3Ilb4JVrhSUX","recordLinkFieldName":"Config (Global Scope)","fieldIdInLinkedTable":"fldWGs5xDGD4UwIDM","fieldNameInLinkedTable":"Recording Approval Email Enabled?","fieldTableInLinkedTable":"Config"}`
- **Program Config: Approval Email Timing**
  - id: `fldJOR8XjFq3Lk2HI`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 — Program Config rollup for Effective Recording Approval Email Timing
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fld3m4sPbI5xHint3","fieldNameInLinkedTable":"Recording Approval Email Timing","fieldTableInLinkedTable":"Config"}`
- **Global Config: Approval Email Timing**
  - id: `fldkHtwI3H00k59wN`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 — Global Config rollup for Effective Recording Approval Email Timing
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldCk3Ilb4JVrhSUX","recordLinkFieldName":"Config (Global Scope)","fieldIdInLinkedTable":"fld3m4sPbI5xHint3","fieldNameInLinkedTable":"Recording Approval Email Timing","fieldTableInLinkedTable":"Config"}`
- **Program Config: Approval Email Template Key**
  - id: `fldk358UEFdwq66X7`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 — Program Config rollup for Effective Recording Approval Email Template Key
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fldzmMcbHHJ77yz0v","fieldNameInLinkedTable":"Recording Approval Email Template Key","fieldTableInLinkedTable":"Config"}`
- **Global Config: Approval Email Template Key**
  - id: `fldpeBcgvOcDCniy1`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - desc: C-025 — Global Config rollup for Effective Recording Approval Email Template Key
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldCk3Ilb4JVrhSUX","recordLinkFieldName":"Config (Global Scope)","fieldIdInLinkedTable":"fldzmMcbHHJ77yz0v","fieldNameInLinkedTable":"Recording Approval Email Template Key","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Effective Recording XP Percentage (Config formula draft)**
  - id: `fldF4dtlJuULJg8zE`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - desc: C-025 — 4-tier precedence (override → program → global → fallback)
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldFCW9Eck9bbrKel","fld5KGepq4YRRck99","fldYKUZQcvZi0ir2Q"],"referencedFieldNames":["Recording XP Percentage — Meeting Override","Program Config: Recording XP %","Global Config: Recording XP %"],"formula":"IF(\n  {fldFCW9Eck9bbrKel} != BLANK(),\n  {fldFCW9Eck9bbrKel},\n  IF(\n    {fld5KGepq4YRRck99} != BLANK(),\n    {fld5KGepq4YRRck99},\n    IF(\n      {fldYKUZQcvZi0ir2Q} != BLANK(),\n      {fldYKUZQcvZi0ir2Q},\n      50\n    )\n  )\n)","fieldReferencesById":["fldFCW9Eck9bbrKel","fld5KGepq4YRRck99","fldYKUZQcvZi0ir2Q"],"fieldReferencesByName":["Recording XP Percentage — Meeting Override","Program Config: Recording XP %","Global Config: Recording XP %"],"dependencySource":"metadata"}`
- **ZZZ C025 Archive — Effective Recording Counts for Level Gate? (Config formula draft)**
  - id: `fldYpVOp0uFm4CtwK`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - desc: C-025 draft precedence formula — paste into Effective* via UI to convert type while keeping field ID
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldhnXwy1EfYbSy4l","fldcVNVocMh0Ciq9a","fldJxPcC8tAvqks0F"],"referencedFieldNames":["Full Gate Credit — Meeting Override","Program Config: Full Gate Credit","Global Config: Full Gate Credit"],"formula":"IF(\n  {fldhnXwy1EfYbSy4l} = \"Yes\", TRUE(),\n  IF(\n    {fldhnXwy1EfYbSy4l} = \"No\", FALSE(),\n    IF(\n      {fldcVNVocMh0Ciq9a} = \"Yes\", TRUE(),\n      IF(\n        {fldcVNVocMh0Ciq9a} = \"No\", FALSE(),\n        IF(\n          {fldJxPcC8tAvqks0F} = \"Yes\", TRUE(),\n          IF(\n            {fldJxPcC8tAvqks0F} = \"No\", FALSE(),\n            TRUE()\n          )\n        )\n      )\n    )\n  )\n)","fieldReferencesById":["fldhnXwy1EfYbSy4l","fldcVNVocMh0Ciq9a","fldJxPcC8tAvqks0F"],"fieldReferencesByName":["Full Gate Credit — Meeting Override","Program Config: Full Gate Credit","Global Config: Full Gate Credit"],"dependencySource":"metadata"}`
- **ZZZ C025 Archive — Effective Recording Counts for Perfect Week? (Config formula draft)**
  - id: `fldu0WoqcTKfqO2tt`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - desc: C-025 draft precedence formula — paste into Effective* via UI to convert type while keeping field ID
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["flderax8CZZC0T7Io","fld1JXcc1VIFrbprj","fldRbQVOK2hkn4XfI"],"referencedFieldNames":["Perfect Week Credit — Meeting Override","Program Config: Perfect Week Credit","Global Config: Perfect Week Credit"],"formula":"IF(\n  {flderax8CZZC0T7Io} = \"Yes\", TRUE(),\n  IF(\n    {flderax8CZZC0T7Io} = \"No\", FALSE(),\n    IF(\n      {fld1JXcc1VIFrbprj} = \"Yes\", TRUE(),\n      IF(\n        {fld1JXcc1VIFrbprj} = \"No\", FALSE(),\n        IF(\n          {fldRbQVOK2hkn4XfI} = \"Yes\", TRUE(),\n          IF(\n            {fldRbQVOK2hkn4XfI} = \"No\", FALSE(),\n            TRUE()\n          )\n        )\n      )\n    )\n  )\n)","fieldReferencesById":["flderax8CZZC0T7Io","fld1JXcc1VIFrbprj","fldRbQVOK2hkn4XfI"],"fieldReferencesByName":["Perfect Week Credit — Meeting Override","Program Config: Perfect Week Credit","Global Config: Perfect Week Credit"],"dependencySource":"metadata"}`
- **ZZZ C025 Archive — Effective Recording Quiz Requires Coach Approval? (Config formula draft)**
  - id: `fldOZ4BveXclH1Io3`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - desc: C-025 draft precedence formula — paste into Effective* via UI to convert type while keeping field ID
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldCsxeL9J4EMtAUb","fldSIq2ipNOe6wwK9","fld0uUzrbX5MPjGcm"],"referencedFieldNames":["Coach Approval Required — Meeting Override","Program Config: Coach Approval Required","Global Config: Coach Approval Required"],"formula":"IF(\n  {fldCsxeL9J4EMtAUb} = \"Yes\", TRUE(),\n  IF(\n    {fldCsxeL9J4EMtAUb} = \"No\", FALSE(),\n    IF(\n      {fldSIq2ipNOe6wwK9} = \"Yes\", TRUE(),\n      IF(\n        {fldSIq2ipNOe6wwK9} = \"No\", FALSE(),\n        IF(\n          {fld0uUzrbX5MPjGcm} = \"Yes\", TRUE(),\n          IF(\n            {fld0uUzrbX5MPjGcm} = \"No\", FALSE(),\n            TRUE()\n          )\n        )\n      )\n    )\n  )\n)","fieldReferencesById":["fldCsxeL9J4EMtAUb","fldSIq2ipNOe6wwK9","fld0uUzrbX5MPjGcm"],"fieldReferencesByName":["Coach Approval Required — Meeting Override","Program Config: Coach Approval Required","Global Config: Coach Approval Required"],"dependencySource":"metadata"}`
- **ZZZ C025 Archive — Effective Recording Makeup Enabled? (Config formula draft)**
  - id: `fldZQSP01wtcKT2EN`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - desc: C-025 draft precedence formula — paste into Effective* via UI to convert type while keeping field ID
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldpfyi2e66uj9BXw","fldU0awkqf7dBtCMx","fld0FuPdNHd2lTjnD"],"referencedFieldNames":["Makeup Enabled — Meeting Override","Program Config: Makeup Enabled","Global Config: Makeup Enabled"],"formula":"IF(\n  {fldpfyi2e66uj9BXw} = \"Yes\", TRUE(),\n  IF(\n    {fldpfyi2e66uj9BXw} = \"No\", FALSE(),\n    IF(\n      {fldU0awkqf7dBtCMx} = \"Yes\", TRUE(),\n      IF(\n        {fldU0awkqf7dBtCMx} = \"No\", FALSE(),\n        IF(\n          {fld0FuPdNHd2lTjnD} = \"Yes\", TRUE(),\n          IF(\n            {fld0FuPdNHd2lTjnD} = \"No\", FALSE(),\n            TRUE()\n          )\n        )\n      )\n    )\n  )\n)","fieldReferencesById":["fldpfyi2e66uj9BXw","fldU0awkqf7dBtCMx","fld0FuPdNHd2lTjnD"],"fieldReferencesByName":["Makeup Enabled — Meeting Override","Program Config: Makeup Enabled","Global Config: Makeup Enabled"],"dependencySource":"metadata"}`
- **ZZZ C025 Archive — Effective Recording Makeup Window Days (Config formula draft)**
  - id: `fldLdje6wgwiPvZOv`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - desc: C-025 draft precedence formula — paste into Effective* via UI to convert type while keeping field ID
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldX3pVCYNARA4FGs","fldN1opjsr97wPfTK","fldCUxvOT4MpoRcuv"],"referencedFieldNames":["Makeup Window Days — Meeting Override","Program Config: Makeup Window Days","Global Config: Makeup Window Days"],"formula":"IF(\n  {fldX3pVCYNARA4FGs} != BLANK(),\n  {fldX3pVCYNARA4FGs},\n  IF(\n    {fldN1opjsr97wPfTK} != BLANK(),\n    {fldN1opjsr97wPfTK},\n    IF(\n      {fldCUxvOT4MpoRcuv} != BLANK(),\n      {fldCUxvOT4MpoRcuv},\n      7\n    )\n  )\n)","fieldReferencesById":["fldX3pVCYNARA4FGs","fldN1opjsr97wPfTK","fldCUxvOT4MpoRcuv"],"fieldReferencesByName":["Makeup Window Days — Meeting Override","Program Config: Makeup Window Days","Global Config: Makeup Window Days"],"dependencySource":"metadata"}`
- **ZZZ C025 Archive — Effective Recording Deadline Mode (Config formula draft)**
  - id: `fldoda1RP46OrL5M2`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - desc: C-025 — LEN/TRIM + ARRAYJOIN select/text draft (empty override safe)
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldthxCJSyDoG51OB","fldiUsPQwJAXfI7VX","fldpBQTlvywnZOv23"],"referencedFieldNames":["Deadline Mode — Meeting Override","Program Config: Deadline Mode","Global Config: Deadline Mode"],"formula":"IF(\n  LEN(TRIM({fldthxCJSyDoG51OB} & \"\")) > 0,\n  {fldthxCJSyDoG51OB} & \"\",\n  IF(\n    LEN(TRIM(ARRAYJOIN({fldiUsPQwJAXfI7VX}) & \"\")) > 0,\n    ARRAYJOIN({fldiUsPQwJAXfI7VX}),\n    IF(\n      LEN(TRIM(ARRAYJOIN({fldpBQTlvywnZOv23}) & \"\")) > 0,\n      ARRAYJOIN({fldpBQTlvywnZOv23}),\n      \"Later of Both\"\n    )\n  )\n)","fieldReferencesById":["fldthxCJSyDoG51OB","fldiUsPQwJAXfI7VX","fldpBQTlvywnZOv23"],"fieldReferencesByName":["Deadline Mode — Meeting Override","Program Config: Deadline Mode","Global Config: Deadline Mode"],"dependencySource":"metadata"}`
- **ZZZ C025 Archive — Effective Recording Approval Email Enabled? (Config formula draft)**
  - id: `fldo5Xdcjj41CrAPD`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - desc: C-025 draft precedence formula — paste into Effective* via UI to convert type while keeping field ID
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldCWlEwhEZsJq3CJ","flduT63RW6F4ZEo0N","fld8NYdy0eIEkFFav"],"referencedFieldNames":["Approval Email Enabled — Meeting Override","Program Config: Approval Email Enabled","Global Config: Approval Email Enabled"],"formula":"IF(\n  {fldCWlEwhEZsJq3CJ} = \"Yes\", TRUE(),\n  IF(\n    {fldCWlEwhEZsJq3CJ} = \"No\", FALSE(),\n    IF(\n      {flduT63RW6F4ZEo0N} = \"Yes\", TRUE(),\n      IF(\n        {flduT63RW6F4ZEo0N} = \"No\", FALSE(),\n        IF(\n          {fld8NYdy0eIEkFFav} = \"Yes\", TRUE(),\n          IF(\n            {fld8NYdy0eIEkFFav} = \"No\", FALSE(),\n            FALSE()\n          )\n        )\n      )\n    )\n  )\n)","fieldReferencesById":["fldCWlEwhEZsJq3CJ","flduT63RW6F4ZEo0N","fld8NYdy0eIEkFFav"],"fieldReferencesByName":["Approval Email Enabled — Meeting Override","Program Config: Approval Email Enabled","Global Config: Approval Email Enabled"],"dependencySource":"metadata"}`
- **ZZZ C025 Archive — Effective Recording Approval Email Timing (Config formula draft)**
  - id: `fldaQ6UUYpfYJTyhV`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - desc: C-025 — LEN/TRIM + ARRAYJOIN select/text draft (empty override safe)
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldcItCULgDHSaXvk","fldJOR8XjFq3Lk2HI","fldkHtwI3H00k59wN"],"referencedFieldNames":["Approval Email Timing — Meeting Override","Program Config: Approval Email Timing","Global Config: Approval Email Timing"],"formula":"IF(\n  LEN(TRIM({fldcItCULgDHSaXvk} & \"\")) > 0,\n  {fldcItCULgDHSaXvk} & \"\",\n  IF(\n    LEN(TRIM(ARRAYJOIN({fldJOR8XjFq3Lk2HI}) & \"\")) > 0,\n    ARRAYJOIN({fldJOR8XjFq3Lk2HI}),\n    IF(\n      LEN(TRIM(ARRAYJOIN({fldkHtwI3H00k59wN}) & \"\")) > 0,\n      ARRAYJOIN({fldkHtwI3H00k59wN}),\n      \"On Satisfactory\"\n    )\n  )\n)","fieldReferencesById":["fldcItCULgDHSaXvk","fldJOR8XjFq3Lk2HI","fldkHtwI3H00k59wN"],"fieldReferencesByName":["Approval Email Timing — Meeting Override","Program Config: Approval Email Timing","Global Config: Approval Email Timing"],"dependencySource":"metadata"}`
- **ZZZ C025 Archive — Effective Recording Approval Email Template Key (Config formula draft)**
  - id: `fldeQAQg531QgEsXf`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - desc: C-025 — LEN/TRIM + ARRAYJOIN select/text draft (empty override safe)
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fld1W33MG1RjFYMlT","fldk358UEFdwq66X7","fldpeBcgvOcDCniy1"],"referencedFieldNames":["Approval Email Template Key — Meeting Override","Program Config: Approval Email Template Key","Global Config: Approval Email Template Key"],"formula":"IF(\n  LEN(TRIM({fld1W33MG1RjFYMlT} & \"\")) > 0,\n  {fld1W33MG1RjFYMlT} & \"\",\n  IF(\n    LEN(TRIM(ARRAYJOIN({fldk358UEFdwq66X7}) & \"\")) > 0,\n    ARRAYJOIN({fldk358UEFdwq66X7}),\n    IF(\n      LEN(TRIM(ARRAYJOIN({fldpeBcgvOcDCniy1}) & \"\")) > 0,\n      ARRAYJOIN({fldpeBcgvOcDCniy1}),\n      BLANK()\n    )\n  )\n)","fieldReferencesById":["fld1W33MG1RjFYMlT","fldk358UEFdwq66X7","fldpeBcgvOcDCniy1"],"fieldReferencesByName":["Approval Email Template Key — Meeting Override","Program Config: Approval Email Template Key","Global Config: Approval Email Template Key"],"dependencySource":"metadata"}`
- **ZZZ C025 Archive — C025 Checkbox Rollup Probe**
  - id: `fldvkxmFANd3KI2uQ`
  - type: `rollup`
  - role: `rollup`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fld9QHugLr37qJmGS","fieldNameInLinkedTable":"Recording Gives Full Zoom Gate Credit?","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Program Config: Full Gate Credit — pre-YN**
  - id: `fldQLiHJc5nX5TQpj`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — checkbox Config lookup (API cannot set rollup COUNTA/OR formula; design aggregation was: IF(COUNTA(values) = 0, BLANK(), OR(values)))
  - options summary: `{"isValid":true,"resultType":"checkbox","resultOptions":{"icon":"check","color":"greenBright"},"recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fld9QHugLr37qJmGS","fieldNameInLinkedTable":"Recording Gives Full Zoom Gate Credit?","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Global Config: Full Gate Credit — pre-YN**
  - id: `fldUCaIua5etYDIpu`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — checkbox Config lookup (API cannot set rollup COUNTA/OR formula; design aggregation was: IF(COUNTA(values) = 0, BLANK(), OR(values)))
  - options summary: `{"isValid":true,"resultType":"checkbox","resultOptions":{"icon":"check","color":"greenBright"},"recordLinkFieldId":"fldCk3Ilb4JVrhSUX","recordLinkFieldName":"Config (Global Scope)","fieldIdInLinkedTable":"fld9QHugLr37qJmGS","fieldNameInLinkedTable":"Recording Gives Full Zoom Gate Credit?","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Program Config: Perfect Week Credit — pre-YN**
  - id: `fld1efNhLOGotLjOP`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — checkbox Config lookup (API cannot set rollup COUNTA/OR formula; design aggregation was: IF(COUNTA(values) = 0, BLANK(), OR(values)))
  - options summary: `{"isValid":true,"resultType":"checkbox","resultOptions":{"icon":"check","color":"greenBright"},"recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fldmahedrTcx111aX","fieldNameInLinkedTable":"Recording Makeup Counts for Perfect Week?","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Global Config: Perfect Week Credit — pre-YN**
  - id: `fld3jqrfP0NOMs4DI`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — checkbox Config lookup (API cannot set rollup COUNTA/OR formula; design aggregation was: IF(COUNTA(values) = 0, BLANK(), OR(values)))
  - options summary: `{"isValid":true,"resultType":"checkbox","resultOptions":{"icon":"check","color":"greenBright"},"recordLinkFieldId":"fldCk3Ilb4JVrhSUX","recordLinkFieldName":"Config (Global Scope)","fieldIdInLinkedTable":"fldmahedrTcx111aX","fieldNameInLinkedTable":"Recording Makeup Counts for Perfect Week?","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Program Config: Coach Approval Required — pre-YN**
  - id: `fldDLZyrwZgVx3UEB`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — checkbox Config lookup (API cannot set rollup COUNTA/OR formula; design aggregation was: IF(COUNTA(values) = 0, BLANK(), OR(values)))
  - options summary: `{"isValid":true,"resultType":"checkbox","resultOptions":{"icon":"check","color":"greenBright"},"recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fldB5cmOxn0AtcHUc","fieldNameInLinkedTable":"Recording Quiz Requires Coach Approval?","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Global Config: Coach Approval Required — pre-YN**
  - id: `fldRAlrhnZ8Nxdybu`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — checkbox Config lookup (API cannot set rollup COUNTA/OR formula; design aggregation was: IF(COUNTA(values) = 0, BLANK(), OR(values)))
  - options summary: `{"isValid":true,"resultType":"checkbox","resultOptions":{"icon":"check","color":"greenBright"},"recordLinkFieldId":"fldCk3Ilb4JVrhSUX","recordLinkFieldName":"Config (Global Scope)","fieldIdInLinkedTable":"fldB5cmOxn0AtcHUc","fieldNameInLinkedTable":"Recording Quiz Requires Coach Approval?","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Program Config: Makeup Enabled — pre-YN**
  - id: `flduyH2xCQbWwRRvj`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — checkbox Config lookup (API cannot set rollup COUNTA/OR formula; design aggregation was: IF(COUNTA(values) = 0, BLANK(), OR(values)))
  - options summary: `{"isValid":true,"resultType":"checkbox","resultOptions":{"icon":"check","color":"greenBright"},"recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fldEktL1d27p5KlF5","fieldNameInLinkedTable":"Recording Makeup Enabled?","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Global Config: Makeup Enabled — pre-YN**
  - id: `fld40gHWZhfrSG5AP`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — checkbox Config lookup (API cannot set rollup COUNTA/OR formula; design aggregation was: IF(COUNTA(values) = 0, BLANK(), OR(values)))
  - options summary: `{"isValid":true,"resultType":"checkbox","resultOptions":{"icon":"check","color":"greenBright"},"recordLinkFieldId":"fldCk3Ilb4JVrhSUX","recordLinkFieldName":"Config (Global Scope)","fieldIdInLinkedTable":"fldEktL1d27p5KlF5","fieldNameInLinkedTable":"Recording Makeup Enabled?","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Program Config: Approval Email Enabled — pre-YN**
  - id: `fldUgXs1Zpa1zCk1k`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — checkbox Config lookup (API cannot set rollup COUNTA/OR formula; design aggregation was: IF(COUNTA(values) = 0, BLANK(), OR(values)))
  - options summary: `{"isValid":true,"resultType":"checkbox","resultOptions":{"icon":"check","color":"greenBright"},"recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fldWGs5xDGD4UwIDM","fieldNameInLinkedTable":"Recording Approval Email Enabled?","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — Global Config: Approval Email Enabled — pre-YN**
  - id: `fldQ9PergUCN5Kx6z`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — checkbox Config lookup (API cannot set rollup COUNTA/OR formula; design aggregation was: IF(COUNTA(values) = 0, BLANK(), OR(values)))
  - options summary: `{"isValid":true,"resultType":"checkbox","resultOptions":{"icon":"check","color":"greenBright"},"recordLinkFieldId":"fldCk3Ilb4JVrhSUX","recordLinkFieldName":"Config (Global Scope)","fieldIdInLinkedTable":"fldWGs5xDGD4UwIDM","fieldNameInLinkedTable":"Recording Approval Email Enabled?","fieldTableInLinkedTable":"Config"}`
- **Program Config: Full Gate Credit**
  - id: `fldcVNVocMh0Ciq9a`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — lookup Config YN text (Yes/No) for blank-safe checkbox precedence
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fldyAukob3zsl4ecc","fieldNameInLinkedTable":"Recording Gives Full Zoom Gate Credit YN","fieldTableInLinkedTable":"Config"}`
- **Global Config: Full Gate Credit**
  - id: `fldJxPcC8tAvqks0F`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — lookup Config YN text (Yes/No) for blank-safe checkbox precedence
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldCk3Ilb4JVrhSUX","recordLinkFieldName":"Config (Global Scope)","fieldIdInLinkedTable":"fldyAukob3zsl4ecc","fieldNameInLinkedTable":"Recording Gives Full Zoom Gate Credit YN","fieldTableInLinkedTable":"Config"}`
- **Program Config: Perfect Week Credit**
  - id: `fld1JXcc1VIFrbprj`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — lookup Config YN text (Yes/No) for blank-safe checkbox precedence
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fldZfMa3MHCr23Flu","fieldNameInLinkedTable":"Recording Makeup Counts for Perfect Week YN","fieldTableInLinkedTable":"Config"}`
- **Global Config: Perfect Week Credit**
  - id: `fldRbQVOK2hkn4XfI`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — lookup Config YN text (Yes/No) for blank-safe checkbox precedence
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldCk3Ilb4JVrhSUX","recordLinkFieldName":"Config (Global Scope)","fieldIdInLinkedTable":"fldZfMa3MHCr23Flu","fieldNameInLinkedTable":"Recording Makeup Counts for Perfect Week YN","fieldTableInLinkedTable":"Config"}`
- **Program Config: Coach Approval Required**
  - id: `fldSIq2ipNOe6wwK9`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — lookup Config YN text (Yes/No) for blank-safe checkbox precedence
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fldviweNbx2tsDgK9","fieldNameInLinkedTable":"Recording Quiz Requires Coach Approval YN","fieldTableInLinkedTable":"Config"}`
- **Global Config: Coach Approval Required**
  - id: `fld0uUzrbX5MPjGcm`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — lookup Config YN text (Yes/No) for blank-safe checkbox precedence
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldCk3Ilb4JVrhSUX","recordLinkFieldName":"Config (Global Scope)","fieldIdInLinkedTable":"fldviweNbx2tsDgK9","fieldNameInLinkedTable":"Recording Quiz Requires Coach Approval YN","fieldTableInLinkedTable":"Config"}`
- **Program Config: Makeup Enabled**
  - id: `fldU0awkqf7dBtCMx`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — lookup Config YN text (Yes/No) for blank-safe checkbox precedence
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fldMJjx3kE92i6H7S","fieldNameInLinkedTable":"Recording Makeup Enabled YN","fieldTableInLinkedTable":"Config"}`
- **Global Config: Makeup Enabled**
  - id: `fld0FuPdNHd2lTjnD`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — lookup Config YN text (Yes/No) for blank-safe checkbox precedence
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldCk3Ilb4JVrhSUX","recordLinkFieldName":"Config (Global Scope)","fieldIdInLinkedTable":"fldMJjx3kE92i6H7S","fieldNameInLinkedTable":"Recording Makeup Enabled YN","fieldTableInLinkedTable":"Config"}`
- **Program Config: Approval Email Enabled**
  - id: `flduT63RW6F4ZEo0N`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — lookup Config YN text (Yes/No) for blank-safe checkbox precedence
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldDZPEVVJkNLE82d","recordLinkFieldName":"Config (Program Scope)","fieldIdInLinkedTable":"fldW69DD0odzxMURh","fieldNameInLinkedTable":"Recording Approval Email Enabled YN","fieldTableInLinkedTable":"Config"}`
- **Global Config: Approval Email Enabled**
  - id: `fld8NYdy0eIEkFFav`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 — lookup Config YN text (Yes/No) for blank-safe checkbox precedence
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldCk3Ilb4JVrhSUX","recordLinkFieldName":"Config (Global Scope)","fieldIdInLinkedTable":"fldW69DD0odzxMURh","fieldNameInLinkedTable":"Recording Approval Email Enabled YN","fieldTableInLinkedTable":"Config"}`
- **ZZZ C025 Archive — C025 Select Probe AJ Prog**
  - id: `fldYBDoDbPkPoPFrC`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldiUsPQwJAXfI7VX"],"referencedFieldNames":["Program Config: Deadline Mode"],"formula":"ARRAYJOIN({fldiUsPQwJAXfI7VX})","fieldReferencesById":["fldiUsPQwJAXfI7VX"],"fieldReferencesByName":["Program Config: Deadline Mode"],"dependencySource":"metadata"}`
- **ZZZ C025 Archive — C025 Select Probe Raw Prog**
  - id: `fldzkgKNktpABm3Iw`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldiUsPQwJAXfI7VX"],"referencedFieldNames":["Program Config: Deadline Mode"],"formula":"{fldiUsPQwJAXfI7VX}","fieldReferencesById":["fldiUsPQwJAXfI7VX"],"fieldReferencesByName":["Program Config: Deadline Mode"],"dependencySource":"metadata"}`
- **ZZZ C025 Archive — C025 Select Probe OverrideBlank**
  - id: `fld08DVUdFzuWWMJJ`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldthxCJSyDoG51OB"],"referencedFieldNames":["Deadline Mode — Meeting Override"],"formula":"IF({fldthxCJSyDoG51OB}!=BLANK(),\"HAS\",\"BLANK\")","fieldReferencesById":["fldthxCJSyDoG51OB"],"fieldReferencesByName":["Deadline Mode — Meeting Override"],"dependencySource":"metadata"}`
- **ZZZ C025 Archive — C025 Select Probe Nested**
  - id: `fld7BwFx7dDWqEsHh`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldiUsPQwJAXfI7VX"],"referencedFieldNames":["Program Config: Deadline Mode"],"formula":"IF(ARRAYJOIN({fldiUsPQwJAXfI7VX})!=BLANK(),ARRAYJOIN({fldiUsPQwJAXfI7VX}),\"FALL\")","fieldReferencesById":["fldiUsPQwJAXfI7VX"],"fieldReferencesByName":["Program Config: Deadline Mode"],"dependencySource":"metadata"}`
- **ZZZ C025 Archive — C025 Select Probe AJ Glob**
  - id: `fldAsOdBCQbNdO8cp`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldpBQTlvywnZOv23"],"referencedFieldNames":["Global Config: Deadline Mode"],"formula":"ARRAYJOIN({fldpBQTlvywnZOv23})","fieldReferencesById":["fldpBQTlvywnZOv23"],"fieldReferencesByName":["Global Config: Deadline Mode"],"dependencySource":"metadata"}`
- **ZZZ C025 Archive — C025 Select Probe OverrideRaw**
  - id: `fldXMn3fjFGTVjwRT`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldthxCJSyDoG51OB"],"referencedFieldNames":["Deadline Mode — Meeting Override"],"formula":"{fldthxCJSyDoG51OB}&\"\"","fieldReferencesById":["fldthxCJSyDoG51OB"],"fieldReferencesByName":["Deadline Mode — Meeting Override"],"dependencySource":"metadata"}`
- **ZZZ C025 Archive — C025 Select Probe BlankCmp**
  - id: `fldoJ82KVOXvqVgF1`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldthxCJSyDoG51OB"],"referencedFieldNames":["Deadline Mode — Meeting Override"],"formula":"IF({fldthxCJSyDoG51OB}=BLANK(),\"IS_BLANK\",\"NOT_BLANK\")","fieldReferencesById":["fldthxCJSyDoG51OB"],"fieldReferencesByName":["Deadline Mode — Meeting Override"],"dependencySource":"metadata"}`
- **ZZZ C025 Archive — C025 Select Probe Len**
  - id: `fldIt58ZRnqZ5ucLB`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldthxCJSyDoG51OB"],"referencedFieldNames":["Deadline Mode — Meeting Override"],"formula":"LEN(TRIM({fldthxCJSyDoG51OB}&\"\"))","fieldReferencesById":["fldthxCJSyDoG51OB"],"fieldReferencesByName":["Deadline Mode — Meeting Override"],"dependencySource":"metadata"}`
- **ZZZ C025 Archive — C025 Select Probe LenPath**
  - id: `fldOxOAGMAyl5Ddxl`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldthxCJSyDoG51OB"],"referencedFieldNames":["Deadline Mode — Meeting Override"],"formula":"IF(LEN(TRIM({fldthxCJSyDoG51OB}&\"\"))>0,\"HAS_TEXT\",\"NO_TEXT\")","fieldReferencesById":["fldthxCJSyDoG51OB"],"fieldReferencesByName":["Deadline Mode — Meeting Override"],"dependencySource":"metadata"}`

## Table: **Zoom Attendance**

- id: `tblfwbt6aCDCM5gUz`
- primary field: **Id** (`fldqYkHZP5A9xsKTL`)
- role guess: `operational summary`
- fields: `43`
- link fields: `2`
- computed fields: `24`
- description: Tracks attendance and quiz workflow for each athlete and each Zoom meeting.

### Fields

- **Id**
  - id: `fldqYkHZP5A9xsKTL`
  - type: `autoNumber`
  - role: `standard`
  - primary: `True`
- **Recording Quiz Response**
  - id: `fldTcncWmr2FqKJ8t`
  - type: `multilineText`
  - role: `standard`
  - primary: `False`
- **Recording Quiz Submitted At**
  - id: `fldvLxpqK9IOwERvQ`
  - type: `dateTime`
  - role: `standard`
  - primary: `False`
  - options summary: `{"dateFormat":{"name":"us","format":"M/D/YYYY"},"timeFormat":{"name":"12hour","format":"h:mma"},"timeZone":"utc"}`
- **Recording Quiz Review Status**
  - id: `fldWcpZKa0Qq0jnYV`
  - type: `singleSelect`
  - role: `status`
  - primary: `False`
  - options summary: `{"choices":["Not Submitted","Needs Review","Satisfactory","Needs Correction"],"choicesDetailed":[{"id":"selkrcaQEV34HkvSh","name":"Not Submitted","color":"blueLight2"},{"id":"selcIiKXKQ6Vpw2mJ","name":"Needs Review","color":"cyanLight2"},{"id":"selZ5LyRbompqqvD4","name":"Satisfactory","color":"tealLight2"},{"id":"selbg1QCq92CJUMC8","name":"Needs Correction","color":"greenLight2"}]}`
- **Recording Quiz Satisfactory?**
  - id: `fldyHfzYweXOvukvl`
  - type: `checkbox`
  - role: `standard`
  - primary: `False`
  - options summary: `{"icon":"thumbsUp","color":"greenBright"}`
- **Recording Quiz Coach Feedback**
  - id: `fldh0Cd9Vs8As2DKS`
  - type: `multilineText`
  - role: `standard`
  - primary: `False`
- **Recording Quiz Attempt Number**
  - id: `fldzUw4D6ffzm3bp8`
  - type: `number`
  - role: `standard`
  - primary: `False`
  - options summary: `{"precision":0}`
- **Live Attendance Confirmed?**
  - id: `fldPNJzsEy6cMzYxd`
  - type: `checkbox`
  - role: `standard`
  - primary: `False`
  - options summary: `{"icon":"thumbsUp","color":"greenBright"}`
- **Zoom Credit Approved?**
  - id: `fldJpQxQQuibUdi5w`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldpukA5h9bxCw2L6","fldXpn2rNrctyLac0"],"referencedFieldNames":["Zoom Credit Pre-Approved?","Zoom Credit Conflict?"],"formula":"IF(\n  AND(\n    {fldpukA5h9bxCw2L6} = 1,\n    {fldXpn2rNrctyLac0} != 1\n  ),\n  1,\n  0\n)","fieldReferencesById":["fldpukA5h9bxCw2L6","fldXpn2rNrctyLac0"],"fieldReferencesByName":["Zoom Credit Pre-Approved?","Zoom Credit Conflict?"],"dependencySource":"metadata"}`
- **Zoom XP Percentage**
  - id: `fld5ArV0SeMcHFcfw`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldXpn2rNrctyLac0","fldpukA5h9bxCw2L6","fld3bxJqGs4E8jB7j","fldLD3TUULTJC6yMW"],"referencedFieldNames":["Zoom Credit Conflict?","Zoom Credit Pre-Approved?","Attendance Method","Effective Recording XP Percentage"],"formula":"IF(\n  {fldXpn2rNrctyLac0} = 1,\n  0,\n  IF(\n    {fldpukA5h9bxCw2L6} != 1,\n    0,\n    IF(\n      {fld3bxJqGs4E8jB7j} = \"Live\",\n      100,\n      IF(\n        {fld3bxJqGs4E8jB7j} = \"Recording Quiz\",\n        IF(\n          {fldLD3TUULTJC6yMW} = BLANK(),\n          50,\n          {fldLD3TUULTJC6yMW}\n        ),\n        0\n      )\n    )\n  )\n)","fieldReferencesById":["fldXpn2rNrctyLac0","fldpukA5h9bxCw2L6","fld3bxJqGs4E8jB7j","fldLD3TUULTJC6yMW"],"fieldReferencesByName":["Zoom Credit Conflict?","Zoom Credit Pre-Approved?","Attendance Method","Effective Recording XP Percentage"],"dependencySource":"metadata"}`
- **Zoom XP Amount**
  - id: `fldplqn2f7yFwwyfg`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldXpn2rNrctyLac0","fldJpQxQQuibUdi5w","fldipxuIl3SpoyC6G","fld5ArV0SeMcHFcfw"],"referencedFieldNames":["Zoom Credit Conflict?","Zoom Credit Approved?","Normal Live Zoom XP","Zoom XP Percentage"],"formula":"IF(\n  OR(\n    {fldXpn2rNrctyLac0} = 1,\n    {fldJpQxQQuibUdi5w} != 1\n  ),\n  0,\n  IF(\n    {fldipxuIl3SpoyC6G} = BLANK(),\n    0,\n    FLOOR({fldipxuIl3SpoyC6G} * {fld5ArV0SeMcHFcfw} / 100)\n  )\n)","fieldReferencesById":["fldXpn2rNrctyLac0","fldJpQxQQuibUdi5w","fldipxuIl3SpoyC6G","fld5ArV0SeMcHFcfw"],"fieldReferencesByName":["Zoom Credit Conflict?","Zoom Credit Approved?","Normal Live Zoom XP","Zoom XP Percentage"],"dependencySource":"metadata"}`
- **Zoom Gate Credit Earned?**
  - id: `fldQR07soikQsD9nm`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldXpn2rNrctyLac0","fldJpQxQQuibUdi5w","fld3bxJqGs4E8jB7j","fldOycbJ145fdx123"],"referencedFieldNames":["Zoom Credit Conflict?","Zoom Credit Approved?","Attendance Method","Effective Recording Counts for Level Gate?"],"formula":"IF(\n  {fldXpn2rNrctyLac0} = 1,\n  0,\n  IF(\n    {fldJpQxQQuibUdi5w} != 1,\n    0,\n    IF(\n      {fld3bxJqGs4E8jB7j} = \"Live\",\n      1,\n      IF(\n        AND(\n          {fld3bxJqGs4E8jB7j} = \"Recording Quiz\",\n          {fldOycbJ145fdx123} = 1\n        ),\n        1,\n        0\n      )\n    )\n  )\n)","fieldReferencesById":["fldXpn2rNrctyLac0","fldJpQxQQuibUdi5w","fld3bxJqGs4E8jB7j","fldOycbJ145fdx123"],"fieldReferencesByName":["Zoom Credit Conflict?","Zoom Credit Approved?","Attendance Method","Effective Recording Counts for Level Gate?"],"dependencySource":"metadata"}`
- **Zoom Credit Key**
  - id: `fldhaYb9gaCndiQvx`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldovPSREAUf4TkeY","fldsgzEskQIVRDFiY"],"referencedFieldNames":["Enrollment RID","Zoom Meeting RID"],"formula":"IF(\n  OR(\n    {fldovPSREAUf4TkeY} = BLANK(),\n    {fldsgzEskQIVRDFiY} = BLANK()\n  ),\n  BLANK(),\n  \"ZOOM_CREDIT|\" & {fldovPSREAUf4TkeY} & \"|\" & {fldsgzEskQIVRDFiY}\n)","fieldReferencesById":["fldovPSREAUf4TkeY","fldsgzEskQIVRDFiY"],"fieldReferencesByName":["Enrollment RID","Zoom Meeting RID"],"dependencySource":"metadata"}`
- **Zoom Credit Conflict?**
  - id: `fldXpn2rNrctyLac0`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldovPSREAUf4TkeY","fld08lAdEm1TQElUC"],"referencedFieldNames":["Enrollment RID","Meeting Approved Preconflict Pair Tags"],"formula":"IF(\n  OR(\n    {fldovPSREAUf4TkeY} = BLANK(),\n    {fld08lAdEm1TQElUC} = BLANK()\n  ),\n  0,\n  IF(\n    AND(\n      FIND(\n        {fldovPSREAUf4TkeY} & \"|LIVE\",\n        {fld08lAdEm1TQElUC} & \"\"\n      ) > 0,\n      FIND(\n        {fldovPSREAUf4TkeY} & \"|REC\",\n        {fld08lAdEm1TQElUC} & \"\"\n      ) > 0\n    ),\n    1,\n    0\n  )\n)","fieldReferencesById":["fldovPSREAUf4TkeY","fld08lAdEm1TQElUC"],"fieldReferencesByName":["Enrollment RID","Meeting Approved Preconflict Pair Tags"],"dependencySource":"metadata"}`
- **Zoom Credit Debug**
  - id: `fldkoQiNgFoVG0ZoD`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fld3bxJqGs4E8jB7j","fldPNJzsEy6cMzYxd","fldWcpZKa0Qq0jnYV","fldyHfzYweXOvukvl","fldpukA5h9bxCw2L6","fldXpn2rNrctyLac0","fldJpQxQQuibUdi5w","fld5ArV0SeMcHFcfw","fldplqn2f7yFwwyfg","fldQR07soikQsD9nm","fldhaYb9gaCndiQvx","fldovPSREAUf4TkeY","fldsgzEskQIVRDFiY","fldLD3TUULTJC6yMW","fldOycbJ145fdx123","fldKzXPUskh2UxwIz","fldJnSfq7APTY3JD5"],"referencedFieldNames":["Attendance Method","Live Attendance Confirmed?","Recording Quiz Review Status","Recording Quiz Satisfactory?","Zoom Credit Pre-Approved?","Zoom Credit Conflict?","Zoom Credit Approved?","Zoom XP Percentage","Zoom XP Amount","Zoom Gate Credit Earned?","Zoom Credit Key","Enrollment RID","Zoom Meeting RID","Effective Recording XP Percentage","Effective Recording Counts for Level Gate?","Effective Recording Quiz Requires Coach Approval?","Calculated Recording Quiz Deadline"],"formula":"\"Method=\" & {fld3bxJqGs4E8jB7j} &\n\" | LiveConfirmed=\" &\nIF({fldPNJzsEy6cMzYxd} = 1, \"Y\", \"N\") &\n\" | Review=\" & {fldWcpZKa0Qq0jnYV} &\n\" | Satisfactory=\" &\nIF({fldyHfzYweXOvukvl} = 1, \"Y\", \"N\") &\n\" | PreApproved=\" &\nIF({fldpukA5h9bxCw2L6} = 1, \"Y\", \"N\") &\n\" | Conflict=\" &\nIF({fldXpn2rNrctyLac0} = 1, \"Y\", \"N\") &\n\" | Approved=\" &\nIF({fldJpQxQQuibUdi5w} = 1, \"Y\", \"N\") &\n\" | Pct=\" & {fld5ArV0SeMcHFcfw} &\n\" | XP=\" & {fldplqn2f7yFwwyfg} &\n\" | Gate=\" &\nIF({fldQR07soikQsD9nm} = 1, \"Y\", \"N\") &\n\" | Key=\" & {fldhaYb9gaCndiQvx} &\n\" | EnrollmentRID=\" & {fldovPSREAUf4TkeY} &\n\" | MeetingRID=\" & {fldsgzEskQIVRDFiY} &\n\" | EffectivePct=\" & {fldLD3TUULTJC6yMW} &\n\" | EffectiveGate=\" &\n{fldOycbJ145fdx123} &\n\" | EffectiveCoachApproval=\" &\n{fldKzXPUskh2UxwIz} &\n\" | Deadline=\" &\n{fldJnSfq7APTY3JD5}","fieldReferencesById":["fld3bxJqGs4E8jB7j","fldPNJzsEy6cMzYxd","fldWcpZKa0Qq0jnYV","fldyHfzYweXOvukvl","fldpukA5h9bxCw2L6","fldXpn2rNrctyLac0","fldJpQxQQuibUdi5w","fld5ArV0SeMcHFcfw","fldplqn2f7yFwwyfg","fldQR07soikQsD9nm","fldhaYb9gaCndiQvx","fldovPSREAUf4TkeY","fldsgzEskQIVRDFiY","fldLD3TUULTJC6yMW","fldOycbJ145fdx123","fldKzXPUskh2UxwIz","fldJnSfq7APTY3JD5"],"fieldReferencesByName":["Attendance Method","Live Attendance Confirmed?","Recording Quiz Review Status","Recording Quiz Satisfactory?","Zoom Credit Pre-Approved?","Zoom Credit Conflict?","Zoom Credit Approved?","Zoom XP Percentage","Zoom XP Amount","Zoom Gate Credit Earned?","Zoom Credit Key","Enrollment RID","Zoom Meeting RID","Effective Recording XP Percentage","Effective Recording Counts for Level Gate?","Effective Recording Quiz Requires Coach Approval?","Calculated Recording Quiz Deadline"],"dependencySource":"metadata"}`
- **Enrollment**
  - id: `fld6VA8craEkzgl8y`
  - type: `multipleRecordLinks`
  - role: `link`
  - primary: `False`
  - options summary: `{"linkedTableId":"tbl3PFmwbRoabu1YV","linkedTableName":"Enrollments","inverseLinkFieldId":"fldfMmRhD7Ubyhs5r","inverseLinkFieldName":"Zoom Attendance","prefersSingleRecordLink":true,"isReversed":false}`
- **Zoom Meeting**
  - id: `fldHzgxuxbyzrQHYA`
  - type: `multipleRecordLinks`
  - role: `link`
  - primary: `False`
  - options summary: `{"linkedTableId":"tblWcSHEm8vNNIxyB","linkedTableName":"Zoom Meetings","inverseLinkFieldId":"fldELpIe5BwPhXaTA","inverseLinkFieldName":"Zoom Attendance","prefersSingleRecordLink":true,"isReversed":false}`
- **Normal Live Zoom XP**
  - id: `fldipxuIl3SpoyC6G`
  - type: `number`
  - role: `standard`
  - primary: `False`
  - options summary: `{"precision":0}`
- **Attendance Method**
  - id: `fld3bxJqGs4E8jB7j`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - options summary: `{"choices":["Live","Recording Quiz"],"choicesDetailed":[{"id":"selGWYY4EBizjBvNW","name":"Live","color":"blueLight2"},{"id":"selx1B4ySHUHgFJfQ","name":"Recording Quiz","color":"cyanLight2"}]}`
- **Effective Recording XP Percentage**
  - id: `fldLD3TUULTJC6yMW`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldHzgxuxbyzrQHYA","recordLinkFieldName":"Zoom Meeting","fieldIdInLinkedTable":"fldgBdBIDvjMELY3o","fieldNameInLinkedTable":"Effective Recording XP Percentage","fieldTableInLinkedTable":"Zoom Meetings"}`
- **Effective Recording Counts for Level Gate?**
  - id: `fldOycbJ145fdx123`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldHzgxuxbyzrQHYA","recordLinkFieldName":"Zoom Meeting","fieldIdInLinkedTable":"fldswwnnpWpiKSIL4","fieldNameInLinkedTable":"Effective Recording Counts for Level Gate?","fieldTableInLinkedTable":"Zoom Meetings"}`
- **Effective Recording Counts for Perfect Week?**
  - id: `fld3OF6y2q49jI2xg`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldHzgxuxbyzrQHYA","recordLinkFieldName":"Zoom Meeting","fieldIdInLinkedTable":"fldEfs9Xk4cIm7sqA","fieldNameInLinkedTable":"Effective Recording Counts for Perfect Week?","fieldTableInLinkedTable":"Zoom Meetings"}`
- **Effective Recording Quiz Requires Coach Approval?**
  - id: `fldKzXPUskh2UxwIz`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldHzgxuxbyzrQHYA","recordLinkFieldName":"Zoom Meeting","fieldIdInLinkedTable":"fldkKRtkzO4AkNyED","fieldNameInLinkedTable":"Effective Recording Quiz Requires Coach Approval?","fieldTableInLinkedTable":"Zoom Meetings"}`
- **Effective Recording Makeup Enabled?**
  - id: `fldl71FnAgxveYyjO`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldHzgxuxbyzrQHYA","recordLinkFieldName":"Zoom Meeting","fieldIdInLinkedTable":"fldppA7JHEbYNu3bR","fieldNameInLinkedTable":"Effective Recording Makeup Enabled?","fieldTableInLinkedTable":"Zoom Meetings"}`
- **Effective Recording Makeup Window Days**
  - id: `fld53QbuYnyySrz9X`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldHzgxuxbyzrQHYA","recordLinkFieldName":"Zoom Meeting","fieldIdInLinkedTable":"fldfDKHOn54ZbH7XL","fieldNameInLinkedTable":"Effective Recording Makeup Window Days","fieldTableInLinkedTable":"Zoom Meetings"}`
- **Effective Recording Deadline Mode**
  - id: `fldFzzOYPQpvV8Xdq`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldHzgxuxbyzrQHYA","recordLinkFieldName":"Zoom Meeting","fieldIdInLinkedTable":"fldnwzUITHTzEeR5n","fieldNameInLinkedTable":"Effective Recording Deadline Mode","fieldTableInLinkedTable":"Zoom Meetings"}`
- **Zoom Meeting RID**
  - id: `fldsgzEskQIVRDFiY`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldHzgxuxbyzrQHYA","recordLinkFieldName":"Zoom Meeting","fieldIdInLinkedTable":"fld5fWmgD4tNKQEfz","fieldNameInLinkedTable":"RecordId","fieldTableInLinkedTable":"Zoom Meetings"}`
- **Enrollment RID**
  - id: `fldovPSREAUf4TkeY`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fld6VA8craEkzgl8y","recordLinkFieldName":"Enrollment","fieldIdInLinkedTable":"fldnsyxEUbrJjyzXU","fieldNameInLinkedTable":"Record Id","fieldTableInLinkedTable":"Enrollments"}`
- **Calculated Recording Quiz Deadline**
  - id: `fldJnSfq7APTY3JD5`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"date","resultOptions":{"dateFormat":{"name":"us","format":"M/D/YYYY"}},"recordLinkFieldId":"fldHzgxuxbyzrQHYA","recordLinkFieldName":"Zoom Meeting","fieldIdInLinkedTable":"fldbmg5yT9O2TSqwn","fieldNameInLinkedTable":"Calculated Recording Quiz Deadline","fieldTableInLinkedTable":"Zoom Meetings"}`
- **Zoom Recording Quiz — Past Deadline (view marker)**
  - id: `fldr1qhbdGPM4Qct9`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fld3bxJqGs4E8jB7j","fldJnSfq7APTY3JD5","fldJpQxQQuibUdi5w"],"referencedFieldNames":["Attendance Method","Calculated Recording Quiz Deadline","Zoom Credit Approved?"],"formula":"AND(\n  {fld3bxJqGs4E8jB7j} = 'Recording Quiz',\n  {fldJnSfq7APTY3JD5} < TODAY(),\n  NOT({fldJpQxQQuibUdi5w})\n)","fieldReferencesById":["fld3bxJqGs4E8jB7j","fldJnSfq7APTY3JD5","fldJpQxQQuibUdi5w"],"fieldReferencesByName":["Attendance Method","Calculated Recording Quiz Deadline","Zoom Credit Approved?"],"dependencySource":"metadata"}`
- **Zoom Credit Pre-Approved?**
  - id: `fldpukA5h9bxCw2L6`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fld3bxJqGs4E8jB7j","fldPNJzsEy6cMzYxd","fldl71FnAgxveYyjO","fldKzXPUskh2UxwIz","fldWcpZKa0Qq0jnYV","fldyHfzYweXOvukvl"],"referencedFieldNames":["Attendance Method","Live Attendance Confirmed?","Effective Recording Makeup Enabled?","Effective Recording Quiz Requires Coach Approval?","Recording Quiz Review Status","Recording Quiz Satisfactory?"],"formula":"IF(\r\n  {fld3bxJqGs4E8jB7j} = \"Live\",\r\n  IF({fldPNJzsEy6cMzYxd} = 1, 1, 0),\r\n  IF(\r\n    {fld3bxJqGs4E8jB7j} = \"Recording Quiz\",\r\n    IF(\r\n      AND(\r\n        OR(\r\n          {fldl71FnAgxveYyjO} = BLANK(),\r\n          {fldl71FnAgxveYyjO} = 1\r\n        ),\r\n        IF(\r\n          OR(\r\n            {fldKzXPUskh2UxwIz} = BLANK(),\r\n            {fldKzXPUskh2UxwIz} = 1\r\n          ),\r\n          AND(\r\n            {fldWcpZKa0Qq0jnYV} = \"Satisfactory\",\r\n            {fldyHfzYweXOvukvl} = 1\r\n          ),\r\n          OR(\r\n            {fldWcpZKa0Qq0jnYV} = \"Satisfactory\",\r\n            {fldWcpZKa0Qq0jnYV} = \"Needs Review\"\r\n          )\r\n        )\r\n      ),\r\n      1,\r\n      0\r\n    ),\r\n    0\r\n  )\r\n)","fieldReferencesById":["fld3bxJqGs4E8jB7j","fldPNJzsEy6cMzYxd","fldl71FnAgxveYyjO","fldKzXPUskh2UxwIz","fldWcpZKa0Qq0jnYV","fldyHfzYweXOvukvl"],"fieldReferencesByName":["Attendance Method","Live Attendance Confirmed?","Effective Recording Makeup Enabled?","Effective Recording Quiz Requires Coach Approval?","Recording Quiz Review Status","Recording Quiz Satisfactory?"],"dependencySource":"metadata"}`
- **Preconflict Pair Tag**
  - id: `fldQJiAeb7K9G3cEl`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldpukA5h9bxCw2L6","fldovPSREAUf4TkeY","fldsgzEskQIVRDFiY","fld3bxJqGs4E8jB7j"],"referencedFieldNames":["Zoom Credit Pre-Approved?","Enrollment RID","Zoom Meeting RID","Attendance Method"],"formula":"IF(\r\n  {fldpukA5h9bxCw2L6} = 1,\r\n  IF(\r\n    OR(\r\n      {fldovPSREAUf4TkeY} = BLANK(),\r\n      {fldsgzEskQIVRDFiY} = BLANK()\r\n    ),\r\n    BLANK(),\r\n    {fldovPSREAUf4TkeY} &\r\n    \"|\" &\r\n    IF(\r\n      {fld3bxJqGs4E8jB7j} = \"Live\",\r\n      \"LIVE\",\r\n      \"REC\"\r\n    )\r\n  ),\r\n  BLANK()\r\n)","fieldReferencesById":["fldpukA5h9bxCw2L6","fldovPSREAUf4TkeY","fldsgzEskQIVRDFiY","fld3bxJqGs4E8jB7j"],"fieldReferencesByName":["Zoom Credit Pre-Approved?","Enrollment RID","Zoom Meeting RID","Attendance Method"],"dependencySource":"metadata"}`
- **Meeting Approved Preconflict Pair Tags**
  - id: `fld08lAdEm1TQElUC`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 meeting-level preconflict tags
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldHzgxuxbyzrQHYA","recordLinkFieldName":"Zoom Meeting","fieldIdInLinkedTable":"fldcM3v5VOjjW002p","fieldNameInLinkedTable":"Approved Preconflict Pair Tags","fieldTableInLinkedTable":"Zoom Meetings"}`
- **Gate Credit Applied?**
  - id: `fldGlxhCsv3cJp9E9`
  - type: `checkbox`
  - role: `standard`
  - primary: `False`
...
- **Recording Quiz Needs Correction At**
  ...
  - options summary: `{"dateFormat":{"name":"local","format":"l"},"timeFormat":{"name":"24hour","format":"HH:mm"},"timeZone":"America/Denver"}`
- **Effective Recording Approval Email Enabled?**
  - id: `fldBt02PeTgL3cw6o`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 117f — lookup Zoom Meetings Effective approval-email setting
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"recordLinkFieldId":"fldHzgxuxbyzrQHYA","recordLinkFieldName":"Zoom Meeting","fieldIdInLinkedTable":"fldqPzKXweQISK4ZR","fieldNameInLinkedTable":"Effective Recording Approval Email Enabled?","fieldTableInLinkedTable":"Zoom Meetings"}`
- **Effective Recording Approval Email Timing**
  - id: `fldgcaQGTka5RkD5o`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 117f — lookup Zoom Meetings Effective approval-email setting
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldHzgxuxbyzrQHYA","recordLinkFieldName":"Zoom Meeting","fieldIdInLinkedTable":"fldT2SG7GRc7sT32u","fieldNameInLinkedTable":"Effective Recording Approval Email Timing","fieldTableInLinkedTable":"Zoom Meetings"}`
- **Effective Recording Approval Email Template Key**
  - id: `fldUs1EDTRkAYt79j`
  - type: `multipleLookupValues`
  - role: `lookup`
  - primary: `False`
  - desc: C-025 117f — lookup Zoom Meetings Effective approval-email setting
  - options summary: `{"isValid":true,"resultType":"singleLineText","recordLinkFieldId":"fldHzgxuxbyzrQHYA","recordLinkFieldName":"Zoom Meeting","fieldIdInLinkedTable":"fldQtvxkRPGCJ7pq8","fieldNameInLinkedTable":"Effective Recording Approval Email Template Key","fieldTableInLinkedTable":"Zoom Meetings"}`
...
- **Zoom Recording Deadline Mode**
  - id: `fldQ61QvoZSbMLFIK`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - desc: C-025 — Deadline mode
  - options summary: `{"choices":["Days After Recording Available","End of Program Week","Later of Both","Earlier of Both"],"choicesDetailed":[{"id":"selDEx0p5CjbmEU73","name":"Days After Recording Available","color":"grayLight2"},{"id":"selyhdYZsHKNdIVvI","name":"End of Program Week","color":"grayLight2"},{"id":"sel6GI1y5PvNR2vSO","name":"Later of Both","color":"grayLight2"},{"id":"selAndfNLXgCgOVjq","name":"Earlier of Both","color":"grayLight2"}]}`
- **Recording Approval Email Enabled?**
  - id: `fldWGs5xDGD4UwIDM`
  - type: `checkbox`
  - role: `contact`
  - primary: `False`
...
- **Recording Approval Email Timing**
  - id: `fld3m4sPbI5xHint3`
  - type: `singleSelect`
  - role: `contact`
  - primary: `False`
  - desc: C-025 — When to send approval email
  - options summary: `{"choices":["On Satisfactory"],"choicesDetailed":[{"id":"selhhwQqY4BNSECo1","name":"On Satisfactory","color":"grayLight2"}]}`
- **Recording Approval Email Template Key**
  - id: `fldzmMcbHHJ77yz0v`
  - type: `singleLineText`
  - role: `contact`
  - primary: `False`
  - desc: C-025 — Make/email template key
- **Recording Path Enabled?**
  - id: `flduBG29tSHjHergL`
  - type: `checkbox`
  - role: `standard`
  - primary: `False`
  - desc: C-025 — Config-only master path switch (no ZM Effective this slice)
  - options summary: `{"icon":"check","color":"greenBright"}`
- **Program Instance**
  - id: `fld9KuUMhOAavlk2Y`
  - type: `multipleRecordLinks`
  - role: `link`
  - primary: `False`
  - desc: C-025 — Optional program-scope declaration on Config row
  - options summary: `{"linkedTableId":"tblMfALZa4YYUy70P","linkedTableName":"Program Instance - Synced","inverseLinkFieldId":"fldYviNLkJCyVOAtO","inverseLinkFieldName":"Config","prefersSingleRecordLink":false,"isReversed":false}`
- **Is Global Default?**
  - id: `fld8D2Xq32FhEPo3E`
  - type: `checkbox`
  - role: `standard`
  - primary: `False`
  - desc: C-025 — Marks Global Config tier-3 row
  - options summary: `{"icon":"check","color":"greenBright"}`
- **Zoom Meetings**
  - id: `fldrNisEXGjcQmEVu`
  - type: `multipleRecordLinks`
  - role: `link`
  - primary: `False`
  - options summary: `{"linkedTableId":"tblWcSHEm8vNNIxyB","linkedTableName":"Zoom Meetings","inverseLinkFieldId":"fldDZPEVVJkNLE82d","inverseLinkFieldName":"Config (Program Scope)","prefersSingleRecordLink":false,"isReversed":false}`
- **Zoom Meetings 2**
  - id: `fldPDq4jvOhQs5YbV`
  - type: `multipleRecordLinks`
  - role: `link`
  - primary: `False`
  - options summary: `{"linkedTableId":"tblWcSHEm8vNNIxyB","linkedTableName":"Zoom Meetings","inverseLinkFieldId":"fldCk3Ilb4JVrhSUX","inverseLinkFieldName":"Config (Global Scope)","prefersSingleRecordLink":false,"isReversed":false}`
- **Recording Gives Full Zoom Gate Credit YN**
  - id: `fldyAukob3zsl4ecc`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - desc: C-025 — Yes/No companion for checkbox blank-safe Config linkage
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fld9QHugLr37qJmGS"],"referencedFieldNames":["Recording Gives Full Zoom Gate Credit?"],"formula":"IF({fld9QHugLr37qJmGS}, \"Yes\", \"No\")","fieldReferencesById":["fld9QHugLr37qJmGS"],"fieldReferencesByName":["Recording Gives Full Zoom Gate Credit?"],"dependencySource":"metadata"}`
- **Recording Makeup Counts for Perfect Week YN**
  - id: `fldZfMa3MHCr23Flu`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - desc: C-025 — Yes/No companion for checkbox blank-safe Config linkage
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldmahedrTcx111aX"],"referencedFieldNames":["Recording Makeup Counts for Perfect Week?"],"formula":"IF({fldmahedrTcx111aX}, \"Yes\", \"No\")","fieldReferencesById":["fldmahedrTcx111aX"],"fieldReferencesByName":["Recording Makeup Counts for Perfect Week?"],"dependencySource":"metadata"}`
- **Recording Quiz Requires Coach Approval YN**
  - id: `fldviweNbx2tsDgK9`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - desc: C-025 — Yes/No companion for checkbox blank-safe Config linkage
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldB5cmOxn0AtcHUc"],"referencedFieldNames":["Recording Quiz Requires Coach Approval?"],"formula":"IF({fldB5cmOxn0AtcHUc}, \"Yes\", \"No\")","fieldReferencesById":["fldB5cmOxn0AtcHUc"],"fieldReferencesByName":["Recording Quiz Requires Coach Approval?"],"dependencySource":"metadata"}`
- **Recording Makeup Enabled YN**
  - id: `fldMJjx3kE92i6H7S`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - desc: C-025 — Yes/No companion for checkbox blank-safe Config linkage
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldEktL1d27p5KlF5"],"referencedFieldNames":["Recording Makeup Enabled?"],"formula":"IF({fldEktL1d27p5KlF5}, \"Yes\", \"No\")","fieldReferencesById":["fldEktL1d27p5KlF5"],"fieldReferencesByName":["Recording Makeup Enabled?"],"dependencySource":"metadata"}`
- **Recording Approval Email Enabled YN**
  - id: `fldW69DD0odzxMURh`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - desc: C-025 — Yes/No companion for checkbox blank-safe Config linkage
  - options summary: `{"isValid":true,"resultType":"singleLineText","referencedFieldIds":["fldWGs5xDGD4UwIDM"],"referencedFieldNames":["Recording Approval Email Enabled?"],"formula":"IF({fldWGs5xDGD4UwIDM}, \"Yes\", \"No\")","fieldReferencesById":["fldWGs5xDGD4UwIDM"],"fieldReferencesByName":["Recording Approval Email Enabled?"],"dependencySource":"metadata"}`
...
- **Recipient Name**
  - id: `fldcJwu5HsFisPDWq`
  - type: `singleLineText`
  - role: `standard`
  - primary: `False`
  - desc: Writable Tremendous recipient name. For live awards, copy from Athlete Name - Display. For sandbox tests, use the tester name. Do not send parent/athlete production names during the first test.
- **Tremendous Reward ID**
  - id: `fldh16n5bymnn20WI`
  - type: `singleLineText`
  - role: `identifier`
  - primary: `False`
  - desc: Tremendous reward id returned after a successful send. If populated, Make must never send again.
- **Tremendous External ID**
  - id: `fld8f2AXegatJzmgy`
  - type: `singleLineText`
  - role: `identifier`
  - primary: `False`
...
- **Tremendous Environment**
  - id: `fld796Csqcz9uZnzO`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - desc: Sandbox or Production Tremendous endpoint. Default in the field UI should be Sandbox. First test must stay Sandbox.
  - options summary: `{"choices":["Sandbox","Production"],"choicesDetailed":[{"id":"selOt8b2yJvoUCCVJ","name":"Sandbox","color":"cyanLight2"},{"id":"selWXyFORacQr6NVx","name":"Production","color":"greenLight2"}]}`
- **Tremendous Delivery Status**
  - id: `fldZlRR7yNic9sZmx`
  - type: `singleSelect`
  - role: `status`
  - primary: `False`
  - desc: Tremendous delivery state. Default in the field UI should be Not Sent.
  - options summary: `{"choices":["Not Sent","Pending","Scheduled","Succeeded","Failed","Canceled","Flagged"],"choicesDetailed":[{"id":"sel1fOKQ9AwHuyy1S","name":"Not Sent","color":"grayLight2"},{"id":"selqKrCyaYpmq0CQt","name":"Pending","color":"yellowLight2"},{"id":"sel4Zpk4mVJTA9DGA","name":"Scheduled","color":"cyanLight2"},{"id":"selZoQNq1fUQYeuSm","name":"Succeeded","color":"greenLight2"},{"id":"selaOgZdU6eSA4grd","name":"Failed","color":"redLight2"},{"id":"selGFKJvyaK17qpFQ","name":"Canceled","color":"orangeLight2"},{"id":"seluLmB4nhSBzYsNW","name":"Flagged","color":"pinkLight2"}]}`
- **Recipient Email**
  - id: `fld0V82fAHpKQUbfY`
  - type: `email`
  - role: `contact`
  - primary: `False`
  - desc: Writable Tremendous destination email. For live awards, copy from Parent Email. For the first sandbox test, use Mike's own sandbox inbox only — never a parent email.
- **Tremendous Order ID**
  - id: `fldp12AQbKrFim9yX`
  - type: `singleLineText`
  - role: `identifier`
  - primary: `False`
  - desc: Tremendous order id returned after a successful send. If populated, Make must never send again.
- **Tremendous Sent At**
  - id: `fldMbPEWJ1WYToeGv`
  - type: `dateTime`
  - role: `standard`
  - primary: `False`
  - desc: When Make sent the sandbox/production order.
  - options summary: `{"dateFormat":{"name":"us","format":"M/D/YYYY"},"timeFormat":{"name":"12hour","format":"h:mma"},"timeZone":"America/Denver"}`
- **Tremendous Delivered At**
  - id: `fldaP1s0AOTcsuqmF`
  - type: `dateTime`
  - role: `standard`
  - primary: `False`
...
- **Send to Tremendous?**
  ...
  - options summary: `{"icon":"check","color":"greenBright"}`
- **Ready to Send?**
  - id: `fldYXe4CHMwrfH62K`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - desc: 1 when the award is Approved, has recipient email and a positive amount, and has not already been sent to Tremendous. Does not include the manual Send to Tremendous? switch — that is a separate gate.
  - options summary: `{"isValid":true,"resultType":"number","resultOptions":{"precision":0},"referencedFieldIds":["fldFOsYD5HxeUHq3M","fld0V82fAHpKQUbfY","fld48LJbn67iHmk3c","fldp12AQbKrFim9yX","fldh16n5bymnn20WI"],"referencedFieldNames":["Award Status","Recipient Email","Award Amount","Tremendous Order ID","Tremendous Reward ID"],"formula":"IF(\n  AND(\n    {fldFOsYD5HxeUHq3M} = \"Approved\",\n    LEN(TRIM({fld0V82fAHpKQUbfY} & \"\")) > 0,\n    {fld48LJbn67iHmk3c},\n    LEN(TRIM({fldp12AQbKrFim9yX} & \"\")) = 0,\n    LEN(TRIM({fldh16n5bymnn20WI} & \"\")) = 0\n  ),\n  IF(VALUE(SUBSTITUTE(ARRAYJOIN({fld48LJbn67iHmk3c}) & \"\", \"$\", \"\")) > 0, 1, 0),\n  0\n)","fieldReferencesById":["fldFOsYD5HxeUHq3M","fld0V82fAHpKQUbfY","fld48LJbn67iHmk3c","fldp12AQbKrFim9yX","fldh16n5bymnn20WI"],"fieldReferencesByName":["Award Status","Recipient Email","Award Amount","Tremendous Order ID","Tremendous Reward ID"],"dependencySource":"metadata"}`
...
- **Testing Scenarios**
  - id: `fldP6gslD5PxexV4i`
  - type: `multipleRecordLinks`
  - role: `link`
  - primary: `False`
  - options summary: `{"linkedTableId":"tblEQLsXTCwx0iOd8","linkedTableName":"Testing Scenarios","inverseLinkFieldId":"fldNtyAo1tZsRQXmB","inverseLinkFieldName":"Pipeline Entity Linked","prefersSingleRecordLink":false,"isReversed":false}`

## Table: **Testing Scenarios**

- id: `tblEQLsXTCwx0iOd8`
- primary field: **Test Intake Name** (`fldqfcodjXsPpyl05`)
- role guess: `operational summary`
- fields: `31`
- link fields: `5`
- computed fields: `1`
- description: Centralizes all DEV test submission scenarios and operator workflow management.

### Fields

- **Test Intake Name**
  - id: `fldqfcodjXsPpyl05`
  - type: `singleLineText`
  - role: `standard`
  - primary: `True`
- **RecordId - Testing Scenarios**
  - id: `fldbTZyPHGCLC8Ioa`
  - type: `formula`
  - role: `formula`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"singleLineText","formula":"RECORD_ID()","dependencySource":"none"}`
- **Run Test?**
  - id: `fldAjFqic7nEBWgBT`
  - type: `checkbox`
  - role: `standard`
  - primary: `False`
  - options summary: `{"icon":"thumbsUp","color":"greenBright"}`
- **Last Run Status**
  - id: `fld4tedtEbwfa1cMB`
  - type: `singleSelect`
  - role: `status`
  - primary: `False`
  - options summary: `{"choices":["Not Run","Pass","Fail","Blocked","Error"],"choicesDetailed":[{"id":"selU9lcUC1CmY1rsF","name":"Not Run","color":"blueLight2"},{"id":"selZhli6tQH2MLERa","name":"Pass","color":"cyanLight2"},{"id":"selBPgwb3tKJoEMqj","name":"Fail","color":"tealLight2"},{"id":"selwzM51XXu1jEL5C","name":"Blocked","color":"greenLight2"},{"id":"selfXOOgLMjRmXDzp","name":"Error","color":"yellowLight2"}]}`
- **Test Status**
  - id: `fldji9YCoxcTIR6Cu`
  - type: `singleSelect`
  - role: `status`
  - primary: `False`
  - options summary: `{"choices":["Not Started","Queued","In Progress","Blocked","Completed","Rejected"],"choicesDetailed":[{"id":"selvOl85gvRH9AGh4","name":"Not Started","color":"blueLight2"},{"id":"selhZDHo1v5u8Ttcb","name":"Queued","color":"cyanLight2"},{"id":"selyHBfgkHUQm8YWL","name":"In Progress","color":"tealLight2"},{"id":"seltp6wKDvBkjshFQ","name":"Blocked","color":"greenLight2"},{"id":"selSMdzaocTgJfOWx","name":"Completed","color":"yellowLight2"},{"id":"selwDoCcD7830t6Xv","name":"Rejected","color":"orangeLight2"}]}`
- **Operator Feedback**
  - id: `fldslXpxwlEBxousb`
  - type: `multilineText`
  - role: `standard`
  - primary: `False`
- **Expected Result**
  - id: `fldvIibzIarXIOHlw`
  - type: `multilineText`
  - role: `standard`
  - primary: `False`
- **Actual Result**
  - id: `fld41YuEuFYTNAaOC`
  - type: `multilineText`
  - role: `standard`
  - primary: `False`
- **Pass/Fail Notes**
  - id: `fldDfIl3muCcjV8U2`
  - type: `multilineText`
  - role: `narrative`
  - primary: `False`
- **Scenario Type**
  - id: `fldcTd7qaFhyKZp5Q`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - options summary: `{"choices":["Daily Submission","Homework","Homework + Video","Three Video Upload","Milestone Crossing","Perfect Week","Backdated Submission","Parent Feedback","Weekly Summary","Award Generation","Other","Video"],"choicesDetailed":[{"id":"sel6EtRvFIfy8oCrT","name":"Daily Submission","color":"blueLight2"},{"id":"selwEylIdfit5KjGD","name":"Homework","color":"cyanLight2"},{"id":"selLHztMDAnxKnUNo","name":"Homework + Video","color":"tealLight2"},{"id":"selTrpERbe6IkCMh5","name":"Three Video Upload","color":"greenLight2"},{"id":"selPsO0ArlMklSCFm","name":"Milestone Crossing","color":"yellowLight2"},{"id":"sel1WefZwT6joNpXV","name":"Perfect Week","color":"orangeLight2"},{"id":"selCKL11Y6hFOWJXo","name":"Backdated Submission","color":"redLight2"},{"id":"sel2eLHnGatmAsPNz","name":"Parent Feedback","color":"pinkLight2"},{"id":"selgzq4EElbWvGXxJ","name":"Weekly Summary","color":"purpleLight2"},{"id":"seluEb6Gxmz0P73vH","name":"Award Generation","color":"grayLight2"},{"id":"selO9IS2H40DsiENi","name":"Other","color":"blueLight1"},{"id":"selFoeh8vKmsoUrFb","name":"Video","color":"blueLight2"}]}`
- **Operator Assigned**
  - id: `fldTGPN6emJvYb03J`
  - type: `singleCollaborator`
  - role: `standard`
  - primary: `False`
- **Pipeline Entity Linked**
  - id: `fldNtyAo1tZsRQXmB`
  - type: `multipleRecordLinks`
  - role: `link`
  - primary: `False`
  - options summary: `{"linkedTableId":"tbl6ORxLs192mXEWp","linkedTableName":"Final Reflection Quiz Submissions","inverseLinkFieldId":"fldP6gslD5PxexV4i","inverseLinkFieldName":"Testing Scenarios","prefersSingleRecordLink":true,"isReversed":false}`
- **Related Enrollment**
  - id: `fldPylkKBdhFTTDCL`
  - type: `multipleRecordLinks`
  - role: `link`
  - primary: `False`
  - options summary: `{"linkedTableId":"tbl3PFmwbRoabu1YV","linkedTableName":"Enrollments","inverseLinkFieldId":"fldKYVEkFcbSrwczx","inverseLinkFieldName":"Testing Scenarios","prefersSingleRecordLink":true,"isReversed":false}`
- **Submission Date**
  - id: `fldNCS0y5Ez4pFccA`
  - type: `date`
  - role: `standard`
  - primary: `False`
  - options summary: `{"dateFormat":{"name":"local","format":"l"}}`
- **Test Notes**
  - id: `fldD8y9YrgIhjiqfu`
  - type: `multilineText`
  - role: `narrative`
  - primary: `False`
- **Relevant Homework Completion**
  - id: `fldD1xEqr5fyFluuN`
  - type: `multipleRecordLinks`
  - role: `link`
  - primary: `False`
  - options summary: `{"linkedTableId":"tblv58ppTFDBXb3nv","linkedTableName":"Homework Completions","inverseLinkFieldId":"fldfoQWecOLx9QKP7","inverseLinkFieldName":"Testing Scenarios","prefersSingleRecordLink":true,"isReversed":false}`
- **Scenario Requirements**
  - id: `fldVWP6MVqrBXqa6J`
  - type: `multilineText`
  - role: `standard`
  - primary: `False`
- **Intake Attachments**
  - id: `fldYubBWgAKHstQ6P`
  - type: `multipleAttachments`
  - role: `standard`
  - primary: `False`
- **Operator Priority**
  - id: `fldTJ17facY3V6rUf`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - options summary: `{"choices":["P1 - Urgent","P2 - High","P3 - Routine"],"choicesDetailed":[{"id":"selifjlLJKIkD0Atm","name":"P1 - Urgent","color":"blueLight2"},{"id":"selC2nB9uAQhTbUfl","name":"P2 - High","color":"cyanLight2"},{"id":"selNFqvVTwo0f2jPg","name":"P3 - Routine","color":"tealLight2"}]}`
- **Automation Platform**
  - id: `fldEMLXIjQYgPpB4k`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - options summary: `{"choices":["Manual","Fillout","Make","Other"],"choicesDetailed":[{"id":"selpVgEi2SWcdD8Cl","name":"Manual","color":"blueLight2"},{"id":"seldt18JljB0AhHtC","name":"Fillout","color":"cyanLight2"},{"id":"seln5ptOqtNfUEKi8","name":"Make","color":"tealLight2"},{"id":"selILXg76aahSGm7b","name":"Other","color":"greenLight2"}]}`
- **Last Updated**
  - id: `fldNrhrZIVIuhCctc`
  - type: `lastModifiedTime`
  - role: `audit`
  - primary: `False`
  - options summary: `{"isValid":true,"resultType":"date","resultOptions":{"dateFormat":{"name":"us","format":"M/D/YYYY"}},"dateFormat":{"name":"us","format":"M/D/YYYY"}}`
- **Test Submission Summary**
  - id: `fldcFA3EQZ4Btfvzc`
  - type: `aiText`
  - role: `standard`
  - primary: `False`
  - options summary: `{"referencedFieldIds":["fldcTd7qaFhyKZp5Q","fldji9YCoxcTIR6Cu","fldD8y9YrgIhjiqfu","fldslXpxwlEBxousb","fldVWP6MVqrBXqa6J"],"referencedFieldNames":["Scenario Type","Test Status","Test Notes","Operator Feedback","Scenario Requirements"]}`
- **Last Run At**
  - id: `fld498KtmqKzJEOog`
  - type: `dateTime`
  - role: `standard`
  - primary: `False`
  - options summary: `{"dateFormat":{"name":"us","format":"M/D/YYYY"},"timeFormat":{"name":"12hour","format":"h:mma"},"timeZone":"utc"}`
- **Dry Run?**
  - id: `fldSSRZKRBMv9UfuA`
  - type: `checkbox`
  - role: `standard`
  - primary: `False`
  - options summary: `{"icon":"thumbsUp","color":"greenBright"}`
- **Linked Submission**
  - id: `fld4DCoxCVBqmBzfh`
  - type: `multipleRecordLinks`
  - role: `link`
  - primary: `False`
  - options summary: `{"linkedTableId":"tblEVjVpGGlPTsYSt","linkedTableName":"Submissions","inverseLinkFieldId":"fldN544H8tEypxGsi","inverseLinkFieldName":"Testing Scenarios","prefersSingleRecordLink":true,"isReversed":false}`
- **Shot Total**
  - id: `fldoNhJ33NofMhK92`
  - type: `number`
  - role: `standard`
  - primary: `False`
  - options summary: `{"precision":0}`
- **Video Feedback Focus**
  - id: `fldBf302WTOx7pTep`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - options summary: `{"choices":["Shooting","Layups / Finishing","Ball Handling","Free Throws","Footwork / Defense","Strength / Movement","General Basketball","Other"],"choicesDetailed":[{"id":"selfXZaZyCHF7Nqgg","name":"Shooting","color":"blueLight2"},{"id":"sel90puXVEsxSxBYn","name":"Layups / Finishing","color":"cyanLight2"},{"id":"sel5L6BUtBUZVurby","name":"Ball Handling","color":"tealLight2"},{"id":"selkROPWOD9OT2Aiv","name":"Free Throws","color":"greenLight2"},{"id":"selIVjrNLQwtwxpQ8","name":"Footwork / Defense","color":"yellowLight2"},{"id":"selbzu7prfXlPXjIG","name":"Strength / Movement","color":"orangeLight2"},{"id":"sele5AjYILsQUHwEu","name":"General Basketball","color":"redLight2"},{"id":"selI4ocGBSnJ5rntX","name":"Other","color":"pinkLight2"}]}`
- **Video Feedback Question**
  - id: `fldnSrB9TrpbVsD42`
  - type: `multilineText`
  - role: `identifier`
  - primary: `False`
- **Video Upload**
  - id: `fldyKFFykzNzjv3DU`
  - type: `multipleAttachments`
  - role: `standard`
  - primary: `False`
- **Homework Assignment**
  - id: `fldKmXmdPtpFxP9Vm`
  - type: `multipleRecordLinks`
  - role: `link`
  - primary: `False`
  - options summary: `{"linkedTableId":"tblUuxwYlX4EQ9MKE","linkedTableName":"FBC Curriculum - SYNC","inverseLinkFieldId":"fld5Qz1U6X1aO6urv","inverseLinkFieldName":"Testing Scenarios","prefersSingleRecordLink":true,"isReversed":false}`
- **Last Error**
  - id: `fldl8UYzlLMrpd5pP`
  - type: `multilineText`
  - role: `standard`
  - primary: `False`
...
- id: `tblOTtJ8tRW2YKsbc`
- primary field: **Name** (`fldwfVbHDyMZpcvei`)
- role guess: `standard`
- fields: `11`
- link fields: `0`
- computed fields: `0`
...
- **Name**
  - id: `fldwfVbHDyMZpcvei`
  - type: `singleLineText`
  - role: `standard`
  - primary: `True`
- **School Level**
  - id: `fldtTWRVl83lSmEwf`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - options summary: `{"choices":["Elementary","Junior High","Middle School","High School","HS","JH/MS"],"choicesDetailed":[{"id":"sel7Qt6MRGHQNDqqD","name":"Elementary","color":"blueLight2"},{"id":"seloYt1BeEHGUPK2l","name":"Junior High","color":"yellowLight2"},{"id":"seli1nEEfbSZhDh1j","name":"Middle School","color":"tealLight2"},{"id":"selJF3ab3AjxW96c9","name":"High School","color":"redLight1"},{"id":"selrBhgqBpSrQo8l3","name":"HS","color":"blueLight2"},{"id":"selL8quBGpPakgHhJ","name":"JH/MS","color":"cyanLight2"}]}`
- **Classification**
  - id: `fld3MI9QbI1YNRgFK`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - options summary: `{"choices":["AA","A","B","C","D","3A","2A","4A","1A","5A","6A"],"choicesDetailed":[{"id":"sellndtDGwIHwIJfG","name":"AA","color":"redDark1"},{"id":"sel5U8uGjxUiv18GU","name":"A","color":"blueBright"},{"id":"sel72nPTjI0yipaGA","name":"B","color":"greenBright"},{"id":"selnzx2L2JLlIxigU","name":"C","color":"yellowBright"},{"id":"selOPXLJ1sFrG9N5j","name":"D","color":"blueLight2"},{"id":"selfR1NFXvNkHzvx2","name":"3A","color":"blueLight2"},{"id":"selYuf71pNlTYEJfr","name":"2A","color":"cyanLight2"},{"id":"selQ8lXwvI4olf10R","name":"4A","color":"tealLight2"},{"id":"selAPCvGKXdcqqqAR","name":"1A","color":"greenLight2"},{"id":"seli9zdfytMPNZSKy","name":"5A","color":"yellowLight2"},{"id":"sellApWDOP84yKoD2","name":"6A","color":"orangeLight2"}]}`
- **Division**
  - id: `fldb7ErHvVc2kwJdM`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - options summary: `{"choices":["Eastern AA","Western AA","Northeastern A","Northwestern A","Southeastern A","Southwestern A","Northern B","Southern B","Western B","Northern C","Eastern C","Southern C","Western C","Eastern A","Western A","I","II","III","IV","V","VI","NW District","NE District","SW District","SE District"],"choicesDetailed":[{"id":"selyxVtHL4MJEPO9z","name":"Eastern AA","color":"blueLight2"},{"id":"selL1ou13qTvFCWui","name":"Western AA","color":"cyanLight2"},{"id":"sel4YoPC6Pjzu7Q4B","name":"Northeastern A","color":"greenLight1"},{"id":"selEQYEzPZhEQ2fWy","name":"Northwestern A","color":"redBright"},{"id":"selWxfBIF8lhXFU7l","name":"Southeastern A","color":"grayLight1"},{"id":"selccgKgn4MySCr8e","name":"Southwestern A","color":"tealLight1"},{"id":"selfy978vr3ZzbWEH","name":"Northern B","color":"orangeLight2"},{"id":"selQv3wFCkQgC8vrv","name":"Southern B","color":"redLight2"},{"id":"selvO7TywyTz9r5Qn","name":"Western B","color":"pinkLight2"},{"id":"selFKt4nteAIrSYSR","name":"Northern C","color":"purpleLight2"},{"id":"selh7sD7Pw6AN7qmV","name":"Eastern C","color":"blueLight1"},{"id":"selmk4bFPZc2g9SvY","name":"Southern C","color":"cyanLight1"},{"id":"selAvObEkZrl4vIsm","name":"Western C","color":"grayLight2"},{"id":"selqiUZcvuCYr14hv","name":"Eastern A","color":"tealLight2"},{"id":"sel1kzAXKPxw9qQ0v","name":"Western A","color":"greenLight2"},{"id":"selkZoM6LMvYfOwyO","name":"I","color":"yellowLight2"},{"id":"selhxmvl6SzldiTuB","name":"II","color":"orangeLight2"},{"id":"selcdFKbOkXH32oTE","name":"III","color":"tealLight2"},{"id":"selUrahuixfYwFjfr","name":"IV","color":"greenLight2"},{"id":"selhTJnnhiT12bXKO","name":"V","color":"blueLight2"},{"id":"seleIEzsFR7QwGd2I","name":"VI","color":"cyanLight2"},{"id":"selg3V0r1h74O3Oq9","name":"NW District","color":"blueLight2"},{"id":"selgdiTYW3NHU0QtU","name":"NE District","color":"cyanLight2"},{"id":"selORDub9EtiizeTW","name":"SW District","color":"tealLight2"},{"id":"sellArEVn22D9pgDU","name":"SE District","color":"greenLight2"}]}`
- **District**
  - id: `fldM9f4hMVrVlmont`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - options summary: `{"choices":["6-C","13-C","6-B","10-C","2-C","3-B","Southwest A","8-C","9-C","Northwest A","Southeast A","5-C","5-B","4-C","1-B","3-C","4-B","Northeast A","2-B","12-C","7-B","14-C"],"choicesDetailed":[{"id":"selI1hnlMmlR9gnhC","name":"6-C","color":"blueLight2"},{"id":"selOskwDZj4lAt2Ak","name":"13-C","color":"cyanLight2"},{"id":"selVZ7CH07nYYw5fq","name":"6-B","color":"tealLight2"},{"id":"selIKTEBYfWcpaj9m","name":"10-C","color":"greenLight2"},{"id":"selxJvw48FD0vSlDg","name":"2-C","color":"yellowLight2"},{"id":"selVQJtrCG1KyrPrx","name":"3-B","color":"orangeLight2"},{"id":"selxFdPd48cEYrOcd","name":"Southwest A","color":"redLight2"},{"id":"selNHSUhR39AoDxUM","name":"8-C","color":"pinkLight2"},{"id":"seld5Vm7MCHume6DV","name":"9-C","color":"purpleLight2"},{"id":"selS94atfhGkMOI55","name":"Northwest A","color":"grayLight2"},{"id":"sel1q5MIH7tJ8vITj","name":"Southeast A","color":"blueLight1"},{"id":"sel7CbuRG31oVjO6e","name":"5-C","color":"cyanLight1"},{"id":"selfMM8y5Czyxpkf1","name":"5-B","color":"tealLight1"},{"id":"selPLl19UiEbTIE66","name":"4-C","color":"greenLight1"},{"id":"selsw6yZu8x4Bpc9U","name":"1-B","color":"yellowLight1"},{"id":"selvwuH0dvQz6USwI","name":"3-C","color":"orangeLight1"},{"id":"selwf3E0EEq8hTvss","name":"4-B","color":"redLight1"},{"id":"sell1c8aDDJakHDn7","name":"Northeast A","color":"pinkLight1"},{"id":"selXtx7vlmYx2aoDj","name":"2-B","color":"purpleLight1"},{"id":"selghBaEc2b1cGTbg","name":"12-C","color":"grayLight1"},{"id":"seluXJqTVGonI39Ez","name":"7-B","color":"blueBright"},{"id":"selJ5wZojnCMZ9RkO","name":"14-C","color":"cyanBright"}]}`
- **State**
  - id: `fld6t876fZv129sVD`
  - type: `singleSelect`
  - role: `status`
  - primary: `False`
  - options summary: `{"choices":["ID","MT","ND","OR","SD","WA","WY"],"choicesDetailed":[{"id":"selMZ2jHxjMXcZxHX","name":"ID","color":"cyanLight2"},{"id":"selsNWZp1Xnh4KIzI","name":"MT","color":"blueLight2"},{"id":"selaAvqV49Uma70mo","name":"ND","color":"orangeLight2"},{"id":"selwAYdRouOJTMNJM","name":"OR","color":"greenLight2"},{"id":"sel7x677mQw5BoL0t","name":"SD","color":"redLight2"},{"id":"selBGkQoi4sjCozIu","name":"WA","color":"tealLight2"},{"id":"selR3ZQ8soUNyPZ88","name":"WY","color":"yellowLight2"}]}`
- **Colors**
  - id: `fldb17fOhEAqi3L2P`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - options summary: `{"choices":["Black/Gold","Black/Green/Gold","Black/Orange","Black/Orange/White","Black/Silver/Orange","Black/Turquoise/White","Black/White/Gold","Black/Yellow","Blue/Black","Blue/Black/Silver","Blue/Gold","Blue/Gold/Black","Blue/Gold/White","Blue/Green","Blue/Green/White","Blue/Silver","Blue/White","Blue/White/Black","Blue/White/Red","Brown/Gold","Cardinal Red/Black","Cardinal Red/White","Cardinal/Silver/White","Cardinal/White","Columbia Blue/White","Forest Green/Vegas Gold","Gold/Black","Green/Blue","Green/Gold","Green/White","Green/White/Black","Green/Yellow","Hunter Green/White","Kelly Green/Black/White","Kelly Green/Gold","Kelly Green/Gold/White","Kelly Green/White","Kelly Green/White/Black","Maroon/Black","Maroon/Gold","Maroon/Gold/White","Maroon/White","Maroon/White/Black","Maroon/White/Gold","Maroon/White/Silver","Metallic Blue/Red/White","Navy Blue/Gold","Navy Blue/Kelly Green","Orange/Black","Orange/Black/White","Orange/Turquoise","Purple/Gold","Purple/Gold/White","Purple/White","Purple/White/Black","Purple/White/Gold","Purple/White/Gray","Red/Black","Red/Black/White","Red/Gold/White","Red/Orange","Red/White","Red/White/Black","Red/White/Blue","Red/White/Navy Blue","Royal Blue/Black","Royal Blue/Black/Gold","Royal Blue/Gold","Royal Blue/Red/White","Royal Blue/Scarlett","Royal Blue/Silver","Royal Blue/Vegas Gold","Royal Blue/White","Royal/Scarlet/White","Scarlet Red/White","Scarlet/Gold","Scarlet/White","Silver/Navy Blue","ID"],"choicesDetailed":[{"id":"selzderI6rSvztKBM","name":"Black/Gold","color":"grayDark1"},{"id":"selKzdx2atDbtp1No","name":"Black/Green/Gold","color":"pinkLight1"},{"id":"selMKDOusM9xALjJp","name":"Black/Orange","color":"pinkLight1"},{"id":"selscKCdfzSZoRdZL","name":"Black/Orange/White","color":"purpleLight1"},{"id":"selh0tHi6d30oof2v","name":"Black/Silver/Orange","color":"grayLight1"},{"id":"seluxVwDKqQIVv0D7","name":"Black/Turquoise/White","color":"blueLight2"},{"id":"sels3a1SUCmLtL3lU","name":"Black/White/Gold","color":"orangeLight2"},{"id":"selrhrz0K0p8qRB54","name":"Black/Yellow","color":"yellowDark1"},{"id":"selGlRhYKQR1IIcGp","name":"Blue/Black","color":"greenLight2"},{"id":"selTYqU5EUBJEACXz","name":"Blue/Black/Silver","color":"yellowBright"},{"id":"seliblbeUc09rF5Bm","name":"Blue/Gold","color":"greenLight1"},{"id":"selZVElgV2jHvpHXA","name":"Blue/Gold/Black","color":"pinkLight2"},{"id":"selhtXToDPvYcBxk2","name":"Blue/Gold/White","color":"blueDark1"},{"id":"selKTAuSIVfP1y52S","name":"Blue/Green","color":"purpleDark1"},{"id":"selfklroQI5oiReTz","name":"Blue/Green/White","color":"redDark1"},{"id":"sellcwBCOjuVAY1fY","name":"Blue/Silver","color":"tealLight2"},{"id":"sel3DlY411oeofYVO","name":"Blue/White","color":"yellowLight1"},{"id":"selvSSNCNvItCy2bL","name":"Blue/White/Black","color":"greenBright"},{"id":"selBDHv5MdWhP9GH5","name":"Blue/White/Red","color":"purpleBright"},{"id":"seleJzNHBuWGCsLDA","name":"Brown/Gold","color":"orangeBright"},{"id":"selFJMdue8Yz6BHrX","name":"Cardinal Red/Black","color":"purpleLight2"},{"id":"sel6WGz416nN58Exn","name":"Cardinal Red/White","color":"grayLight2"},{"id":"selH7RmPqtibe1u46","name":"Cardinal/Silver/White","color":"pinkDark1"},{"id":"selwnw0loog0nKvr0","name":"Cardinal/White","color":"grayBright"},{"id":"selgRbn3Izm9B7DXe","name":"Columbia Blue/White","color":"yellowLight1"},{"id":"selNO7NpjBGQf0V3p","name":"Forest Green/Vegas Gold","color":"blueLight1"},{"id":"selbCPTvC1HTEXgum","name":"Gold/Black","color":"blueBright"},{"id":"selzwg1X5pRdiErUP","name":"Green/Blue","color":"cyanLight1"},{"id":"selVQL84kHPaycN1k","name":"Green/Gold","color":"cyanDark1"},{"id":"selBrPMi9CNB1qeaS","name":"Green/White","color":"tealLight1"},{"id":"selEhcHLSMBAUPM2q","name":"Green/White/Black","color":"redLight1"},{"id":"selP6AxePdOZBiVl5","name":"Green/Yellow","color":"redBright"},{"id":"selueRGe8dLpGFVEw","name":"Hunter Green/White","color":"grayLight1"},{"id":"selucZr7fgD1cWbWt","name":"Kelly Green/Black/White","color":"purpleLight2"},{"id":"selCyLsJSq03NvKVW","name":"Kelly Green/Gold","color":"orangeLight1"},{"id":"selSkkwI0t1aMBBBW","name":"Kelly Green/Gold/White","color":"orangeDark1"},{"id":"sel5MuJhH2h397nzs","name":"Kelly Green/White","color":"greenDark1"},{"id":"selftK9zsAPIYJP1k","name":"Kelly Green/White/Black","color":"redLight2"},{"id":"sel7EqnwI3zEhouP3","name":"Maroon/Black","color":"tealBright"},{"id":"sel3WSBLCsuNQ01yF","name":"Maroon/Gold","color":"redLight1"},{"id":"selInlEhUa7IbLUUy","name":"Maroon/Gold/White","color":"grayLight2"},{"id":"selybQOpbtDWQKFRi","name":"Maroon/White","color":"pinkLight2"},{"id":"sel2AvCyhT0OAYq2P","name":"Maroon/White/Black","color":"greenBright"},{"id":"sel2z434AMW4su01b","name":"Maroon/White/Gold","color":"orangeLight1"},{"id":"selT9aNV2H0wSN6wM","name":"Maroon/White/Silver","color":"cyanBright"},{"id":"selEpNlo9OBCDHgpp","name":"Metallic Blue/Red/White","color":"grayBright"},{"id":"sel8QGRqhzmUut3hM","name":"Navy Blue/Gold","color":"yellowDark1"},{"id":"selbTh8IDXw4Pz8hK","name":"Navy Blue/Kelly Green","color":"cyanBright"},{"id":"selF7kO6yAaK4i6Kv","name":"Orange/Black","color":"pinkBright"},{"id":"selqCbVkQRoExvhoE","name":"Orange/Black/White","color":"yellowLight2"},{"id":"selUOoLl8jgM2ceCl","name":"Orange/Turquoise","color":"blueDark1"},{"id":"selWv7H1YwPyCrrnz","name":"Purple/Gold","color":"purpleLight1"},{"id":"selaIC6KkkQ74gQMs","name":"Purple/Gold/White","color":"redDark1"},{"id":"selTT0sk6JeAA7wiY","name":"Purple/White","color":"blueLight1"},{"id":"selS4NQznTEDbtfGt","name":"Purple/White/Black","color":"tealBright"},{"id":"seltZCYbPLl2dQBgH","name":"Purple/White/Gold","color":"yellowBright"},{"id":"selbUexlvpbYiDQLk","name":"Purple/White/Gray","color":"greenLight2"},{"id":"selBTnby5t7seqBpB","name":"Red/Black","color":"blueLight2"},{"id":"sel0XQfgFyl5el6wz","name":"Red/Black/White","color":"redLight2"},{"id":"sel2oNqHOeDv71nbr","name":"Red/Gold/White","color":"orangeDark1"},{"id":"sel8DRrmjVeUVlGMU","name":"Red/Orange","color":"tealLight1"},{"id":"selKxtl33nKuGGbOd","name":"Red/White","color":"redBright"},{"id":"sel7p4E1s1ZcRQaYo","name":"Red/White/Black","color":"yellowLight2"},{"id":"sel6fMoCuCJSYFc4Y","name":"Red/White/Blue","color":"pinkBright"},{"id":"seld1mJ2ezcBKYvnA","name":"Red/White/Navy Blue","color":"greenLight1"},{"id":"selz4yu4boesa3TDj","name":"Royal Blue/Black","color":"pinkDark1"},{"id":"sel4AjDnlu3mdKyxQ","name":"Royal Blue/Black/Gold","color":"greenDark1"},{"id":"sel0q0McDQR9IDV5T","name":"Royal Blue/Gold","color":"cyanLight2"},{"id":"selzlv1kjqsNs0Mwy","name":"Royal Blue/Red/White","color":"tealDark1"},{"id":"selJcSgHL6ZhUZL2Q","name":"Royal Blue/Scarlett","color":"cyanLight2"},{"id":"selRURNYfCXRHwFUM","name":"Royal Blue/Silver","color":"orangeLight2"},{"id":"selO0nCJyt2NeFO47","name":"Royal Blue/Vegas Gold","color":"cyanDark1"},{"id":"selR6yGacMwm6swD5","name":"Royal Blue/White","color":"cyanLight1"},{"id":"selqrmQ8zOAzoO8tS","name":"Royal/Scarlet/White","color":"orangeBright"},{"id":"selCP77D0da8QJQg7","name":"Scarlet Red/White","color":"blueBright"},{"id":"selL6xlYyZAW29SnZ","name":"Scarlet/Gold","color":"purpleBright"},{"id":"selwAoKoxacaSbAmL","name":"Scarlet/White","color":"tealLight2"},{"id":"sel9EyYN8SEgJiy1C","name":"Silver/Navy Blue","color":"tealDark1"},{"id":"sel4y4goIC7reLryb","name":"ID","color":"blueLight2"}]}`
- **Song**
  - id: `fldyn0nYbdDKES1q8`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - options summary: `{"choices":["Air Force","Air Force Fight Song","All Hail Central","Anchors Away","Anchors Aweigh","BCCHS School Song","Big Sky Scream","Bison Fight","Blue and White","Bozeman High Fight Song","Bridger Loyalty","College Boy","Colstrip Loyalty Song","Columbia","Far Above Cayugas Water","Frenchtown Broncs","Gillette Look Sharp","Go Big Horns","Go Glacier","Go Northwestern","Go Northwestern Go","Go U Northwestern","Go Ye Northwestern","Hail (to the Victors)","Hail Dawson High","Hail Team","Hail to the Varsity","Hail to the Victors","Hail West Virginia","Hamilton Fight Song","Here's to Powell Co. HS","Honor Song","Illinois Fight Song","Illinois Loyalty","Irish Backs Go Marching","Legionnaires on Parade","Let's Talk About Jesus","Magnificent Seven","Minnesota Rouser","Minnesota Rouser ","My Bonnie Lassie","New Colonial March","Nortre Dame Victory","Notre Dame Fight Song","Notre Dame Victory","Notre Dame Victory Marc","Notre Dame Victory Song","On for Winifred","On Loyola","ON Wisconsin","On Wisconsin","Our Director","Park High Fight Song","Plains Fight Song","Rebel Fight Song","Round & Round","Saints go Marching in","St Regis School Song","Stand Up and Cheer","Stand Up Superior","Stars & Stripes Forever","Stein Song","The Cardinal","Fight Song","The Victors","The Victory","Up With Montana","Victors","WA State Fight Song","Washington & Lee","Washington & Lee Swing","Washington Lee","Washington & Lee Swing","Wave the Flag"],"choicesDetailed":[{"id":"seleN4Wsk3Jev6uw6","name":"Air Force","color":"cyanLight1"},{"id":"selrYj2O1Wc6UKd95","name":"Air Force Fight Song","color":"greenDark1"},{"id":"sel4OJgemxWx8YZd9","name":"All Hail Central","color":"redLight1"},{"id":"selvVzlhXdqRCCDoo","name":"Anchors Away","color":"cyanDark1"},{"id":"seleIZJVKMnIrl0rJ","name":"Anchors Aweigh","color":"purpleLight1"},{"id":"selro6KMGhFDP3z0X","name":"BCCHS School Song","color":"grayLight2"},{"id":"selgHO87Oh6YmhUG5","name":"Big Sky Scream","color":"redLight1"},{"id":"sel7Ca8zzOQ2X7QSU","name":"Bison Fight","color":"purpleDark1"},{"id":"selZeRf4SJywxzq8D","name":"Blue and White","color":"yellowLight1"},{"id":"seltvJugCDBEzfT1k","name":"Bozeman High Fight Song","color":"greenLight1"},{"id":"selkiB5avjcWMaQ35","name":"Bridger Loyalty","color":"yellowLight1"},{"id":"sels20tBcCJE2NLiw","name":"College Boy","color":"orangeLight1"},{"id":"selTuZGqtVdpo1I49","name":"Colstrip Loyalty Song","color":"blueBright"},{"id":"sel7ytik3bWC5qnqn","name":"Columbia","color":"purpleBright"},{"id":"selCPykic338DvUlz","name":"Far Above Cayugas Water","color":"grayLight1"},{"id":"sel0c28FPqf19LV3x","name":"Frenchtown Broncs","color":"tealDark1"},{"id":"selgz3gvhhFnHjwoi","name":"Gillette Look Sharp","color":"tealLight1"},{"id":"selJC3MXn8SODsfKI","name":"Go Big Horns","color":"tealLight1"},{"id":"seluRb71c7eq1uuvq","name":"Go Glacier","color":"yellowDark1"},{"id":"seli3lL1M1OteQC5Y","name":"Go Northwestern","color":"cyanDark1"},{"id":"selal7G7kAOQ7HVBW","name":"Go Northwestern Go","color":"pinkBright"},{"id":"seloZpF1BgTDoIYRb","name":"Go U Northwestern","color":"grayLight1"},{"id":"selbqljjb2ksXIe6o","name":"Go Ye Northwestern","color":"cyanBright"},{"id":"selcKm62heJ9mfJva","name":"Hail (to the Victors)","color":"blueLight1"},{"id":"selx7dsbSrgRwAAnb","name":"Hail Dawson High","color":"orangeBright"},{"id":"selxYFgfanQcDnRoR","name":"Hail Team","color":"grayLight2"},{"id":"selhmcnSwf1k0QA87","name":"Hail to the Varsity","color":"blueLight2"},{"id":"selt5fsuoaCfOGQuJ","name":"Hail to the Victors","color":"orangeBright"},{"id":"selL0x75M03Cc785F","name":"Hail West Virginia","color":"cyanLight2"},{"id":"selzZlWaWyj6UekHd","name":"Hamilton Fight Song","color":"grayDark1"},{"id":"sel5LJnTksRrwtpkZ","name":"Here's to Powell Co. HS","color":"yellowBright"},{"id":"sel0Jw60PKzLyUClV","name":"Honor Song","color":"tealDark1"},{"id":"selLRd8w4D3QUjTrZ","name":"Illinois Fight Song","color":"orangeDark1"},{"id":"selNjYezWGfWEV9Nb","name":"Illinois Loyalty","color":"cyanLight2"},{"id":"selt5PeJQdDpa9MKa","name":"Irish Backs Go Marching","color":"blueBright"},{"id":"sel6O3I97dcTB4Zdm","name":"Legionnaires on Parade","color":"yellowLight2"},{"id":"selWMacoFQDAXoBvn","name":"Let's Talk About Jesus","color":"yellowDark1"},{"id":"selUAv6jjbEBBP2gS","name":"Magnificent Seven","color":"pinkDark1"},{"id":"sel2IcpuP7FM8aLmm","name":"Minnesota Rouser","color":"purpleLight2"},{"id":"sel1JST4gePjO6Ya0","name":"Minnesota Rouser ","color":"redLight2"},{"id":"sel9TYysEsa85P6oO","name":"My Bonnie Lassie","color":"orangeDark1"},{"id":"selHsNQTMg7AMRt2y","name":"New Colonial March","color":"greenDark1"},{"id":"sel4SgCLAGSGgytU5","name":"Nortre Dame Victory","color":"purpleLight2"},{"id":"selCbRg4RjSKRDnB5","name":"Notre Dame Fight Song","color":"blueLight1"},{"id":"sel0SpwsNHobI3yfQ","name":"Notre Dame Victory","color":"greenLight2"},{"id":"selMFwoLwYnWzZHsN","name":"Notre Dame Victory Marc","color":"orangeLight1"},{"id":"selcNihIMYO04DRQE","name":"Notre Dame Victory Song","color":"purpleBright"},{"id":"selnPt5sqNzuHfUyT","name":"On for Winifred","color":"redDark1"},{"id":"selNanTcBKX4Q40NL","name":"On Loyola","color":"greenLight1"},{"id":"selftaRNexyBl52if","name":"ON Wisconsin","color":"yellowBright"},{"id":"seludq8mbgOuCspfj","name":"On Wisconsin","color":"blueLight2"},{"id":"selO63Fdt1yjvZoyf","name":"Our Director","color":"pinkLight2"},{"id":"selNGZI2veMXUUJPW","name":"Park High Fight Song","color":"cyanBright"},{"id":"selKH4MnZf5RZc4VJ","name":"Plains Fight Song","color":"tealBright"},{"id":"selXVwOqrjrA1KBrN","name":"Rebel Fight Song","color":"pinkBright"},{"id":"selycpq58POkvbYAY","name":"Round & Round","color":"tealLight2"},{"id":"selzSeEGUWS5TB6hP","name":"Saints go Marching in","color":"orangeLight2"},{"id":"sel6YOoJugjlNB4Wd","name":"St Regis School Song","color":"redBright"},{"id":"selVsGW5UWIH75dR9","name":"Stand Up and Cheer","color":"tealLight2"},{"id":"selyI5TFiuMGfgS8j","name":"Stand Up Superior","color":"grayBright"},{"id":"selpcZO0FHAr45Esd","name":"Stars & Stripes Forever","color":"redBright"},{"id":"selJV41isRSONqXOx","name":"Stein Song","color":"orangeLight2"},{"id":"seldAHlQoFKKOEfTc","name":"The Cardinal","color":"purpleLight1"},{"id":"selTwbRoTVWkYVV6C","name":"Fight Song","color":"pinkLight1"},{"id":"sel1vqNSOJAf2lawi","name":"The Victors","color":"pinkLight2"},{"id":"selBZrwibAMUeRkVH","name":"The Victory","color":"cyanLight1"},{"id":"selzzBJdhvql3YbSs","name":"Up With Montana","color":"redLight2"},{"id":"sellKew5TgY2MP3KP","name":"Victors","color":"blueDark1"},{"id":"selH0OzgWAqJCvsLT","name":"WA State Fight Song","color":"greenBright"},{"id":"selz9hUyDszHYbjiK","name":"Washington & Lee","color":"grayBright"},{"id":"selj824dyzifUiGrr","name":"Washington & Lee Swing","color":"tealBright"},{"id":"seluAKl3lltZvELiq","name":"Washington Lee","color":"greenLight2"},{"id":"selFiuT6C3yvjBAfZ","name":"Washington & Lee Swing","color":"redDark1"},{"id":"selj3KnWSe1jEH3xL","name":"Wave the Flag","color":"greenBright"}]}`
- **Nickname**
  - id: `fldllkRPZEKpkuIVk`
  - type: `singleSelect`
  - role: `standard`
  - primary: `False`
  - options summary: `{"choices":["Badgers","Bats","Bearcubs","Bears","Beavers","Bengals","Big Horns","Bison","Blackhawks","Blue Demons","Blue Devils","Blue Hawks","Blue Ponies","Bobcats","Braves/Bravettes","Braves/Lady Braves","Broncs","Bruins","Bulldogs","Chiefs","Colts/Fillies","Copperheads","Cougars","Cowboys/Cowgirls","Coyotes","DiamondBacks","Dogies","Eagles","Elk","Engineers","Falcons","Fusion","Golden Bears","Golden Eagles","Hawks","Hornets","Horsemen/Trotters","Huskies","Indians","J-Hawks","Knights","Lions","Locomotives","Loggers","Longhorns","Lynx","Maroons","Miners","Morning Stars","Mountaineers","Mustangs","Mustangs/M-ettes","Outlaws","Panthers","Penguins","Pioneers","Pirates","Porcupines","Prospectors","Raiders","Rams","Rams/Breakers","Rangers","Rebels","Red Devils","Red Hawks","Redhawks","Refiners","Renegades","Rockets","Royal Lions","Rustlers","Savage Heat","Scotties","Scouts","Sheepherders","Spartans","Stars","Sugarbeeters","Terriers","Thunder","Thunderbirds","Tigers","Tornadoes","Trojans","Vikings","Vikings/Valkyries","Wardens","Warriors","Warriors/Scarlets","Wildcats","Wolfpack","Wolverines","Wolves","Wranglers","Yellowjackets","Raptors","Vigilantes","Cubs","Buccaneers","Unicorns","Dinomites"],"choicesDetailed":[{"id":"sel4AqZJN8FkHZLZK","name":"Badgers","color":"tealBright"},{"id":"self1VjWeQMVuYIwU","name":"Bats","color":"purpleLight2"},{"id":"selLe7aAOLZqZO6iM","name":"Bearcubs","color":"yellowLight2"},{"id":"selSyYzNJhiZZgGZ9","name":"Bears","color":"orangeLight1"},{"id":"seltuIXcyH0YhcYEJ","name":"Beavers","color":"pinkLight2"},{"id":"selLxGhgprgDPn3XB","name":"Bengals","color":"pinkLight1"},{"id":"seltvW8fp1gHskmhq","name":"Big Horns","color":"grayBright"},{"id":"selstFAnDJ4sQYeK9","name":"Bison","color":"tealLight1"},{"id":"selxVvr1q8kEhQbHA","name":"Blackhawks","color":"redLight2"},{"id":"selSUuwtjFeT1U87h","name":"Blue Demons","color":"yellowLight2"},{"id":"selRfW3ZiuE1PVNBX","name":"Blue Devils","color":"blueDark1"},{"id":"selatHJ1pZv1EJi84","name":"Blue Hawks","color":"tealLight1"},{"id":"selEdIa6roYmwjJwR","name":"Blue Ponies","color":"orangeLight1"},{"id":"selEgx54crrDuFJWL","name":"Bobcats","color":"grayLight2"},{"id":"seljeJgJz6r3a2mWl","name":"Braves/Bravettes","color":"cyanLight2"},{"id":"selftLqYS9g3RmtXB","name":"Braves/Lady Braves","color":"orangeLight2"},{"id":"selPbpv1IYPqEDSTy","name":"Broncs","color":"tealLight1"},{"id":"selc3KIhMSDgXzWQn","name":"Bruins","color":"redLight2"},{"id":"seljs82WSW8rxSw2Q","name":"Bulldogs","color":"yellowDark1"},{"id":"selOaGeZYoDZnHW31","name":"Chiefs","color":"tealLight2"},{"id":"selam1qusgxRZ9Gap","name":"Colts/Fillies","color":"pinkBright"},{"id":"selcgR90bISSnbiac","name":"Copperheads","color":"tealLight2"},{"id":"seliEl4ksYuGbysKC","name":"Cougars","color":"purpleBright"},{"id":"sel9wwTQdmGo95M8y","name":"Cowboys/Cowgirls","color":"grayBright"},{"id":"selhgy0MshPKMZdaa","name":"Coyotes","color":"redDark1"},{"id":"selHWr5NNytveU49B","name":"DiamondBacks","color":"pinkDark1"},{"id":"selDJRbSO7EDmzhTh","name":"Dogies","color":"tealLight2"},{"id":"sel9uOvG6uktCi0IP","name":"Eagles","color":"grayDark1"},{"id":"selPiul3RHSYMhSb6","name":"Elk","color":"yellowLight2"},{"id":"seleUfPCkxmPWh9bA","name":"Engineers","color":"yellowLight1"},{"id":"selC96yrCFTjaM6Lw","name":"Falcons","color":"greenLight1"},{"id":"selDjNLJr1LWxRApW","name":"Fusion","color":"greenBright"},{"id":"selAnbl8h5wT0fcsV","name":"Golden Bears","color":"yellowLight1"},{"id":"selTMOxR8t3pRqqtf","name":"Golden Eagles","color":"blueLight2"},{"id":"sellnRbstcADxMWz1","name":"Hawks","color":"redLight1"},{"id":"selYVSEArOO1jYM0B","name":"Hornets","color":"pinkLight1"},{"id":"selGbgHsyBPR15Wld","name":"Horsemen/Trotters","color":"redDark1"},{"id":"selfyOd0vjrB4TuxQ","name":"Huskies","color":"blueLight2"},{"id":"selHSHFNoskrQjJ7l","name":"Indians","color":"blueBright"},{"id":"sel2AMBbd4xYUQ2Gc","name":"J-Hawks","color":"tealBright"},{"id":"selpQIvVVgYoMYHhU","name":"Knights","color":"greenDark1"},{"id":"selQmjujTpBWMjY40","name":"Lions","color":"pinkBright"},{"id":"selvpxEGdHqPg8LGI","name":"Locomotives","color":"orangeBright"},{"id":"sel2huqm9t7OkIPyZ","name":"Loggers","color":"redBright"},{"id":"selGoZaqDh0j9Rfyu","name":"Longhorns","color":"greenLight2"},{"id":"selp0Qf5ZYKhoChS2","name":"Lynx","color":"purpleBright"},{"id":"selqTg8k6FgK6OQVU","name":"Maroons","color":"cyanBright"},{"id":"selZLal7KMi04uVVz","name":"Miners","color":"greenBright"},{"id":"selYXm8acsHFZwBJL","name":"Morning Stars","color":"yellowBright"},{"id":"selfI1jaa8fdnMXuR","name":"Mountaineers","color":"purpleLight1"},{"id":"selfCGnPBJ6oqadgJ","name":"Mustangs","color":"purpleDark1"},{"id":"selTt4O85j8niHeK1","name":"Mustangs/M-ettes","color":"cyanDark1"},{"id":"selyZIyXTtHf4L7ql","name":"Outlaws","color":"grayLight1"},{"id":"sel2o6ZYaNNx7X76r","name":"Panthers","color":"cyanLight2"},{"id":"selImEOOatYquLUqn","name":"Penguins","color":"purpleLight1"},{"id":"selZPOvD6wHiDojBW","name":"Pioneers","color":"grayLight2"},{"id":"selKmOB4mcYQjicRV","name":"Pirates","color":"purpleLight1"},{"id":"sel7oIeBKKT5KUQz4","name":"Porcupines","color":"orangeDark1"},{"id":"selo9Myf07if6dgPo","name":"Prospectors","color":"blueLight1"},{"id":"selN1s3i36JJNrB8N","name":"Raiders","color":"grayLight1"},{"id":"selcQjh5n4AFIdZDO","name":"Rams","color":"cyanLight1"},{"id":"selm6kryyfpxCSAH0","name":"Rams/Breakers","color":"blueDark1"},{"id":"selh1RWD8WWXR29n4","name":"Rangers","color":"cyanLight1"},{"id":"selnKjZ4PMcdPy7Rt","name":"Rebels","color":"cyanDark1"},{"id":"selKmJun40HKkXPTU","name":"Red Devils","color":"yellowDark1"},{"id":"selJjsmustLgwrgT5","name":"Red Hawks","color":"orangeLight2"},{"id":"selTytVJiYibmSPm4","name":"Redhawks","color":"tealDark1"},{"id":"selIk144XGmInfV65","name":"Refiners","color":"purpleLight2"},{"id":"selPYGMRHT9Ul0vPW","name":"Renegades","color":"purpleDark1"},{"id":"selcsXSrBlw6tFxJC","name":"Rockets","color":"blueLight2"},{"id":"sel3VDwCODQsPQY1o","name":"Royal Lions","color":"grayDark1"},{"id":"selXgLLCpzkfCxsET","name":"Rustlers","color":"greenLight1"},{"id":"sellqVUFMbyqV2rtN","name":"Savage Heat","color":"blueBright"},{"id":"selS80hsavOlmhjte","name":"Scotties","color":"grayLight2"},{"id":"selW7RMisB4WO3Bu5","name":"Scouts","color":"pinkLight1"},{"id":"selQbrQpHrVGaqAXl","name":"Sheepherders","color":"blueLight1"},{"id":"seljd9jXM6FdXg7UX","name":"Spartans","color":"redLight2"},{"id":"selN1AIY7pNO2RZf4","name":"Stars","color":"cyanLight2"},{"id":"selQQyXbY3SbXqMx3","name":"Sugarbeeters","color":"orangeBright"},{"id":"selTqqVYDTaknMD7H","name":"Terriers","color":"cyanLight1"},{"id":"selHHa7qfBKlZruNc","name":"Thunder","color":"redLight1"},{"id":"selCzxjI5y7hufxTM","name":"Thunderbirds","color":"redLight1"},{"id":"selzar1MFsuWYdxUS","name":"Tigers","color":"greenDark1"},{"id":"selJTtrGIqD0an4w0","name":"Tornadoes","color":"yellowLight1"},{"id":"selNsTfOHT5KkRXLI","name":"Trojans","color":"orangeDark1"},{"id":"selDqwF3GJSgpHdnK","name":"Vikings","color":"yellowBright"},{"id":"selVyvaBqxa7aFhbX","name":"Vikings/Valkyries","color":"blueLight1"},{"id":"selyi7AmEkvmUKrMa","name":"Wardens","color":"pinkDark1"},{"id":"selaHIHS9u2H7HSHG","name":"Warriors","color":"grayLight1"},{"id":"selu2OV2sJ15XkCug","name":"Warriors/Scarlets","color":"greenLight2"},{"id":"selVnnUwKvUuJSimE","name":"Wildcats","color":"redBright"},{"id":"selQisRZ3ELJ4JOMt","name":"Wolfpack","color":"purpleLight2"},{"id":"selQuVBYoHITI93Vn","name":"Wolverines","color":"orangeLight1"},{"id":"sel32VLipxSyC60iG","name":"Wolves","color":"tealDark1"},{"id":"selUzVtEbseADJllB","name":"Wranglers","color":"pinkLight2"},{"id":"sel6YF4P5LUiczaPN","name":"Yellowjackets","color":"pinkLight2"},{"id":"selpRvxoYI5AjRsTn","name":"Raptors","color":"cyanBright"},{"id":"selNDZ6KhTDHF4ZJF","name":"Vigilantes","color":"yellowDark1"},{"id":"selLjuSbfiyX6CIC0","name":"Cubs","color":"greenDark1"},{"id":"selC7DDCJxOKM2KlY","name":"Buccaneers","color":"grayDark1"},{"id":"sela2QYGa280qMDJd","name":"Unicorns","color":"blueDark1"},{"id":"sel65pSh0m8Q4r4d0","name":"Dinomites","color":"orangeLight2"}]}`
- **Mascot**
  - id: `fldYd5oULnG6DPwik`
  - type: `multipleAttachments`
  - role: `standard`
  - primary: `False`
- **Calculation**
  - id: `fldsiZNMzXw00xX1m`
  - type: `multilineText`
  - role: `standard`
  - primary: `False`
...
- **Submission Assets** → **Calculation** (`formula`) depends on: `RecordId`
...
- **Homework Completions** → **Linked Asset Reuse Decision** (`multipleLookupValues`) uses recordLinkField=`Submission Assets`, linkedField=`Asset Reuse Decision`
- **Homework Completions** → **Activity XP Display Label** (`formula`) depends on: `Linked Asset Reuse Decision`
...
- **Video Feedback** → **Linked Asset Reuse Decision** (`multipleLookupValues`) uses recordLinkField=`Submission Asset`, linkedField=`Asset Reuse Decision`
- **Video Feedback** → **Activity XP Display Label** (`formula`) depends on: `Linked Asset Reuse Decision`
- **Zoom Meetings** → **Effective Recording XP Percentage** (`formula`) depends on: `Recording XP Percentage — Meeting Override`, `Program Config: Recording XP %`, `Global Config: Recording XP %`
...
- **Zoom Meetings** → **Zoom Credit Approved?** (`formula`) depends on: `Live Attendance Confirmed?`, `Attendance Method`, `Recording Quiz Review Status`, `Recording Quiz Satisfactory?`
- **Zoom Meetings** → **Zoom XP Percentage** (`formula`) depends on: `Zoom Credit Approved?`, `Live Attendance Confirmed?`, `Attendance Method`, `Recording Quiz Review Status`, `Recording Quiz Satisfactory?`, `Recording XP Percentage`
- **Zoom Meetings** → **Zoom XP Amount** (`formula`)
- **Zoom Meetings** → **Zoom Gate Credit Earned?** (`formula`) depends on: `Zoom Credit Approved?`
- **Zoom Meetings** → **Zoom Credit Key** (`formula`) depends on: `Zoom Meeting Key`, `RecordId`
- **Zoom Meetings** → **Zoom Credit Conflict?** (`formula`) depends on: `Live Attendance Confirmed?`, `Attendance Method`, `Recording Quiz Review Status`, `Recording Quiz Satisfactory?`
- **Zoom Meetings** → **Zoom Credit Debug** (`formula`) depends on: `Attendance Method`, `Live Attendance Confirmed?`, `Recording Quiz Review Status`, `Recording Quiz Satisfactory?`, `Zoom Credit Approved?`, `Zoom XP Percentage`, `Zoom XP Amount`, `Zoom Gate Credit Earned?`, `Zoom Credit Conflict?`, `Zoom Credit Key`
...
- **Zoom Meetings** → **Program Config: Recording XP %** (`rollup`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Zoom Recording XP Percent of Live`
- **Zoom Meetings** → **Global Config: Recording XP %** (`rollup`) uses recordLinkField=`Config (Global Scope)`, linkedField=`Zoom Recording XP Percent of Live`
- **Zoom Meetings** → **ZZZ C025 Archive — Program Config: Full Gate Credit — legacy rollup** (`rollup`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Recording Gives Full Zoom Gate Credit?`
- **Zoom Meetings** → **ZZZ C025 Archive — Global Config: Full Gate Credit — legacy rollup** (`rollup`) uses recordLinkField=`Config (Global Scope)`, linkedField=`Recording Gives Full Zoom Gate Credit?`
- **Zoom Meetings** → **ZZZ C025 Archive — Program Config: Perfect Week Credit — legacy rollup** (`rollup`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Recording Makeup Counts for Perfect Week?`
- **Zoom Meetings** → **ZZZ C025 Archive — Global Config: Perfect Week Credit — legacy rollup** (`rollup`) uses recordLinkField=`Config (Global Scope)`, linkedField=`Recording Makeup Counts for Perfect Week?`
- **Zoom Meetings** → **ZZZ C025 Archive — Program Config: Coach Approval Required — legacy rollup** (`rollup`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Recording Quiz Requires Coach Approval?`
- **Zoom Meetings** → **ZZZ C025 Archive — Global Config: Coach Approval Required — legacy rollup** (`rollup`) uses recordLinkField=`Config (Global Scope)`, linkedField=`Recording Quiz Requires Coach Approval?`
- **Zoom Meetings** → **ZZZ C025 Archive — Program Config: Makeup Enabled — legacy rollup** (`rollup`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Recording Makeup Enabled?`
- **Zoom Meetings** → **ZZZ C025 Archive — Global Config: Makeup Enabled — legacy rollup** (`rollup`) uses recordLinkField=`Config (Global Scope)`, linkedField=`Recording Makeup Enabled?`
- **Zoom Meetings** → **Program Config: Makeup Window Days** (`rollup`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Zoom Recording Makeup Window Days`
- **Zoom Meetings** → **Global Config: Makeup Window Days** (`rollup`) uses recordLinkField=`Config (Global Scope)`, linkedField=`Zoom Recording Makeup Window Days`
- **Zoom Meetings** → **Program Config: Deadline Mode** (`rollup`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Zoom Recording Deadline Mode`
- **Zoom Meetings** → **Global Config: Deadline Mode** (`rollup`) uses recordLinkField=`Config (Global Scope)`, linkedField=`Zoom Recording Deadline Mode`
- **Zoom Meetings** → **ZZZ C025 Archive — Program Config: Approval Email Enabled — legacy rollup** (`rollup`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Recording Approval Email Enabled?`
- **Zoom Meetings** → **ZZZ C025 Archive — Global Config: Approval Email Enabled — legacy rollup** (`rollup`) uses recordLinkField=`Config (Global Scope)`, linkedField=`Recording Approval Email Enabled?`
- **Zoom Meetings** → **Program Config: Approval Email Timing** (`rollup`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Recording Approval Email Timing`
- **Zoom Meetings** → **Global Config: Approval Email Timing** (`rollup`) uses recordLinkField=`Config (Global Scope)`, linkedField=`Recording Approval Email Timing`
- **Zoom Meetings** → **Program Config: Approval Email Template Key** (`rollup`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Recording Approval Email Template Key`
- **Zoom Meetings** → **Global Config: Approval Email Template Key** (`rollup`) uses recordLinkField=`Config (Global Scope)`, linkedField=`Recording Approval Email Template Key`
- **Zoom Meetings** → **ZZZ C025 Archive — Effective Recording XP Percentage (Config formula draft)** (`formula`) depends on: `Recording XP Percentage — Meeting Override`, `Program Config: Recording XP %`, `Global Config: Recording XP %`
- **Zoom Meetings** → **ZZZ C025 Archive — Effective Recording Counts for Level Gate? (Config formula draft)** (`formula`) depends on: `Full Gate Credit — Meeting Override`, `Program Config: Full Gate Credit`, `Global Config: Full Gate Credit`
- **Zoom Meetings** → **ZZZ C025 Archive — Effective Recording Counts for Perfect Week? (Config formula draft)** (`formula`) depends on: `Perfect Week Credit — Meeting Override`, `Program Config: Perfect Week Credit`, `Global Config: Perfect Week Credit`
- **Zoom Meetings** → **ZZZ C025 Archive — Effective Recording Quiz Requires Coach Approval? (Config formula draft)** (`formula`) depends on: `Coach Approval Required — Meeting Override`, `Program Config: Coach Approval Required`, `Global Config: Coach Approval Required`
- **Zoom Meetings** → **ZZZ C025 Archive — Effective Recording Makeup Enabled? (Config formula draft)** (`formula`) depends on: `Makeup Enabled — Meeting Override`, `Program Config: Makeup Enabled`, `Global Config: Makeup Enabled`
- **Zoom Meetings** → **ZZZ C025 Archive — Effective Recording Makeup Window Days (Config formula draft)** (`formula`) depends on: `Makeup Window Days — Meeting Override`, `Program Config: Makeup Window Days`, `Global Config: Makeup Window Days`
- **Zoom Meetings** → **ZZZ C025 Archive — Effective Recording Deadline Mode (Config formula draft)** (`formula`) depends on: `Deadline Mode — Meeting Override`, `Program Config: Deadline Mode`, `Global Config: Deadline Mode`
- **Zoom Meetings** → **ZZZ C025 Archive — Effective Recording Approval Email Enabled? (Config formula draft)** (`formula`) depends on: `Approval Email Enabled — Meeting Override`, `Program Config: Approval Email Enabled`, `Global Config: Approval Email Enabled`
- **Zoom Meetings** → **ZZZ C025 Archive — Effective Recording Approval Email Timing (Config formula draft)** (`formula`) depends on: `Approval Email Timing — Meeting Override`, `Program Config: Approval Email Timing`, `Global Config: Approval Email Timing`
- **Zoom Meetings** → **ZZZ C025 Archive — Effective Recording Approval Email Template Key (Config formula draft)** (`formula`) depends on: `Approval Email Template Key — Meeting Override`, `Program Config: Approval Email Template Key`, `Global Config: Approval Email Template Key`
- **Zoom Meetings** → **ZZZ C025 Archive — C025 Checkbox Rollup Probe** (`rollup`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Recording Gives Full Zoom Gate Credit?`
- **Zoom Meetings** → **ZZZ C025 Archive — Program Config: Full Gate Credit — pre-YN** (`multipleLookupValues`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Recording Gives Full Zoom Gate Credit?`
- **Zoom Meetings** → **ZZZ C025 Archive — Global Config: Full Gate Credit — pre-YN** (`multipleLookupValues`) uses recordLinkField=`Config (Global Scope)`, linkedField=`Recording Gives Full Zoom Gate Credit?`
- **Zoom Meetings** → **ZZZ C025 Archive — Program Config: Perfect Week Credit — pre-YN** (`multipleLookupValues`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Recording Makeup Counts for Perfect Week?`
- **Zoom Meetings** → **ZZZ C025 Archive — Global Config: Perfect Week Credit — pre-YN** (`multipleLookupValues`) uses recordLinkField=`Config (Global Scope)`, linkedField=`Recording Makeup Counts for Perfect Week?`
- **Zoom Meetings** → **ZZZ C025 Archive — Program Config: Coach Approval Required — pre-YN** (`multipleLookupValues`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Recording Quiz Requires Coach Approval?`
- **Zoom Meetings** → **ZZZ C025 Archive — Global Config: Coach Approval Required — pre-YN** (`multipleLookupValues`) uses recordLinkField=`Config (Global Scope)`, linkedField=`Recording Quiz Requires Coach Approval?`
- **Zoom Meetings** → **ZZZ C025 Archive — Program Config: Makeup Enabled — pre-YN** (`multipleLookupValues`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Recording Makeup Enabled?`
- **Zoom Meetings** → **ZZZ C025 Archive — Global Config: Makeup Enabled — pre-YN** (`multipleLookupValues`) uses recordLinkField=`Config (Global Scope)`, linkedField=`Recording Makeup Enabled?`
- **Zoom Meetings** → **ZZZ C025 Archive — Program Config: Approval Email Enabled — pre-YN** (`multipleLookupValues`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Recording Approval Email Enabled?`
- **Zoom Meetings** → **ZZZ C025 Archive — Global Config: Approval Email Enabled — pre-YN** (`multipleLookupValues`) uses recordLinkField=`Config (Global Scope)`, linkedField=`Recording Approval Email Enabled?`
- **Zoom Meetings** → **Program Config: Full Gate Credit** (`multipleLookupValues`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Recording Gives Full Zoom Gate Credit YN`
- **Zoom Meetings** → **Global Config: Full Gate Credit** (`multipleLookupValues`) uses recordLinkField=`Config (Global Scope)`, linkedField=`Recording Gives Full Zoom Gate Credit YN`
- **Zoom Meetings** → **Program Config: Perfect Week Credit** (`multipleLookupValues`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Recording Makeup Counts for Perfect Week YN`
- **Zoom Meetings** → **Global Config: Perfect Week Credit** (`multipleLookupValues`) uses recordLinkField=`Config (Global Scope)`, linkedField=`Recording Makeup Counts for Perfect Week YN`
- **Zoom Meetings** → **Program Config: Coach Approval Required** (`multipleLookupValues`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Recording Quiz Requires Coach Approval YN`
- **Zoom Meetings** → **Global Config: Coach Approval Required** (`multipleLookupValues`) uses recordLinkField=`Config (Global Scope)`, linkedField=`Recording Quiz Requires Coach Approval YN`
- **Zoom Meetings** → **Program Config: Makeup Enabled** (`multipleLookupValues`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Recording Makeup Enabled YN`
- **Zoom Meetings** → **Global Config: Makeup Enabled** (`multipleLookupValues`) uses recordLinkField=`Config (Global Scope)`, linkedField=`Recording Makeup Enabled YN`
- **Zoom Meetings** → **Program Config: Approval Email Enabled** (`multipleLookupValues`) uses recordLinkField=`Config (Program Scope)`, linkedField=`Recording Approval Email Enabled YN`
- **Zoom Meetings** → **Global Config: Approval Email Enabled** (`multipleLookupValues`) uses recordLinkField=`Config (Global Scope)`, linkedField=`Recording Approval Email Enabled YN`
- **Zoom Meetings** → **ZZZ C025 Archive — C025 Select Probe AJ Prog** (`formula`) depends on: `Program Config: Deadline Mode`
- **Zoom Meetings** → **ZZZ C025 Archive — C025 Select Probe Raw Prog** (`formula`) depends on: `Program Config: Deadline Mode`
- **Zoom Meetings** → **ZZZ C025 Archive — C025 Select Probe OverrideBlank** (`formula`) depends on: `Deadline Mode — Meeting Override`
- **Zoom Meetings** → **ZZZ C025 Archive — C025 Select Probe Nested** (`formula`) depends on: `Program Config: Deadline Mode`
- **Zoom Meetings** → **ZZZ C025 Archive — C025 Select Probe AJ Glob** (`formula`) depends on: `Global Config: Deadline Mode`
- **Zoom Meetings** → **ZZZ C025 Archive — C025 Select Probe OverrideRaw** (`formula`) depends on: `Deadline Mode — Meeting Override`
- **Zoom Meetings** → **ZZZ C025 Archive — C025 Select Probe BlankCmp** (`formula`) depends on: `Deadline Mode — Meeting Override`
- **Zoom Meetings** → **ZZZ C025 Archive — C025 Select Probe Len** (`formula`) depends on: `Deadline Mode — Meeting Override`
- **Zoom Meetings** → **ZZZ C025 Archive — C025 Select Probe LenPath** (`formula`) depends on: `Deadline Mode — Meeting Override`
...
- **Zoom Attendance** → **Effective Recording Approval Email Enabled?** (`multipleLookupValues`) uses recordLinkField=`Zoom Meeting`, linkedField=`Effective Recording Approval Email Enabled?`
- **Zoom Attendance** → **Effective Recording Approval Email Timing** (`multipleLookupValues`) uses recordLinkField=`Zoom Meeting`, linkedField=`Effective Recording Approval Email Timing`
- **Zoom Attendance** → **Effective Recording Approval Email Template Key** (`multipleLookupValues`) uses recordLinkField=`Zoom Meeting`, linkedField=`Effective Recording Approval Email Template Key`
...
- **Award Recipients** → **Ready to Send?** (`formula`) depends on: `Award Status`, `Recipient Email`, `Award Amount`, `Tremendous Order ID`, `Tremendous Reward ID`
