...
See WAS architecture + Agent 2 ownership matrix: Build?, Ready?, Send to Make?, Sent?, Make Send Status, sendMode, package fields.  
**PROD 074 sendMode must not be fixed Test.**
