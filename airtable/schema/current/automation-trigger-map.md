...
| 057 | Weekly Athlete Summary | When record matches conditions: `Perfect Week Calculation Queue? = 1` (Pending OR Recalc Needed) | `057-...-calculate-perfect-week-eligibility.js` (**v2.5** — SC-160 early HW + SC-152 Live Tested) | Perfect week flags |
