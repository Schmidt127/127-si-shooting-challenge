...
| 057 | Weekly Athlete Summary | When record matches conditions: `Perfect Week Calculation Queue? = 1` (Pending OR Recalc Needed) | `057-...-calculate-perfect-week-eligibility.js` (**GitHub v2.6; Live v2.5 pending SC-121 paste** — partial terminal Week aware) | Perfect week flags |
