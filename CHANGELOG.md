...
- **`backfill-homework-completion-upload-edge-cases.js`** — Safe-backfill for multi-asset and no-asset homework upload rows using slot match and reverse asset lookup.
