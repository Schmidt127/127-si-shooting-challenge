...
#### Changed
- **SC-158 / SF-08 Automation 059 lifecycle (2026-09-04)** — GitHub **059 v3.8**: OR trigger docs (Pending+Active award **or** inactive Shot Milestone withdrawal), Trigger Context notes field, `lifecycleOut`. Live still **v3.7** + positive-only trigger until Mike paste/Update ([`docs/deploy-checklists/059-sf08-lifecycle-trigger-or.md`](./docs/deploy-checklists/059-sf08-lifecycle-trigger-or.md)). Silent miss proven; award/restore/dedupe/error paths live-tested on disposables. Closeout: [`docs/audits/SF-08-059-LIFECYCLE-CLOSEOUT-20260904.md`](./docs/audits/SF-08-059-LIFECYCLE-CLOSEOUT-20260904.md).
...
- **Homework late-credit policy (2026-09-03)** — **020 v3.9**, **065 v10.6**, **057 v2.3**: late satisfactory homework earns full `HOMEWORK_XP|{hcId}` credit; timing status `late` is recorded for reporting; Perfect Week homework counts require on-time Submission Date (PHA Due Date → Week End Date fallback). Contract tests: `tests/automation-contracts/065-homework-late-credit-policy.test.js`. Operator checklist: [`docs/deploy-checklists/homework-late-credit-policy-020-057-065.md`](./docs/deploy-checklists/homework-late-credit-policy-020-057-065.md). **Production Automations Code PASTE-ALIGNED 2026-09-03** (Agent 4 MCP: 020 v3.9 / 065 v10.6 / 057 2.3 Live) — disposable behavior proof still **REQUIRES LIVE CONFIRMATION**. **Do not paste from agents.**
