...
#### Added
- **SC-159 trigger redesign (2026-09-04)** - Nested OR not representable in Automation UI. Recommended formula field `059 Lifecycle Trigger?`; superseded OR checklist. SC-159 remains OPEN until live-tested. [`docs/audits/SC-159-LIFECYCLE-TRIGGER-REDESIGN-20260904.md`](./docs/audits/SC-159-LIFECYCLE-TRIGGER-REDESIGN-20260904.md).
