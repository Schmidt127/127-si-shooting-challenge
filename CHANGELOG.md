...
#### Changed
- **SC-160 Stage 6 recovery + 020 v4.1 (2026-09-05)** — Resumed unanswered PAUSE: orphan duplicate WAS deleted; late Homework XP @ 35 + idempotent retry PASS; harness `listExactWas` FIND/ARRAYJOIN miss fixed. GitHub **020 v4.1** find-or-creates canonical WAS for Enrollment + PHA.Week (weekless intake). **Paste pending** — [`docs/deploy-checklists/SC-160-020-v4.1-was-pha-week.md`](./docs/deploy-checklists/SC-160-020-v4.1-was-pha-week.md). Evidence: [`docs/audits/SC-160-STAGE6-RECOVERY-CLOSEOUT-20260905.md`](./docs/audits/SC-160-STAGE6-RECOVERY-CLOSEOUT-20260905.md). FUT-002 trash **hold**. Season Sim not run; 058/059/070a untouched.
