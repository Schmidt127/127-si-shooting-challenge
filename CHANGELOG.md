...
#### Added
- **Full parent/athlete email redesign promotion checklist (2026-09-01)** — Cohesive four-template React Email redesign in Communications Hub (`DAILY_SUBMISSION`, `VIDEO_FEEDBACK`, `HOMEWORK_FEEDBACK`, `WEEKLY_ATHLETE_SUMMARY`): shared design system (brand blue `#0034B7`, orange `#FF8B00`, no navy), Session Details stat rows, Video Feedback Next Video Challenge + weekly video list, Weekly Mission Report structure. Checklist: [`docs/deploy-checklists/sc-parent-athlete-email-redesign-2026-09-01.md`](./docs/deploy-checklists/sc-parent-athlete-email-redesign-2026-09-01.md). **Hub deploy pending; automations 071/076 not re-pasted.**
