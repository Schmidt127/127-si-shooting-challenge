...
#### Changed
- **Automation 005 v4.1 (2026-08-06)** — Activity Date fallback now scopes candidate Weeks to `Submission.Enrollment.Program Instance` before date-range match (fixes Early Bird vs Perfect Week fixture multi-match on 2026-08-05). Homework-first unchanged. Missing Enrollment / Program Instance → clear skip. Same-PI overlap still errors. Offline 8/8. **PROD paste + live Tests 1–7 required.** [`005-…js`](./airtable/automations/shooting-challenge/005-submission-intake-and-asset-creation-assign-week-to-submission-homework-first.js) · [`005-program-instance-week-scope.md`](./docs/deploy-checklists/005-program-instance-week-scope.md) · evidence [`2026-08-06-005-program-instance-week-scope/`](./docs/testing/evidence/2026-08-06-005-program-instance-week-scope/).
