...
#### Changed
- **074 v2.2 failure visibility (2026-07-24)** — Emits `statusOut` / `debugStep` / `actionOut` on webhook failure and success; corrects WRITEBACK docblock (074 READs `Weekly Email Sent?` to block duplicates; does not WRITE/CLEAR it). Agent 4 QC suite + Live/Test regression. Paste required for PROD. [`docs/testing/agent4-qc/`](./docs/testing/agent4-qc/).
