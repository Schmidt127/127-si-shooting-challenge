...
#### Added
- **SC-SEASON-SIM-001 three-athlete preparation (2026-09-06)** — Reusable Perfect / Recovery / Edge profiles; expectation matrices; execution manifest + operator checklist + scenario matrix; CLI `dry-run-three`. **READY — not executed.** Authorization: `RUN 3-ATHLETE SEASON SIMULATION`. **No DEV environment.** Supersedes five-enrollment design. SC-SEASON-SIM-002 remains COMPLETE historical infrastructure.
