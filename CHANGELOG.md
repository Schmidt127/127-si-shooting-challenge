...
#### Changed
- **Program Instance isolation package (2026-08-06)** — Scope Enrollment/Week matching and Week date helpers by Program Instance so multi-year Active records cannot collide. **005 v4.1** (Activity Date fallback: Enrollment → PI → Weeks); **023 v3.0** (priority match; never Athlete-only when ambiguous); **053 5.3** / **066 v3.5** (PI-scoped Week attribution); **118/119 v1.7** (End Date collision throw; arm by Week PI); **043 v2.1** (School Year / Rule Set prefer). **Repository updated — PROD paste required.** Package: [`PROGRAM-INSTANCE-ISOLATION-PACKAGE.md`](./docs/prod-completion/2026-08-06/PROGRAM-INSTANCE-ISOLATION-PACKAGE.md) · Paste: [`2026-08-06-PROGRAM-INSTANCE-ISOLATION-PASTE.md`](./docs/deploy-checklists/2026-08-06-PROGRAM-INSTANCE-ISOLATION-PASTE.md).
