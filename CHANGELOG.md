...
#### Added
- **SC-167/168/169 live verification (2026-09-05)** — Live **010 v10.14** MCP-verified (`wflJUkUJYTtRWJCyH`); SC-168/169 **COMPLETE**; SC-167 eligible disposable create+retry **LIVE TEST REQUIRED** (2027 Weeks + wall-clock formulas). Audit: [`docs/audits/SC-167-168-169-LIVE-VERIFICATION-20260905.md`](./docs/audits/SC-167-168-169-LIVE-VERIFICATION-20260905.md).
- **SC-167/168/169 Season Sim T122531Z discrepancy wave closeout (2026-09-05)** — Coordinator wave after SC-SEASON-SIM-002: duplicate SUBMISSION_XP (SC-167), missing weekly emails (SC-168), unlocks=0 false negative (SC-169). Merged **#450/#451/#453/#452/#454**. Wave audit: [`docs/audits/SC-167-168-169-DISCREPANCY-WAVE-CLOSEOUT-20260905.md`](./docs/audits/SC-167-168-169-DISCREPANCY-WAVE-CLOSEOUT-20260905.md). Full Season Sim not rerun.
...
#### Changed
- **SC-167 Automation 010 v10.14 (2026-09-05)** — GitHub harden against concurrent duplicate `SUBMISSION_XP|{submissionId}` creates: deterministic owner + post-create consolidate (deactivate extras); fail closed on ambiguous ownership. PR **#453**. **Live pasted + MCP-verified v10.14** (`wflJUkUJYTtRWJCyH`); eligible disposable create+retry still **LIVE TEST REQUIRED** — [`docs/deploy-checklists/SC-167-010-v10.14-duplicate-consolidate.md`](./docs/deploy-checklists/SC-167-010-v10.14-duplicate-consolidate.md) · [`docs/audits/SC-167-168-169-LIVE-VERIFICATION-20260905.md`](./docs/audits/SC-167-168-169-LIVE-VERIFICATION-20260905.md). Does not change XP amounts or eligibility.
