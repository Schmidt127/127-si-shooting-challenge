...
#### Changed
- **Homework late-credit policy (2026-09-03)** — `resolveHomeworkCreditEligibility` no longer denies credit solely because Submission Date is after due. Late + Satisfactory/XP → credit earned; late awaiting review → pending (`Late — pending review`); public labels updated in `homework-assignments.tsx`. Deploy checklist: [`docs/deploy-checklists/homework-late-credit-policy-020-065-057.md`](./docs/deploy-checklists/homework-late-credit-policy-020-065-057.md).
...
#### Changed
- **Homework late-credit policy — 020 v3.9 / 065 v10.6 / 057 v2.3 (2026-09-03)** — Late homework is full-credit + normal XP once Satisfactory (`timingStatus: late`; no 065 late XP block). 020 late Notes reworded. 057 Perfect Week homework gate excludes late Submission Dates for the original week. Shared contracts in `lib/homework-contracts/assignment-identity.js` + `v2-engine-contracts.js`. **Production paste pending** — [`docs/deploy-checklists/homework-late-credit-policy-020-065-057.md`](./docs/deploy-checklists/homework-late-credit-policy-020-065-057.md). Does not modify 003 / 067 / 101 / 117 / SC-147; no 121.
- **Automation 003 v2.0 — COMPLETE / PRODUCTION-VERIFIED (2026-09-03, SC-023)** — Documented Production grade-change Grade Band refresh (enabled; refresh-view conditions; dynamic `recordId`; disposable VERIFY Enrollment succeeded). **Keep active** — not an unused slot; initial assign remains **002**. No Production script/formula/behavior change this session. Offline regression: `tests/enrollment-intake/automation-003-grade-change-refresh.test.js`. Closeout: [`docs/prod-completion/2026-09-03/AUTOMATION-003-GRADE-CHANGE-VERIFIED.md`](./docs/prod-completion/2026-09-03/AUTOMATION-003-GRADE-CHANGE-VERIFIED.md).
