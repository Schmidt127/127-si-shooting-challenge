...
- **Final Pre-Close backfill stubs** — `repair-final-090f-unlock-week-from-source.js`, `repair-final-090g-build-final-challenge-summary-email.js` (`DRY_RUN` only until audit review).
