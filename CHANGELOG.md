...
#### Added
- **At-home release prep closeout (2026-09-10)** — Audit [`docs/audits/AT-HOME-RELEASE-PREP-2026-09-10.md`](./docs/audits/AT-HOME-RELEASE-PREP-2026-09-10.md); SC-172 operator checklist [`docs/deploy-checklists/SC-172-health-admin-diagnostics.md`](./docs/deploy-checklists/SC-172-health-admin-diagnostics.md); Hub Production redeem/submit URL gaps documented in structured curriculum env checklist.
