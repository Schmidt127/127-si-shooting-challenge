...
#### Added
<<<<<<< HEAD
- **Email + SC-147 paste operator packets (2026-09-01)** — Paste-ready desktop docs (repo-only; no Airtable paste by agents): [`071-v4.3-homework-feedback-paste-packet.md`](./docs/deploy-checklists/071-v4.3-homework-feedback-paste-packet.md) (**071 v4.3** FUT-046 payload), [`076-v8.12-daily-submission-paste-packet.md`](./docs/deploy-checklists/076-v8.12-daily-submission-paste-packet.md) (**076 v8.12** FUT-041 `xpEarned`/`xpExtraCredit`), enhanced [`SC-147-zoom-recording-half-xp.md`](./docs/deploy-checklists/SC-147-zoom-recording-half-xp.md) (slot **147** recommendation, `ZOOM_RECORDING` rule checklist, **147 v1.0** paste section), index [`EMAIL-PASTE-QUEUE-2026-09.md`](./docs/deploy-checklists/EMAIL-PASTE-QUEUE-2026-09.md). **Mike paste still required** for 071/076/147.
=======
- **FUT-038 global category on/off — Mike decision worksheet (2026-09-01)** — Async **12-decision** worksheet for Mike (config ownership, 2026–27 defaults, gates, Perfect Week + Zoom, web UX, email, intake, mid-season toggle, PKG-004 naming). Worksheet: [`docs/next-wave/config-selection/FUT-038-MIKE-DECISION-WORKSHEET.md`](./docs/next-wave/config-selection/FUT-038-MIKE-DECISION-WORKSHEET.md). Brief §11 pointer added. **No schema, automation, web, or email implementation.**
>>>>>>> origin/cursor/fut-038-decision-worksheet-e772
...
<<<<<<< HEAD
- **Email + SC-147 paste operator packets (2026-09-01)** — Paste-ready desktop docs (repo-only; no Airtable paste by agents): [`071-v4.3-homework-feedback-paste-packet.md`](./docs/deploy-checklists/071-v4.3-homework-feedback-paste-packet.md) (**071 v4.3** FUT-046 payload), [`076-v8.12-daily-submission-paste-packet.md`](./docs/deploy-checklists/076-v8.12-daily-submission-paste-packet.md) (**076 v8.12** FUT-041 `xpEarned`/`xpExtraCredit`), enhanced [`SC-147-zoom-recording-half-xp.md`](./docs/deploy-checklists/SC-147-zoom-recording-half-xp.md) (recommended slot **147**, `ZOOM_RECORDING` rule row checklist, **147 v1.0** paste packet), index [`EMAIL-PASTE-QUEUE-2026-09.md`](./docs/deploy-checklists/EMAIL-PASTE-QUEUE-2026-09.md). **Mike paste still required** for 071/076/147.
=======
...
- **FUT-041 + FUT-046 + FUT-047 email bundle (2026-09-01)** — PR **#321** merged `66f8c40b`;
  ...
  **Mike paste still required:** **071 v4.3** and **076 v8.12** to Airtable DEV → verify → Production.

#### Added
- **SC-147 Recorded Zoom half-XP automation script ready (2026-09-01, MRW-H10)** — Production-ready
  **147** placeholder slot script `147-zoom-recording-credit-award-half-xp.js` **v1.0** (Source Key
  `ZOOM_RECORDING_CREDIT|{enrollmentId}|{zoomMeetingId}`, live **101** exclusivity, idempotent XP
  guard, half-XP from `ZOOM_RECORDING` rule row or `floor(ZOOM_ATTEND_BASE/2)`). Promotion checklist:
  [`docs/deploy-checklists/SC-147-zoom-recording-half-xp.md`](./docs/deploy-checklists/SC-147-zoom-recording-half-xp.md).
  Offline tests: `lib/sc-147-zoom-recording-credit.test.js`. **Not Live** — Mike slot + rule row + DEV paste pending.
