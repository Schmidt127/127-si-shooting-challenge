...
#### Added
- **SC-147 reconciliation trigger formula fix (2026-09-02)** — Exact Production formula package to wake `Zoom XP Reconciliation Needed?` for approved recording-only Zoom Attendance without Attendees writes. [`docs/deploy-checklists/SC-147-reconciliation-trigger-formula-fix.md`](./docs/deploy-checklists/SC-147-reconciliation-trigger-formula-fix.md). **NOT applied to Production** — Mike/OMNI before 101 v6.7 paste.
- **101 v6.7 — SC-147 Recorded Zoom half-XP extension (2026-09-02)** — Recording half-XP merged into `101-zoom-attendance-xp-award-meeting-xp.js` (no slot 121). Source Key `ZOOM_RECORDING_CREDIT|{enrollmentId}|{zoomMeetingId}`. **NOT Live** — paste packet [`101-v6.7-sc-147-operator-packet.md`](./docs/deploy-checklists/101-v6.7-sc-147-operator-packet.md). PR **#338** merged `49098217`. **117 unchanged (email-only).**
