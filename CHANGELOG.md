...
#### Added
- **DEV execution and promotion model (2026-07-14)** — Feature-once Mike approval; autonomous low-risk DEV work; ARCHIVE/DEV/PROD rules; consolidated completion reporting; PROD promotion package required. [DEV-EXECUTION-AND-PROMOTION-MODEL.md](./docs/development/DEV-EXECUTION-AND-PROMOTION-MODEL.md). Agent instructions updated (`AGENTS.md`, workflow guardrails, doc 04, overnight hard-blocks reconciled).
...
#### Changed
- **C-025 S19 DEV 117 activation closeout (2026-07-14)** — Deployment sheet + Mike action sheet for paste of 117a–f. Safety fixes: **117c/117f/117b v1.0.1** (Recording Quiz–only XP; email Approved/Conflict guards; correctionCount output). Stopped for Mike UI: create/paste **117a** OFF in DEV.
...
- **C-025 Effective Recording\* → Formula (DEV, 2026-07-14)** — Mike UI in-place convert of 10 Zoom Meetings Effective fields (same field IDs). Checkbox Effectives forced to formula number 1/0; selects → singleLineText. Postconversion verify **13/13 PASS**; Schmidt **4/4**. Docs: [conversion guide](./docs/deploy-checklists/C-025-effective-to-formula-conversion.md), [result](./docs/deploy-checklists/C-025-effective-postconversion-result.md). No PROD / 117a–f / cleanup.
