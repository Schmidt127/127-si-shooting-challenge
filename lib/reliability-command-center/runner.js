...
const { checkXpSourceAuthority } = require("./workflows/xp-source-authority");
...
const CHECKERS = [
  ...
  { name: "xpSourceAuthority", fn: checkXpSourceAuthority },
...
function normalizeInput(raw = {}) {
  ...
  return {
    ...
    streakOccurrences: pick("streakOccurrences", "Streak Occurrences"),
