...
const requiredTests = [
  ...
  "airtable/automations/shooting-challenge/lib/c025-stage17-etf-downstream.js",
  "airtable/automations/shooting-challenge/lib/c025-stage17-etf-downstream.test.js",
  "airtable/automations/shooting-challenge/lib/066-milestone-crossing-harness.test.js",
  "airtable/automations/shooting-challenge/lib/066-create-records-batch.test.js",
...
if (byNumber.has("066")) {
  ...
  if (
    ...
    fail("PROJECT_STATE references Automation 066 older 3.x without acknowledging current version");
  } else {
    pass("PROJECT_STATE 066 version wording acknowledges current 066 (or avoids stale older-only claim)");
  }
}

// 070b / 070c version wording must match repository source while preserving the live v4.7 cutover boundary.
if (byNumber.has("070b") && byNumber.has("070c")) {
  ...
  if (ver070b === "v4.8") pass("070b declared repository version v4.8");
  else fail(`070b expected repository v4.8, found ${ver070b || "(none)"}`);
  ...
  if (/070b.*v4\.7/i.test(inventoryText) && /070c.*v1\.1/i.test(inventoryText)) {
    pass("inventory preserves live 070b v4.7 and documents 070c v1.1; GitHub source is v4.8 pending paste");
  } else {
    fail("inventory missing live 070b v4.7 / 070c v1.1 wording");
  }
}
