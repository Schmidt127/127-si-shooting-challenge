...
> **Historical — read-only offline tooling (DEV base retired 2026-08-19).** Fixtures and CLI remain for repository contract tests (`run_offline_fixture_suite.js`, `validate-v2-release-readiness.js`). Do not target the retired DEV base for live writes.
